...
public interface ExprCast extends de.peeeq.wurstscript.ast.Expr, KatjaTuple {

    //----- methods of ExprCast -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.ExprCast replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.TypeExpr typ();
    public de.peeeq.wurstscript.ast.ExprCast replaceTyp(de.peeeq.wurstscript.ast.TypeExpr typ);
    public de.peeeq.wurstscript.ast.Expr expr();
    public de.peeeq.wurstscript.ast.ExprCast replaceExpr(de.peeeq.wurstscript.ast.Expr expr);
    public KatjaSort get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ExprCast replace(int pos, Object term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprCast.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.ExprCast {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPos _source = null;
        private de.peeeq.wurstscript.ast.TypeExpr _typ = null;
        private de.peeeq.wurstscript.ast.Expr _expr = null;
        ...
        public de.peeeq.wurstscript.ast.ExprCast replaceExpr(de.peeeq.wurstscript.ast.Expr expr) {
            return replace(2, expr);
        }

        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.TypeExpr typ, de.peeeq.wurstscript.ast.Expr expr) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort ExprCast invoked with null parameter source");
            if(typ == null)
                throw new IllegalArgumentException("constructor of sort ExprCast invoked with null parameter typ");
            if(expr == null)
                throw new IllegalArgumentException("constructor of sort ExprCast invoked with null parameter expr");
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprCast invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprCast invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprCast replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort ExprCast invoked with negative parameter "+pos);
            if(pos >= 3)
                throw new IllegalArgumentException("replace on sort ExprCast invoked with too large parameter "+pos+", sort has only 3 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort ExprCast invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.TypeExpr))
                throw new IllegalArgumentException("replace on sort ExprCast invoked with term of incorrect sort, TypeExpr expected");
            if(pos == 2 && !(term instanceof de.peeeq.wurstscript.ast.Expr))
                throw new IllegalArgumentException("replace on sort ExprCast invoked with term of incorrect sort, Expr expected");

            return (de.peeeq.wurstscript.ast.ExprCast) AST.unique(new de.peeeq.wurstscript.ast.ExprCast.Impl(
                pos == 0 ? (de.peeeq.wurstscript.ast.WPos) term : _source,
                pos == 1 ? (de.peeeq.wurstscript.ast.TypeExpr) term : _typ,
                pos == 2 ? (de.peeeq.wurstscript.ast.Expr) term : _expr
            ));
        }

        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.Expr.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseExprCast(this);
        }
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.ExprCast");
            builder.append("( ");
            _source.toJavaCode(builder);
            builder.append(", ");
            _typ.toJavaCode(builder);
            builder.append(", ");
            _expr.toJavaCode(builder);
            builder.append(" )");
        ...
        public Appendable toString(Appendable builder) throws IOException {
            builder.append("ExprCast");
            builder.append("( ");
            _source.toString(builder);
            builder.append(", ");
            _typ.toString(builder);
            builder.append(", ");
            _expr.toString(builder);
            builder.append(" )");
