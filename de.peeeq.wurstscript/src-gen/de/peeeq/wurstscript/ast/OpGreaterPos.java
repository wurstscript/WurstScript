...
public interface OpGreaterPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpGreater> {

    //----- methods of OpGreaterPos -----

    public de.peeeq.wurstscript.ast.OpGreater termOpBinary();
    public de.peeeq.wurstscript.ast.OpGreater termOp();
    public de.peeeq.wurstscript.ast.OpGreater term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpGreaterPos replace(de.peeeq.wurstscript.ast.OpGreater term);
    ...
    //----- nested classes of OpGreaterPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpGreaterPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpGreater> implements de.peeeq.wurstscript.ast.OpGreaterPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpGreater term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpGreaterPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpGreaterPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpGreaterPos replace(de.peeeq.wurstscript.ast.OpGreater term) {
            return (de.peeeq.wurstscript.ast.OpGreaterPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpGreaterPos(this);
        }
