...
public interface WParameterPos extends de.peeeq.wurstscript.ast.VarDefPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.WParameter> {

    //----- methods of WParameterPos -----

    public de.peeeq.wurstscript.ast.WParameter termVarDef();
    public de.peeeq.wurstscript.ast.WParameter term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.WParameterPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.TypeExprPos typ();
    public de.peeeq.wurstscript.ast.WParameterPos replaceTyp(de.peeeq.wurstscript.ast.TypeExpr typ);
    public de.peeeq.wurstscript.ast.StringPos name();
    public de.peeeq.wurstscript.ast.WParameterPos replaceName(java.lang.String name);
    public de.peeeq.wurstscript.ast.AST.TermPos<?> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.WParameterPos replace(de.peeeq.wurstscript.ast.WParameter term);
    public de.peeeq.wurstscript.ast.WParametersPos parent();
    public de.peeeq.wurstscript.ast.WParameterPos lsib();
    public de.peeeq.wurstscript.ast.WParameterPos rsib();
    ...
    //----- nested classes of WParameterPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.WParameterPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.WParameter> implements de.peeeq.wurstscript.ast.WParameterPos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.TypeExprPos _typ = null;
        ...
        public de.peeeq.wurstscript.ast.TypeExprPos typ() {
            if(_typ == null)
                _typ = de.peeeq.wurstscript.ast.AST.TypeExprPos(this, _term.typ(), 1);
        ...
        public de.peeeq.wurstscript.ast.StringPos name() {
            if(_name == null)
                _name = de.peeeq.wurstscript.ast.AST.StringPos(this, _term.name(), 2);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.WParameter term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.TermPos<?> get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_typ == null)
                        _typ = AST.TypeExprPos(this, _term.typ(), 1);
                    
                    return _typ;
                case 2:
                    if(_name == null)
                        _name = AST.StringPos(this, _term.name(), 2);
                    
                    return _name;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort WParameterPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort WParameterPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.WParameterPos replace(de.peeeq.wurstscript.ast.WParameter term) {
            return (de.peeeq.wurstscript.ast.WParameterPos) super.replace(term);
        }
        ...
        public de.peeeq.wurstscript.ast.WParametersPos parent() {
            return (de.peeeq.wurstscript.ast.WParametersPos) super.parent();
        }

        public de.peeeq.wurstscript.ast.WParameterPos lsib() {
            return (de.peeeq.wurstscript.ast.WParameterPos) super.lsib();
        }

        public de.peeeq.wurstscript.ast.WParameterPos rsib() {
            return (de.peeeq.wurstscript.ast.WParameterPos) super.rsib();
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.VarDefPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseWParameterPos(this);
        }
