...
public interface ArraySizesPos extends de.peeeq.wurstscript.ast.AST.ListPos<de.peeeq.wurstscript.ast.ArraySizes, de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.Expr> {

    //----- methods of ArraySizesPos -----

    public de.peeeq.wurstscript.ast.ArraySizes term();
    public de.peeeq.wurstscript.ast.ArraySizesPos add(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArraySizesPos addAll(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArraySizesPos remove(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArraySizesPos removeAll(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArraySizesPos appBack(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArraySizesPos appFront(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArraySizesPos conc(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArraySizesPos reverse();
    public de.peeeq.wurstscript.ast.ArraySizesPos toSet();
    public de.peeeq.wurstscript.ast.ArraySizesPos setAdd(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArraySizesPos setRemove(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArraySizesPos setUnion(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArraySizesPos setWithout(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArraySizesPos setIntersection(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public KatjaList<de.peeeq.wurstscript.ast.ExprPos> toList();
    public de.peeeq.wurstscript.ast.ArraySizesPos replace(de.peeeq.wurstscript.ast.ArraySizes term);
    public de.peeeq.wurstscript.ast.TypeExprPos parent();
    ...
    //----- nested classes of ArraySizesPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ArraySizesPos.VisitorType<E> {
    ...
    static class Impl extends KatjaListPosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.ArraySizes, de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.Expr> implements de.peeeq.wurstscript.ast.ArraySizesPos {

        //----- methods of Impl -----

        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.ArraySizes term, int pos) {
        ...
        public KatjaList<de.peeeq.wurstscript.ast.ExprPos> toList() {
            ...
            return new ArraySizesPos.ListImpl(values);
        }

        public de.peeeq.wurstscript.ast.ArraySizesPos replace(de.peeeq.wurstscript.ast.ArraySizes term) {
            return (de.peeeq.wurstscript.ast.ArraySizesPos) super.replace(term);
        }
        ...
        public de.peeeq.wurstscript.ast.TypeExprPos parent() {
            return (de.peeeq.wurstscript.ast.TypeExprPos) super.parent();
        }
