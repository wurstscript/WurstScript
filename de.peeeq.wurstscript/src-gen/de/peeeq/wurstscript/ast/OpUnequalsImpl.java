...
class OpUnequalsImpl implements OpUnequals, AstElementIntern {
	OpUnequalsImpl() {
	}
	...
	@Override public OpUnequals copy() {
	...
	@Override public void accept(OpUnequals.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpUnequals(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpUnequals(this);
	}
