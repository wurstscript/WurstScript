...
public interface ExprUnaryPos extends de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.ExprUnary> {

    //----- methods of ExprUnaryPos -----

    public de.peeeq.wurstscript.ast.ExprUnary termExpr();
    public de.peeeq.wurstscript.ast.ExprUnary termOptExpr();
    public de.peeeq.wurstscript.ast.ExprUnary term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.ExprUnaryPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.OpUnaryPos op();
    public de.peeeq.wurstscript.ast.ExprUnaryPos replaceOp(de.peeeq.wurstscript.ast.OpUnary op);
    public de.peeeq.wurstscript.ast.ExprPos right();
    public de.peeeq.wurstscript.ast.ExprUnaryPos replaceRight(de.peeeq.wurstscript.ast.Expr right);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ExprUnaryPos replace(de.peeeq.wurstscript.ast.ExprUnary term);
    ...
    //----- nested classes of ExprUnaryPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprUnaryPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.ExprUnary> implements de.peeeq.wurstscript.ast.ExprUnaryPos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.OpUnaryPos _op = null;
        ...
        public de.peeeq.wurstscript.ast.OpUnaryPos op() {
            if(_op == null)
                _op = de.peeeq.wurstscript.ast.AST.OpUnaryPos(this, _term.op(), 1);
        ...
        public de.peeeq.wurstscript.ast.ExprPos right() {
            if(_right == null)
                _right = de.peeeq.wurstscript.ast.AST.ExprPos(this, _term.right(), 2);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.ExprUnary term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_op == null)
                        _op = AST.OpUnaryPos(this, _term.op(), 1);
                    
                    return _op;
                case 2:
                    if(_right == null)
                        _right = AST.ExprPos(this, _term.right(), 2);
                    
                    return _right;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprUnaryPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprUnaryPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprUnaryPos replace(de.peeeq.wurstscript.ast.ExprUnary term) {
            return (de.peeeq.wurstscript.ast.ExprUnaryPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ExprPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseExprUnaryPos(this);
        }
