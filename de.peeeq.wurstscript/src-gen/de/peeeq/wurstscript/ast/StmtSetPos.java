...
public interface StmtSetPos extends de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.StmtSet> {
    ...
    //----- methods of StmtSetPos -----

    public de.peeeq.wurstscript.ast.StmtSet termWStatement();
    ...
    public de.peeeq.wurstscript.ast.StmtSetPos replaceRight(de.peeeq.wurstscript.ast.Expr right);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtSetPos replace(de.peeeq.wurstscript.ast.StmtSet term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtSetPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.StmtSet> implements de.peeeq.wurstscript.ast.StmtSetPos {
        ...
        public de.peeeq.wurstscript.ast.OpAssignmentPos op() {
            if(_op == null)
                _op = de.peeeq.wurstscript.ast.AST.OpAssignmentPos(this, _term.op(), 2);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.StmtSet term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_op == null)
                        _op = AST.OpAssignmentPos(this, _term.op(), 2);
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtSetPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtSetPos invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtSetPos replace(de.peeeq.wurstscript.ast.StmtSet term) {
            return (de.peeeq.wurstscript.ast.StmtSetPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtSetPos(this);
        }
