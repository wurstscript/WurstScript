...
public interface NoExprPos extends de.peeeq.wurstscript.ast.OptExprPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.NoExpr> {

    //----- methods of NoExprPos -----

    public de.peeeq.wurstscript.ast.NoExpr termOptExpr();
    public de.peeeq.wurstscript.ast.NoExpr term();
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.NoExprPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.NoExpr> implements de.peeeq.wurstscript.ast.NoExprPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.NoExpr term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort NoExprPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort NoExprPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.NoExprPos replace(de.peeeq.wurstscript.ast.NoExpr term) {
            return (de.peeeq.wurstscript.ast.NoExprPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OptExprPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseNoExprPos(this);
        }
