...
public interface ExprAtomicPos extends de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of ExprAtomicPos -----

    public de.peeeq.wurstscript.ast.ExprAtomic termExpr();
    public de.peeeq.wurstscript.ast.ExprAtomic termOptExpr();
    public KatjaSort term();
    public de.peeeq.wurstscript.ast.ExprAtomic termExprAtomic();
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ExprAtomicPos.Switch<CT, E> switchClass) throws E;

    //----- nested classes of ExprAtomicPos -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseExprIntValPos(de.peeeq.wurstscript.ast.ExprIntValPos term) throws E;
        public CT CaseExprRealValPos(de.peeeq.wurstscript.ast.ExprRealValPos term) throws E;
        public CT CaseExprStringValPos(de.peeeq.wurstscript.ast.ExprStringValPos term) throws E;
        public CT CaseExprBoolValPos(de.peeeq.wurstscript.ast.ExprBoolValPos term) throws E;
        ...
        public CT CaseExprThisPos(de.peeeq.wurstscript.ast.ExprThisPos term) throws E;
        public CT CaseExprNullPos(de.peeeq.wurstscript.ast.ExprNullPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprAtomicPos.VisitorType<E> {
