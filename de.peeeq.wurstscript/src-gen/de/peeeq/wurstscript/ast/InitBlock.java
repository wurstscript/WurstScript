...
public interface InitBlock extends de.peeeq.wurstscript.ast.WEntity, KatjaTuple {
    ...
    public de.peeeq.wurstscript.ast.InitBlock replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.WStatements body();
    public de.peeeq.wurstscript.ast.InitBlock replaceBody(de.peeeq.wurstscript.ast.WStatements body);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.InitBlock.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.InitBlock {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.WStatements body) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort InitBlock invoked with null parameter source");
            if(body == null)
                throw new IllegalArgumentException("constructor of sort InitBlock invoked with null parameter body");
        ...
        public KatjaTerm get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort InitBlock invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort InitBlock invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.InitBlock replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort InitBlock invoked with negative parameter "+pos);
            if(pos >= 2)
                throw new IllegalArgumentException("replace on sort InitBlock invoked with too large parameter "+pos+", sort has only 2 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort InitBlock invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.WStatements))
                throw new IllegalArgumentException("replace on sort InitBlock invoked with term of incorrect sort, WStatements expected");

            return (de.peeeq.wurstscript.ast.InitBlock) AST.unique(new de.peeeq.wurstscript.ast.InitBlock.Impl(
