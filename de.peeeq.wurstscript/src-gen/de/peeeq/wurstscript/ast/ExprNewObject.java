...
public interface ExprNewObject extends de.peeeq.wurstscript.ast.Expr, de.peeeq.wurstscript.ast.StmtCall, de.peeeq.wurstscript.ast.TypeRef, KatjaTuple {

    //----- methods of ExprNewObject -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.ExprNewObject replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public java.lang.String typeName();
    public de.peeeq.wurstscript.ast.ExprNewObject replaceTypeName(java.lang.String typeName);
    public de.peeeq.wurstscript.ast.Arguments args();
    public de.peeeq.wurstscript.ast.ExprNewObject replaceArgs(de.peeeq.wurstscript.ast.Arguments args);
    public Object get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ExprNewObject replace(int pos, Object term);
    ...
    //----- nested classes of ExprNewObject -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprNewObject.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.ExprNewObject {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, java.lang.String typeName, de.peeeq.wurstscript.ast.Arguments args) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort ExprNewObject invoked with null parameter source");
            if(typeName == null)
                throw new IllegalArgumentException("constructor of sort ExprNewObject invoked with null parameter typeName");
            if(args == null)
                throw new IllegalArgumentException("constructor of sort ExprNewObject invoked with null parameter args");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprNewObject invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprNewObject invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprNewObject replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort ExprNewObject invoked with negative parameter "+pos);
            if(pos >= 3)
                throw new IllegalArgumentException("replace on sort ExprNewObject invoked with too large parameter "+pos+", sort has only 3 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort ExprNewObject invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof java.lang.String))
                throw new IllegalArgumentException("replace on sort ExprNewObject invoked with term of incorrect sort, String expected");
            if(pos == 2 && !(term instanceof de.peeeq.wurstscript.ast.Arguments))
                throw new IllegalArgumentException("replace on sort ExprNewObject invoked with term of incorrect sort, Arguments expected");

            return (de.peeeq.wurstscript.ast.ExprNewObject) AST.unique(new de.peeeq.wurstscript.ast.ExprNewObject.Impl(
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.Expr.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseExprNewObject(this);
        }
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.ExprNewObject");
            builder.append("( ");
