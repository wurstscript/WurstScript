...
public interface ExprVarArrayAccessPos extends de.peeeq.wurstscript.ast.ExprAssignablePos, de.peeeq.wurstscript.ast.ExprAtomicPos, de.peeeq.wurstscript.ast.VarRefPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.ExprVarArrayAccess> {

    //----- methods of ExprVarArrayAccessPos -----

    public de.peeeq.wurstscript.ast.ExprVarArrayAccess termExprAssignable();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccess termExprAtomic();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccess termVarRef();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccess termExpr();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccess termOptExpr();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccess term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccessPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.StringPos varName();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccessPos replaceVarName(java.lang.String varName);
    public de.peeeq.wurstscript.ast.IndexesPos indexes();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccessPos replaceIndexes(de.peeeq.wurstscript.ast.Indexes indexes);
    public de.peeeq.wurstscript.ast.AST.TermPos<?> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ExprVarArrayAccessPos replace(de.peeeq.wurstscript.ast.ExprVarArrayAccess term);
    ...
    //----- nested classes of ExprVarArrayAccessPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprVarArrayAccessPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.ExprVarArrayAccess> implements de.peeeq.wurstscript.ast.ExprVarArrayAccessPos {
        ...
        public de.peeeq.wurstscript.ast.IndexesPos indexes() {
            if(_indexes == null)
                _indexes = de.peeeq.wurstscript.ast.AST.IndexesPos(this, _term.indexes(), 2);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.ExprVarArrayAccess term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.TermPos<?> get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_indexes == null)
                        _indexes = AST.IndexesPos(this, _term.indexes(), 2);
                    
                    return _indexes;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprVarArrayAccessPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprVarArrayAccessPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprVarArrayAccessPos replace(de.peeeq.wurstscript.ast.ExprVarArrayAccess term) {
            return (de.peeeq.wurstscript.ast.ExprVarArrayAccessPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ExprAssignablePos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseExprVarArrayAccessPos(this);
        }
