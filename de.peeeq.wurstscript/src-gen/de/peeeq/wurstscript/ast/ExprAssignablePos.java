...
public interface ExprAssignablePos extends de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.AST.SortPos {
    ...
    //----- methods of ExprAssignablePos -----

    public de.peeeq.wurstscript.ast.ExprAssignable termExpr();
    public de.peeeq.wurstscript.ast.ExprAssignable termOptExpr();
    public KatjaSort term();
    public de.peeeq.wurstscript.ast.ExprAssignable termExprAssignable();
    ...
    //----- nested classes of ExprAssignablePos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprAssignablePos.VisitorType<E> {
