...
public interface OptTypeExpr extends KatjaSort {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OptTypeExpr.VisitorType<E> {
