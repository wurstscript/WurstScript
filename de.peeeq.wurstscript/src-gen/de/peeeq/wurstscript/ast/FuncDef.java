...
public interface FuncDef extends de.peeeq.wurstscript.ast.ClassMember, de.peeeq.wurstscript.ast.FunctionDefinition, de.peeeq.wurstscript.ast.WEntity, de.peeeq.wurstscript.ast.WScope, KatjaTuple {
    ...
    public de.peeeq.wurstscript.ast.FuncDef replaceVisibility(de.peeeq.wurstscript.ast.VisibilityModifier visibility);
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.FuncDef {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.VisibilityModifier visibility, de.peeeq.wurstscript.ast.FuncSignature signature, de.peeeq.wurstscript.ast.WStatements body) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort FuncDef invoked with null parameter source");
            if(visibility == null)
                throw new IllegalArgumentException("constructor of sort FuncDef invoked with null parameter visibility");
            if(signature == null)
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                case 2: return _signature;
                case 3: return _body;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort FuncDef invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort FuncDef invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.FuncDef replace(int pos, Object term) {
            ...
            if(pos >= 4)
                throw new IllegalArgumentException("replace on sort FuncDef invoked with too large parameter "+pos+", sort has only 4 components");
            ...
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.VisibilityModifier))
                throw new IllegalArgumentException("replace on sort FuncDef invoked with term of incorrect sort, VisibilityModifier expected");
            if(pos == 2 && !(term instanceof de.peeeq.wurstscript.ast.FuncSignature))
            ...
            return (de.peeeq.wurstscript.ast.FuncDef) AST.unique(new de.peeeq.wurstscript.ast.FuncDef.Impl(
                ...
                pos == 2 ? (de.peeeq.wurstscript.ast.FuncSignature) term : _signature,
