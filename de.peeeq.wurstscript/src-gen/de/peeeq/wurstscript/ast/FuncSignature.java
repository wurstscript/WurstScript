...
public interface FuncSignature extends KatjaTuple {

    //----- methods of FuncSignature -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.FuncSignature replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public java.lang.String name();
    public de.peeeq.wurstscript.ast.FuncSignature replaceName(java.lang.String name);
    public de.peeeq.wurstscript.ast.WParameters parameters();
    public de.peeeq.wurstscript.ast.FuncSignature replaceParameters(de.peeeq.wurstscript.ast.WParameters parameters);
    public de.peeeq.wurstscript.ast.OptTypeExpr typ();
    public de.peeeq.wurstscript.ast.FuncSignature replaceTyp(de.peeeq.wurstscript.ast.OptTypeExpr typ);
    public Object get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.FuncSignature replace(int pos, Object term);

    //----- nested classes of FuncSignature -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.FuncSignature.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.FuncSignature {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPos _source = null;
        private java.lang.String _name = null;
        private de.peeeq.wurstscript.ast.WParameters _parameters = null;
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, java.lang.String name, de.peeeq.wurstscript.ast.WParameters parameters, de.peeeq.wurstscript.ast.OptTypeExpr typ) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort FuncSignature invoked with null parameter source");
            if(name == null)
                throw new IllegalArgumentException("constructor of sort FuncSignature invoked with null parameter name");
            if(parameters == null)
                throw new IllegalArgumentException("constructor of sort FuncSignature invoked with null parameter parameters");
            if(typ == null)
                throw new IllegalArgumentException("constructor of sort FuncSignature invoked with null parameter typ");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                case 1: return _name;
                case 2: return _parameters;
                case 3: return _typ;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort FuncSignature invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort FuncSignature invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.FuncSignature replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort FuncSignature invoked with negative parameter "+pos);
            if(pos >= 4)
                throw new IllegalArgumentException("replace on sort FuncSignature invoked with too large parameter "+pos+", sort has only 4 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort FuncSignature invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof java.lang.String))
                throw new IllegalArgumentException("replace on sort FuncSignature invoked with term of incorrect sort, String expected");
            if(pos == 2 && !(term instanceof de.peeeq.wurstscript.ast.WParameters))
                throw new IllegalArgumentException("replace on sort FuncSignature invoked with term of incorrect sort, WParameters expected");
            if(pos == 3 && !(term instanceof de.peeeq.wurstscript.ast.OptTypeExpr))
                throw new IllegalArgumentException("replace on sort FuncSignature invoked with term of incorrect sort, OptTypeExpr expected");

            return (de.peeeq.wurstscript.ast.FuncSignature) AST.unique(new de.peeeq.wurstscript.ast.FuncSignature.Impl(
                pos == 0 ? (de.peeeq.wurstscript.ast.WPos) term : _source,
                pos == 1 ? (java.lang.String) term : _name,
                pos == 2 ? (de.peeeq.wurstscript.ast.WParameters) term : _parameters,
                pos == 3 ? (de.peeeq.wurstscript.ast.OptTypeExpr) term : _typ
            ));
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.FuncSignature");
            builder.append("( ");
            _source.toJavaCode(builder);
            builder.append(", ");
            builder.append("\"").append(_name.toString()).append("\"");
            builder.append(", ");
            _parameters.toJavaCode(builder);
            builder.append(", ");
        ...
        public Appendable toString(Appendable builder) throws IOException {
            builder.append("FuncSignature");
            builder.append("( ");
            _source.toString(builder);
            builder.append(", ");
            builder.append("\"").append(_name.toString()).append("\"");
            builder.append(", ");
            _parameters.toString(builder);
            builder.append(", ");
