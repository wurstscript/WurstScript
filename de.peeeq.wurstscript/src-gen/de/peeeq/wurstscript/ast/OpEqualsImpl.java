...
class OpEqualsImpl implements OpEquals, AstElementIntern {
	OpEqualsImpl() {
	}
	...
	@Override public void accept(OpEquals.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpEquals(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpEquals(this);
	}
