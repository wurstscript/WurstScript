...
public interface OptExpr extends KatjaSort {

    //----- methods of OptExpr -----

    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OptExpr.Switch<CT, E> switchClass) throws E;

    //----- nested classes of OptExpr -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.Expr.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseNoExpr(de.peeeq.wurstscript.ast.NoExpr term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OptExpr.VisitorType<E> {
