...
public interface VarRefPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of VarRefPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.VarRef termVarRef();
    ...
    //----- nested classes of VarRefPos -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseExprVarArrayAccessPos(de.peeeq.wurstscript.ast.ExprVarArrayAccessPos term) throws E;
        public CT CaseExprVarAccessPos(de.peeeq.wurstscript.ast.ExprVarAccessPos term) throws E;
    ...
    static interface VisitorType<E extends Throwable> {
        ...
        public void visit(de.peeeq.wurstscript.ast.VarRefPos term) throws E;
    }

    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.VarRefPos.VisitorType<E> {
        ...
        private final de.peeeq.wurstscript.ast.VarRefPos.Switch<Object, E> variantVisit$VarRefPos = new de.peeeq.wurstscript.ast.VarRefPos.Switch<Object, E>() { public final Object CaseExprVarArrayAccessPos(de.peeeq.wurstscript.ast.ExprVarArrayAccessPos term) throws E { visit(term); return null; } public final Object CaseExprVarAccessPos(de.peeeq.wurstscript.ast.ExprVarAccessPos term) throws E { visit(term); return null; } public final Object CaseExprMemberVarPos(de.peeeq.wurstscript.ast.ExprMemberVarPos term) throws E { visit(term); return null; } public final Object CaseExprMemberArrayVarPos(de.peeeq.wurstscript.ast.ExprMemberArrayVarPos term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.wurstscript.ast.VarRefPos term) throws E {
            term.Switch(variantVisit$VarRefPos);
        }
    }
}
