...
public interface StmtReturn extends de.peeeq.wurstscript.ast.WStatement, KatjaTuple {

    //----- methods of StmtReturn -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtReturn.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.StmtReturn {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.OptExpr obj) {
            ...
            if(obj == null)
                throw new IllegalArgumentException("constructor of sort StmtReturn invoked with null parameter obj");
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtReturn invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtReturn invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtReturn replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort StmtReturn invoked with negative parameter "+pos);
            if(pos >= 2)
                throw new IllegalArgumentException("replace on sort StmtReturn invoked with too large parameter "+pos+", sort has only 2 components");
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtReturn(this);
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.StmtReturn");
            builder.append("( ");
