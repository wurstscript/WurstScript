...
public interface OpModRealPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpModReal> {

    //----- methods of OpModRealPos -----

    public de.peeeq.wurstscript.ast.OpModReal termOpBinary();
    public de.peeeq.wurstscript.ast.OpModReal termOp();
    public de.peeeq.wurstscript.ast.OpModReal term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpModRealPos replace(de.peeeq.wurstscript.ast.OpModReal term);
    ...
    //----- nested classes of OpModRealPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpModRealPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpModReal> implements de.peeeq.wurstscript.ast.OpModRealPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpModReal term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpModRealPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpModRealPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpModRealPos replace(de.peeeq.wurstscript.ast.OpModReal term) {
            return (de.peeeq.wurstscript.ast.OpModRealPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpModRealPos(this);
        }
