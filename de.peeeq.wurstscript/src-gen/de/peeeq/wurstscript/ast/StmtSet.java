...
public interface StmtSet extends de.peeeq.wurstscript.ast.WStatement, KatjaTuple {
    ...
    public de.peeeq.wurstscript.ast.StmtSet replaceRight(de.peeeq.wurstscript.ast.Expr right);
    public KatjaSort get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtSet replace(int pos, Object term);
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E;

    //----- nested classes of StmtSet -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtSet.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.StmtSet {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.ExprAssignable left, de.peeeq.wurstscript.ast.OpAssignment op, de.peeeq.wurstscript.ast.Expr right) {
            ...
            if(left == null)
                throw new IllegalArgumentException("constructor of sort StmtSet invoked with null parameter left");
            if(op == null)
                throw new IllegalArgumentException("constructor of sort StmtSet invoked with null parameter op");
            if(right == null)
                throw new IllegalArgumentException("constructor of sort StmtSet invoked with null parameter right");
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtSet invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtSet invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtSet replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort StmtSet invoked with negative parameter "+pos);
            if(pos >= 4)
                throw new IllegalArgumentException("replace on sort StmtSet invoked with too large parameter "+pos+", sort has only 4 components");
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtSet(this);
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.StmtSet");
            builder.append("( ");
