...
public interface TopLevelDeclaration extends KatjaSort {

    //----- methods of TopLevelDeclaration -----

    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.TopLevelDeclaration.Switch<CT, E> switchClass) throws E;

    //----- nested classes of TopLevelDeclaration -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.JassToplevelDeclaration.Switch<CT, E> {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.TopLevelDeclaration.VisitorType<E> {
