...
public interface StmtIncRefCountPos extends de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.StmtIncRefCount> {

    //----- methods of StmtIncRefCountPos -----

    public de.peeeq.wurstscript.ast.StmtIncRefCount termWStatement();
    public de.peeeq.wurstscript.ast.StmtIncRefCount term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.StmtIncRefCountPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.ExprPos obj();
    public de.peeeq.wurstscript.ast.StmtIncRefCountPos replaceObj(de.peeeq.wurstscript.ast.Expr obj);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtIncRefCountPos replace(de.peeeq.wurstscript.ast.StmtIncRefCount term);
    ...
    //----- nested classes of StmtIncRefCountPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtIncRefCountPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.StmtIncRefCount> implements de.peeeq.wurstscript.ast.StmtIncRefCountPos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.ExprPos _obj = null;
        ...
        public de.peeeq.wurstscript.ast.ExprPos obj() {
            if(_obj == null)
                _obj = de.peeeq.wurstscript.ast.AST.ExprPos(this, _term.obj(), 1);

            return _obj;
        }

        public de.peeeq.wurstscript.ast.StmtIncRefCountPos replaceObj(de.peeeq.wurstscript.ast.Expr obj) {
            return replace(_term.replaceObj(obj));
        }

        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.StmtIncRefCount term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_obj == null)
                        _obj = AST.ExprPos(this, _term.obj(), 1);
                    
                    return _obj;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtIncRefCountPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtIncRefCountPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtIncRefCountPos replace(de.peeeq.wurstscript.ast.StmtIncRefCount term) {
            return (de.peeeq.wurstscript.ast.StmtIncRefCountPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtIncRefCountPos(this);
        }
