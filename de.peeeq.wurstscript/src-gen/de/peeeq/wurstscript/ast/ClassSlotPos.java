...
public interface ClassSlotPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of ClassSlotPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.ClassSlot termClassSlot();
    ...
    //----- nested classes of ClassSlotPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.ClassMemberPos.Switch<CT, E> {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ClassSlotPos.VisitorType<E> {
