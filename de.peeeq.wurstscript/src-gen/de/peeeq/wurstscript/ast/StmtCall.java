...
public interface StmtCall extends de.peeeq.wurstscript.ast.WStatement, KatjaSort {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtCall.VisitorType<E> {
