...
public interface OpDivIntPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpDivInt> {

    //----- methods of OpDivIntPos -----

    public de.peeeq.wurstscript.ast.OpDivInt termOpBinary();
    public de.peeeq.wurstscript.ast.OpDivInt termOp();
    public de.peeeq.wurstscript.ast.OpDivInt term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpDivIntPos replace(de.peeeq.wurstscript.ast.OpDivInt term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpDivIntPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpDivInt> implements de.peeeq.wurstscript.ast.OpDivIntPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpDivInt term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpDivIntPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpDivIntPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpDivIntPos replace(de.peeeq.wurstscript.ast.OpDivInt term) {
            return (de.peeeq.wurstscript.ast.OpDivIntPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpDivIntPos(this);
        }
