...
public interface ExprStringValPos extends de.peeeq.wurstscript.ast.ExprAtomicPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.ExprStringVal> {

    //----- methods of ExprStringValPos -----

    public de.peeeq.wurstscript.ast.ExprStringVal termExprAtomic();
    public de.peeeq.wurstscript.ast.ExprStringVal termExpr();
    public de.peeeq.wurstscript.ast.ExprStringVal termOptExpr();
    public de.peeeq.wurstscript.ast.ExprStringVal term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.ExprStringValPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.StringPos val();
    public de.peeeq.wurstscript.ast.ExprStringValPos replaceVal(java.lang.String val);
    public de.peeeq.wurstscript.ast.AST.TermPos<?> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ExprStringValPos replace(de.peeeq.wurstscript.ast.ExprStringVal term);
    ...
    //----- nested classes of ExprStringValPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprStringValPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.ExprStringVal> implements de.peeeq.wurstscript.ast.ExprStringValPos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.StringPos _val = null;
        ...
        public de.peeeq.wurstscript.ast.StringPos val() {
            if(_val == null)
                _val = de.peeeq.wurstscript.ast.AST.StringPos(this, _term.val(), 1);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.ExprStringVal term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.TermPos<?> get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_val == null)
                        _val = AST.StringPos(this, _term.val(), 1);
                    
                    return _val;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprStringValPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprStringValPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprStringValPos replace(de.peeeq.wurstscript.ast.ExprStringVal term) {
            return (de.peeeq.wurstscript.ast.ExprStringValPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ExprAtomicPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseExprStringValPos(this);
        }
