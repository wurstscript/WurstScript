...
public interface WEntityPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of WEntityPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.WEntity termWEntity();
    ...
    //----- nested classes of WEntityPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.TypeDefPos.Switch<CT, E> {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.WEntityPos.VisitorType<E> {
