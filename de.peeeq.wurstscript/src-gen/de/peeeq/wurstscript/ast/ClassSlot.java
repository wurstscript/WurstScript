...
public interface ClassSlot extends KatjaSort {
    ...
    //----- nested classes of ClassSlot -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.ClassMember.Switch<CT, E> {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ClassSlot.VisitorType<E> {
