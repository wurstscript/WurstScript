...
class ExprBoolValImpl implements ExprBoolVal, AstElementIntern {
	ExprBoolValImpl(WPos source, boolean val) {
	...
	@Override public ExprBoolVal copy() {
		return new ExprBoolValImpl((WPos) source.copy(), val);
	}
