...
public interface OpGreaterEqPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpGreaterEq> {

    //----- methods of OpGreaterEqPos -----

    public de.peeeq.wurstscript.ast.OpGreaterEq termOpBinary();
    public de.peeeq.wurstscript.ast.OpGreaterEq termOp();
    public de.peeeq.wurstscript.ast.OpGreaterEq term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpGreaterEqPos replace(de.peeeq.wurstscript.ast.OpGreaterEq term);
    ...
    //----- nested classes of OpGreaterEqPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpGreaterEqPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpGreaterEq> implements de.peeeq.wurstscript.ast.OpGreaterEqPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpGreaterEq term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpGreaterEqPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpGreaterEqPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpGreaterEqPos replace(de.peeeq.wurstscript.ast.OpGreaterEq term) {
            return (de.peeeq.wurstscript.ast.OpGreaterEqPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpGreaterEqPos(this);
        }
