...
public interface StringPos extends de.peeeq.wurstscript.ast.AST.LeafPos<java.lang.String> {
    ...
    static class Impl extends KatjaLeafPosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, java.lang.String> implements de.peeeq.wurstscript.ast.StringPos {

        //----- methods of Impl -----

        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, java.lang.String term, int pos) {
