...
public interface ArgumentsPos extends de.peeeq.wurstscript.ast.AST.ListPos<de.peeeq.wurstscript.ast.Arguments, de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.Expr> {

    //----- methods of ArgumentsPos -----

    public de.peeeq.wurstscript.ast.Arguments term();
    public de.peeeq.wurstscript.ast.ArgumentsPos add(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArgumentsPos addAll(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArgumentsPos remove(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArgumentsPos removeAll(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArgumentsPos appBack(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArgumentsPos appFront(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArgumentsPos conc(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArgumentsPos reverse();
    public de.peeeq.wurstscript.ast.ArgumentsPos toSet();
    public de.peeeq.wurstscript.ast.ArgumentsPos setAdd(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArgumentsPos setRemove(de.peeeq.wurstscript.ast.Expr element);
    public de.peeeq.wurstscript.ast.ArgumentsPos setUnion(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArgumentsPos setWithout(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public de.peeeq.wurstscript.ast.ArgumentsPos setIntersection(KatjaList<? extends de.peeeq.wurstscript.ast.Expr> list);
    public KatjaList<de.peeeq.wurstscript.ast.ExprPos> toList();
    public de.peeeq.wurstscript.ast.ArgumentsPos replace(de.peeeq.wurstscript.ast.Arguments term);
    ...
    //----- nested classes of ArgumentsPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ArgumentsPos.VisitorType<E> {
    ...
    static class Impl extends KatjaListPosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.Arguments, de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.Expr> implements de.peeeq.wurstscript.ast.ArgumentsPos {

        //----- methods of Impl -----

        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.Arguments term, int pos) {
        ...
        public KatjaList<de.peeeq.wurstscript.ast.ExprPos> toList() {
            ...
            return new ArgumentsPos.ListImpl(values);
        }

        public de.peeeq.wurstscript.ast.ArgumentsPos replace(de.peeeq.wurstscript.ast.Arguments term) {
            return (de.peeeq.wurstscript.ast.ArgumentsPos) super.replace(term);
        }
