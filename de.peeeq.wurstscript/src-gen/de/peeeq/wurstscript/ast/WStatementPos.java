...
public interface WStatementPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of WStatementPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.WStatement termWStatement();
    ...
    //----- nested classes of WStatementPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.StmtCallPos.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseStmtIfPos(de.peeeq.wurstscript.ast.StmtIfPos term) throws E;
        public CT CaseStmtWhilePos(de.peeeq.wurstscript.ast.StmtWhilePos term) throws E;
        public CT CaseStmtLoopPos(de.peeeq.wurstscript.ast.StmtLoopPos term) throws E;
        public CT CaseLocalVarDefPos(de.peeeq.wurstscript.ast.LocalVarDefPos term) throws E;
        public CT CaseStmtSetPos(de.peeeq.wurstscript.ast.StmtSetPos term) throws E;
        public CT CaseStmtReturnPos(de.peeeq.wurstscript.ast.StmtReturnPos term) throws E;
        public CT CaseStmtDestroyPos(de.peeeq.wurstscript.ast.StmtDestroyPos term) throws E;
        public CT CaseStmtIncRefCountPos(de.peeeq.wurstscript.ast.StmtIncRefCountPos term) throws E;
        public CT CaseStmtDecRefCountPos(de.peeeq.wurstscript.ast.StmtDecRefCountPos term) throws E;
        public CT CaseStmtErrPos(de.peeeq.wurstscript.ast.StmtErrPos term) throws E;
        public CT CaseStmtExitwhenPos(de.peeeq.wurstscript.ast.StmtExitwhenPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.WStatementPos.VisitorType<E> {
