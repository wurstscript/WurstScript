...
public interface WPackage extends de.peeeq.wurstscript.ast.PackageOrGlobal, de.peeeq.wurstscript.ast.TopLevelDeclaration, KatjaTuple {

    //----- methods of WPackage -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.WPackage replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public java.lang.String name();
    public de.peeeq.wurstscript.ast.WPackage replaceName(java.lang.String name);
    public de.peeeq.wurstscript.ast.WImports imports();
    public de.peeeq.wurstscript.ast.WPackage replaceImports(de.peeeq.wurstscript.ast.WImports imports);
    public de.peeeq.wurstscript.ast.WEntities elements();
    public de.peeeq.wurstscript.ast.WPackage replaceElements(de.peeeq.wurstscript.ast.WEntities elements);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.WPackage.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.WPackage {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPos _source = null;
        private java.lang.String _name = null;
        private de.peeeq.wurstscript.ast.WImports _imports = null;
        private de.peeeq.wurstscript.ast.WEntities _elements = null;
        ...
        public de.peeeq.wurstscript.ast.WPackage replaceElements(de.peeeq.wurstscript.ast.WEntities elements) {
            return replace(3, elements);
        }

        Impl(de.peeeq.wurstscript.ast.WPos source, java.lang.String name, de.peeeq.wurstscript.ast.WImports imports, de.peeeq.wurstscript.ast.WEntities elements) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort WPackage invoked with null parameter source");
            if(name == null)
                throw new IllegalArgumentException("constructor of sort WPackage invoked with null parameter name");
            if(imports == null)
                throw new IllegalArgumentException("constructor of sort WPackage invoked with null parameter imports");
            if(elements == null)
                throw new IllegalArgumentException("constructor of sort WPackage invoked with null parameter elements");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                case 1: return _name;
                case 2: return _imports;
                case 3: return _elements;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort WPackage invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort WPackage invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.WPackage replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort WPackage invoked with negative parameter "+pos);
            if(pos >= 4)
                throw new IllegalArgumentException("replace on sort WPackage invoked with too large parameter "+pos+", sort has only 4 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort WPackage invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof java.lang.String))
                throw new IllegalArgumentException("replace on sort WPackage invoked with term of incorrect sort, String expected");
            if(pos == 2 && !(term instanceof de.peeeq.wurstscript.ast.WImports))
                throw new IllegalArgumentException("replace on sort WPackage invoked with term of incorrect sort, WImports expected");
            if(pos == 3 && !(term instanceof de.peeeq.wurstscript.ast.WEntities))
                throw new IllegalArgumentException("replace on sort WPackage invoked with term of incorrect sort, WEntities expected");

            return (de.peeeq.wurstscript.ast.WPackage) AST.unique(new de.peeeq.wurstscript.ast.WPackage.Impl(
