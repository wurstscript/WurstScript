...
class OpModRealImpl implements OpModReal, AstElementIntern {
	OpModRealImpl() {
	}
	...
	@Override public OpModReal copy() {
	...
	@Override public void accept(OpModReal.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpModReal(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpModReal(this);
	}
