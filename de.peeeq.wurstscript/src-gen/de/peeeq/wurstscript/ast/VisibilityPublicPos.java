...
public interface VisibilityPublicPos extends de.peeeq.wurstscript.ast.VisibilityModifierPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.VisibilityPublic> {

    //----- methods of VisibilityPublicPos -----

    public de.peeeq.wurstscript.ast.VisibilityPublic termVisibilityModifier();
    public de.peeeq.wurstscript.ast.VisibilityPublic term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.VisibilityPublicPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.WPosPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.VisibilityPublicPos replace(de.peeeq.wurstscript.ast.VisibilityPublic term);
    ...
    //----- nested classes of VisibilityPublicPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.VisibilityPublicPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.VisibilityPublic> implements de.peeeq.wurstscript.ast.VisibilityPublicPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.VisibilityPublic term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.WPosPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort VisibilityPublicPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort VisibilityPublicPos invoked with too large parameter "+i+", sort has only 1 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.VisibilityPublicPos replace(de.peeeq.wurstscript.ast.VisibilityPublic term) {
            return (de.peeeq.wurstscript.ast.VisibilityPublicPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.VisibilityModifierPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseVisibilityPublicPos(this);
        }
