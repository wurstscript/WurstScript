...
public interface ConstructorDef extends de.peeeq.wurstscript.ast.ClassSlot, de.peeeq.wurstscript.ast.WScope, KatjaTuple {

    //----- methods of ConstructorDef -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.ConstructorDef replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.VisibilityModifier visibility();
    public de.peeeq.wurstscript.ast.ConstructorDef replaceVisibility(de.peeeq.wurstscript.ast.VisibilityModifier visibility);
    public de.peeeq.wurstscript.ast.WParameters params();
    public de.peeeq.wurstscript.ast.ConstructorDef replaceParams(de.peeeq.wurstscript.ast.WParameters params);
    public de.peeeq.wurstscript.ast.WStatements body();
    public de.peeeq.wurstscript.ast.ConstructorDef replaceBody(de.peeeq.wurstscript.ast.WStatements body);
    public KatjaSort get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ConstructorDef replace(int pos, Object term);
    ...
    //----- nested classes of ConstructorDef -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ConstructorDef.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.ConstructorDef {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPos _source = null;
        private de.peeeq.wurstscript.ast.VisibilityModifier _visibility = null;
        private de.peeeq.wurstscript.ast.WParameters _params = null;
        ...
        public de.peeeq.wurstscript.ast.ConstructorDef replaceBody(de.peeeq.wurstscript.ast.WStatements body) {
            return replace(3, body);
        }

        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.VisibilityModifier visibility, de.peeeq.wurstscript.ast.WParameters params, de.peeeq.wurstscript.ast.WStatements body) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort ConstructorDef invoked with null parameter source");
            if(visibility == null)
                throw new IllegalArgumentException("constructor of sort ConstructorDef invoked with null parameter visibility");
            if(params == null)
                throw new IllegalArgumentException("constructor of sort ConstructorDef invoked with null parameter params");
            if(body == null)
                throw new IllegalArgumentException("constructor of sort ConstructorDef invoked with null parameter body");
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ConstructorDef invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ConstructorDef invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ConstructorDef replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort ConstructorDef invoked with negative parameter "+pos);
            if(pos >= 4)
                throw new IllegalArgumentException("replace on sort ConstructorDef invoked with too large parameter "+pos+", sort has only 4 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort ConstructorDef invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.VisibilityModifier))
                throw new IllegalArgumentException("replace on sort ConstructorDef invoked with term of incorrect sort, VisibilityModifier expected");
            if(pos == 2 && !(term instanceof de.peeeq.wurstscript.ast.WParameters))
                throw new IllegalArgumentException("replace on sort ConstructorDef invoked with term of incorrect sort, WParameters expected");
            if(pos == 3 && !(term instanceof de.peeeq.wurstscript.ast.WStatements))
                throw new IllegalArgumentException("replace on sort ConstructorDef invoked with term of incorrect sort, WStatements expected");

            return (de.peeeq.wurstscript.ast.ConstructorDef) AST.unique(new de.peeeq.wurstscript.ast.ConstructorDef.Impl(
                pos == 0 ? (de.peeeq.wurstscript.ast.WPos) term : _source,
                pos == 1 ? (de.peeeq.wurstscript.ast.VisibilityModifier) term : _visibility,
                pos == 2 ? (de.peeeq.wurstscript.ast.WParameters) term : _params,
                pos == 3 ? (de.peeeq.wurstscript.ast.WStatements) term : _body
            ));
        }

        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ClassSlot.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseConstructorDef(this);
        }
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.ConstructorDef");
            builder.append("( ");
