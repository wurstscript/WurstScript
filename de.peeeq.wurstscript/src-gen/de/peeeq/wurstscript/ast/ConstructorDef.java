...
public interface ConstructorDef extends de.peeeq.wurstscript.ast.ClassSlot, de.peeeq.wurstscript.ast.WScope, KatjaTuple {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.ConstructorDef {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.WParameters params, de.peeeq.wurstscript.ast.WStatements body) {
            if(source == null)
        ...
        public KatjaTerm get(int i) {
            ...
            switch(ith) {
                ...
                case 1: return _params;
                case 2: return _body;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ConstructorDef invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ConstructorDef invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ConstructorDef replace(int pos, Object term) {
            ...
            if(pos >= 3)
                throw new IllegalArgumentException("replace on sort ConstructorDef invoked with too large parameter "+pos+", sort has only 3 components");
            ...
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.WParameters))
            ...
            return (de.peeeq.wurstscript.ast.ConstructorDef) AST.unique(new de.peeeq.wurstscript.ast.ConstructorDef.Impl(
                ...
                pos == 1 ? (de.peeeq.wurstscript.ast.WParameters) term : _params,
