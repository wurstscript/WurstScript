...
class OpGreaterImpl implements OpGreater, AstElementIntern {
	OpGreaterImpl() {
	}
	...
	@Override public OpGreater copy() {
	...
	@Override public void accept(OpGreater.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpGreater(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpGreater(this);
	}
