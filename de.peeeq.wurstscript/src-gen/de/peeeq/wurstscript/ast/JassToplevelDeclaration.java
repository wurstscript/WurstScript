...
public interface JassToplevelDeclaration extends de.peeeq.wurstscript.ast.TopLevelDeclaration, KatjaSort {

    //----- methods of JassToplevelDeclaration -----
    ...
    //----- nested classes of JassToplevelDeclaration -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.FunctionDefinition.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseJassGlobalBlock(de.peeeq.wurstscript.ast.JassGlobalBlock term) throws E;
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.JassToplevelDeclaration.VisitorType<E> {
