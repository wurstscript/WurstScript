...
class OpNotImpl implements OpNot, AstElementIntern {
	OpNotImpl() {
	}
	...
	@Override public void accept(OpNot.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(Op.Matcher<T> matcher) {
		return matcher.case_OpNot(this);
	}
	@Override public void match(Op.MatcherVoid matcher) {
		matcher.case_OpNot(this);
	}
