...
public interface ClassDefPos extends de.peeeq.wurstscript.ast.TypeDefPos, de.peeeq.wurstscript.ast.WScopePos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.ClassDef> {
    ...
    public de.peeeq.wurstscript.ast.ClassDefPos replaceVisibility(de.peeeq.wurstscript.ast.VisibilityModifier visibility);
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.ClassDef> implements de.peeeq.wurstscript.ast.ClassDefPos {
        ...
        public de.peeeq.wurstscript.ast.BooleanPos unmanaged() {
            if(_unmanaged == null)
                _unmanaged = de.peeeq.wurstscript.ast.AST.BooleanPos(this, _term.unmanaged(), 3);
        ...
        public de.peeeq.wurstscript.ast.ClassSlotsPos slots() {
            if(_slots == null)
                _slots = de.peeeq.wurstscript.ast.AST.ClassSlotsPos(this, _term.slots(), 4);
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 3:
                    if(_unmanaged == null)
                        _unmanaged = AST.BooleanPos(this, _term.unmanaged(), 3);
                    
                    return _unmanaged;
                case 4:
                    if(_slots == null)
                        _slots = AST.ClassSlotsPos(this, _term.slots(), 4);
                ...
                default:
                    if(ith < 0) {
                        ...
                        throw new IllegalArgumentException("get on sort ClassDefPos invoked with too large parameter "+i+", sort has only 5 components");
                    }
            }
        }
