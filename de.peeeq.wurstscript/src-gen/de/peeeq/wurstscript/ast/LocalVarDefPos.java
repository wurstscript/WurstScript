...
public interface LocalVarDefPos extends de.peeeq.wurstscript.ast.VarDefPos, de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.LocalVarDef> {

    //----- methods of LocalVarDefPos -----

    public de.peeeq.wurstscript.ast.LocalVarDef termVarDef();
    public de.peeeq.wurstscript.ast.LocalVarDef termWStatement();
    public de.peeeq.wurstscript.ast.LocalVarDef term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.LocalVarDefPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.BooleanPos constant();
    public de.peeeq.wurstscript.ast.LocalVarDefPos replaceConstant(java.lang.Boolean constant);
    public de.peeeq.wurstscript.ast.OptTypeExprPos typ();
    public de.peeeq.wurstscript.ast.LocalVarDefPos replaceTyp(de.peeeq.wurstscript.ast.OptTypeExpr typ);
    public de.peeeq.wurstscript.ast.StringPos name();
    public de.peeeq.wurstscript.ast.LocalVarDefPos replaceName(java.lang.String name);
    public de.peeeq.wurstscript.ast.OptExprPos initialExpr();
    public de.peeeq.wurstscript.ast.LocalVarDefPos replaceInitialExpr(de.peeeq.wurstscript.ast.OptExpr initialExpr);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.LocalVarDefPos replace(de.peeeq.wurstscript.ast.LocalVarDef term);
    ...
    //----- nested classes of LocalVarDefPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.LocalVarDefPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.LocalVarDef> implements de.peeeq.wurstscript.ast.LocalVarDefPos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.BooleanPos _constant = null;
        ...
        public de.peeeq.wurstscript.ast.BooleanPos constant() {
            if(_constant == null)
                _constant = de.peeeq.wurstscript.ast.AST.BooleanPos(this, _term.constant(), 1);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.LocalVarDef term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_constant == null)
                        _constant = AST.BooleanPos(this, _term.constant(), 1);
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort LocalVarDefPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort LocalVarDefPos invoked with too large parameter "+i+", sort has only 5 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.LocalVarDefPos replace(de.peeeq.wurstscript.ast.LocalVarDef term) {
            return (de.peeeq.wurstscript.ast.LocalVarDefPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.VarDefPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseLocalVarDefPos(this);
        }
