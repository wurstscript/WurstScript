...
public interface GlobalVarDef extends de.peeeq.wurstscript.ast.ClassMember, de.peeeq.wurstscript.ast.VarDef, de.peeeq.wurstscript.ast.WEntity, KatjaTuple {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.GlobalVarDef {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, java.lang.Boolean isConstant, de.peeeq.wurstscript.ast.OptTypeExpr typ, java.lang.String name, de.peeeq.wurstscript.ast.OptExpr initialExpr) {
            if(source == null)
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        ...
                        throw new IllegalArgumentException("get on sort GlobalVarDef invoked with too large parameter "+i+", sort has only 5 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.GlobalVarDef replace(int pos, Object term) {
            ...
            if(pos >= 5)
                throw new IllegalArgumentException("replace on sort GlobalVarDef invoked with too large parameter "+pos+", sort has only 5 components");
            ...
            return (de.peeeq.wurstscript.ast.GlobalVarDef) AST.unique(new de.peeeq.wurstscript.ast.GlobalVarDef.Impl(
                ...
                pos == 1 ? (java.lang.Boolean) term : _isConstant,
