...
public abstract class WStatements extends ParseqList<WStatement> implements AstElement{
	public WStatements copy() {
		WStatements result = new WStatementsImpl();
		for (WStatement elem : this) {
			result.add((WStatement) elem.copy());
		}
		return result;
	}
	...
	public abstract boolean attrDoesReturn();
}
