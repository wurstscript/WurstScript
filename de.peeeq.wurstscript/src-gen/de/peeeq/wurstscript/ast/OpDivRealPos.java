...
public interface OpDivRealPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpDivReal> {

    //----- methods of OpDivRealPos -----

    public de.peeeq.wurstscript.ast.OpDivReal termOpBinary();
    public de.peeeq.wurstscript.ast.OpDivReal termOp();
    public de.peeeq.wurstscript.ast.OpDivReal term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpDivRealPos replace(de.peeeq.wurstscript.ast.OpDivReal term);
    ...
    //----- nested classes of OpDivRealPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpDivRealPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpDivReal> implements de.peeeq.wurstscript.ast.OpDivRealPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpDivReal term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpDivRealPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpDivRealPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpDivRealPos replace(de.peeeq.wurstscript.ast.OpDivReal term) {
            return (de.peeeq.wurstscript.ast.OpDivRealPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpDivRealPos(this);
        }
