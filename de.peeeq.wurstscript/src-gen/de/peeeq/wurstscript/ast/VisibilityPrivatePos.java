...
public interface VisibilityPrivatePos extends de.peeeq.wurstscript.ast.VisibilityModifierPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.VisibilityPrivate> {

    //----- methods of VisibilityPrivatePos -----

    public de.peeeq.wurstscript.ast.VisibilityPrivate termVisibilityModifier();
    public de.peeeq.wurstscript.ast.VisibilityPrivate term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.VisibilityPrivatePos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.WPosPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.VisibilityPrivatePos replace(de.peeeq.wurstscript.ast.VisibilityPrivate term);
    ...
    //----- nested classes of VisibilityPrivatePos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.VisibilityPrivatePos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.VisibilityPrivate> implements de.peeeq.wurstscript.ast.VisibilityPrivatePos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.VisibilityPrivate term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.WPosPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort VisibilityPrivatePos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort VisibilityPrivatePos invoked with too large parameter "+i+", sort has only 1 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.VisibilityPrivatePos replace(de.peeeq.wurstscript.ast.VisibilityPrivate term) {
            return (de.peeeq.wurstscript.ast.VisibilityPrivatePos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.VisibilityModifierPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseVisibilityPrivatePos(this);
        }
