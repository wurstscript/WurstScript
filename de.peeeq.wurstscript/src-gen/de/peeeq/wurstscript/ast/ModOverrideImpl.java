...
class ModOverrideImpl implements ModOverride, AstElementIntern {
	ModOverrideImpl(WPos source) {
	...
	@Override public ModOverride copy() {
		return new ModOverrideImpl((WPos) source.copy());
	}
	...
	@Override public <T> T match(Modifier.Matcher<T> matcher) {
		return matcher.case_ModOverride(this);
	}
	@Override public void match(Modifier.MatcherVoid matcher) {
		matcher.case_ModOverride(this);
	}

	@Override public String toString() {
		return "ModOverride(" + source+")";
	}
