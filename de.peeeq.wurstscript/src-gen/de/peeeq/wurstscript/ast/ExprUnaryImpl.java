...
class ExprUnaryImpl implements ExprUnary, AstElementIntern {
	ExprUnaryImpl(WPos source, OpUnary op, Expr right) {
	...
	private OpUnary op;
	public void setOp(OpUnary op) {
		if (op == null) throw new IllegalArgumentException();
		((AstElementIntern)this.op).setParent(null);
		((AstElementIntern)op).setParent(this);
		this.op = op;
	} 
	public OpUnary getOp() { return op; }
	...
	@Override public ExprUnary copy() {
		return new ExprUnaryImpl((WPos) source.copy(), (OpUnary) op.copy(), (Expr) right.copy());
	}
	...
	@Override public String toString() {
		return "ExprUnary(" + source + ", " +op + ", " +right+")";
	}
