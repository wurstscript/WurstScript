...
class ExprRealValImpl implements ExprRealVal, AstElementIntern {
	ExprRealValImpl(WPos source, double val) {
	...
	@Override public ExprRealVal copy() {
		return new ExprRealValImpl((WPos) source.copy(), val);
	}
	...
	@Override public <T> T match(OptExpr.Matcher<T> matcher) {
		return matcher.case_ExprRealVal(this);
	}
	@Override public void match(OptExpr.MatcherVoid matcher) {
		matcher.case_ExprRealVal(this);
	}
