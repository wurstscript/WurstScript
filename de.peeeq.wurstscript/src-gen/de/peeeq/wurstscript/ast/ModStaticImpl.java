...
class ModStaticImpl implements ModStatic, AstElementIntern {
	ModStaticImpl(WPos source) {
	...
	@Override public ModStatic copy() {
		return new ModStaticImpl((WPos) source.copy());
	}
	...
	@Override public <T> T match(Modifier.Matcher<T> matcher) {
		return matcher.case_ModStatic(this);
	}
	@Override public void match(Modifier.MatcherVoid matcher) {
		matcher.case_ModStatic(this);
	}

	@Override public String toString() {
		return "ModStatic(" + source+")";
	}
