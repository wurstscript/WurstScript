...
public interface StmtCallPos extends de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of StmtCallPos -----

    public de.peeeq.wurstscript.ast.StmtCall termWStatement();
    public KatjaSort term();
    public de.peeeq.wurstscript.ast.StmtCall termStmtCall();
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtCallPos.VisitorType<E> {
