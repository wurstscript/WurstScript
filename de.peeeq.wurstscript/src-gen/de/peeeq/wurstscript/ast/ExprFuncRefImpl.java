...
class ExprFuncRefImpl implements ExprFuncRef, AstElementIntern {
	ExprFuncRefImpl(WPos source, String funcName) {
	...
	@Override public ExprFuncRef copy() {
		return new ExprFuncRefImpl((WPos) source.copy(), funcName);
	}
	...
	@Override public <T> T match(FuncRef.Matcher<T> matcher) {
		return matcher.case_ExprFuncRef(this);
	}
	@Override public void match(FuncRef.MatcherVoid matcher) {
		matcher.case_ExprFuncRef(this);
	}
	...
	@Override public String toString() {
		return "ExprFuncRef(" + source + ", " +funcName+")";
	}
