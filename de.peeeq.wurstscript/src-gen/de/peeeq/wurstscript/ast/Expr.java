...
public interface Expr extends de.peeeq.wurstscript.ast.OptExpr, KatjaSort {
    ...
    //----- nested classes of Expr -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.ExprAssignable.Switch<CT, E>, de.peeeq.wurstscript.ast.ExprAtomic.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseExprBinary(de.peeeq.wurstscript.ast.ExprBinary term) throws E;
        public CT CaseExprUnary(de.peeeq.wurstscript.ast.ExprUnary term) throws E;
        ...
        public CT CaseExprNewObject(de.peeeq.wurstscript.ast.ExprNewObject term) throws E;
        public CT CaseExprCast(de.peeeq.wurstscript.ast.ExprCast term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.Expr.VisitorType<E> {
