...
public interface WPackagePos extends de.peeeq.wurstscript.ast.PackageOrGlobalPos, de.peeeq.wurstscript.ast.TopLevelDeclarationPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.WPackage> {

    //----- methods of WPackagePos -----

    public de.peeeq.wurstscript.ast.WPackage termPackageOrGlobal();
    ...
    public de.peeeq.wurstscript.ast.WPackagePos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.StringPos name();
    public de.peeeq.wurstscript.ast.WPackagePos replaceName(java.lang.String name);
    public de.peeeq.wurstscript.ast.WImportsPos imports();
    public de.peeeq.wurstscript.ast.WPackagePos replaceImports(de.peeeq.wurstscript.ast.WImports imports);
    public de.peeeq.wurstscript.ast.WEntitiesPos elements();
    public de.peeeq.wurstscript.ast.WPackagePos replaceElements(de.peeeq.wurstscript.ast.WEntities elements);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.WPackagePos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.WPackage> implements de.peeeq.wurstscript.ast.WPackagePos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.StringPos _name = null;
        private de.peeeq.wurstscript.ast.WImportsPos _imports = null;
        ...
        public de.peeeq.wurstscript.ast.WImportsPos imports() {
            if(_imports == null)
                _imports = de.peeeq.wurstscript.ast.AST.WImportsPos(this, _term.imports(), 2);
        ...
        public de.peeeq.wurstscript.ast.WEntitiesPos elements() {
            if(_elements == null)
                _elements = de.peeeq.wurstscript.ast.AST.WEntitiesPos(this, _term.elements(), 3);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.WPackage term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.TermPos<?> get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_imports == null)
                        _imports = AST.WImportsPos(this, _term.imports(), 2);
                    
                    return _imports;
                case 3:
                    if(_elements == null)
                        _elements = AST.WEntitiesPos(this, _term.elements(), 3);
                    
                    return _elements;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort WPackagePos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort WPackagePos invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.WPackagePos replace(de.peeeq.wurstscript.ast.WPackage term) {
            return (de.peeeq.wurstscript.ast.WPackagePos) super.replace(term);
        }
