...
class ExprMemberArrayVarImpl implements ExprMemberArrayVar, AstElementIntern {
	ExprMemberArrayVarImpl(WPos source, Expr left, String varName, Indexes indexes) {
	...
	public ExprMemberArrayVar copy() {
		return new ExprMemberArrayVarImpl(source.copy(), left.copy(), varName, indexes.copy());
	}
	...
	@Override public String toString() {
		return "ExprMemberArrayVar(" + source + ", " +left + ", " +varName + ", " +indexes+")";
	}
	...
	private boolean attr_attrVarDef_isCached = false;
	private VarDef attr_attrVarDef_cache;
	public VarDef attrVarDef() {
		if (!attr_attrVarDef_isCached) {
			attr_attrVarDef_cache = de.peeeq.wurstscript.attributes.AttrVarDef.calculate(this);
			attr_attrVarDef_isCached = true;
		}
		return attr_attrVarDef_cache;
	}
