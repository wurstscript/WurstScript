...
public interface StmtErrPos extends de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.StmtErr> {

    //----- methods of StmtErrPos -----

    public de.peeeq.wurstscript.ast.StmtErr termWStatement();
    public de.peeeq.wurstscript.ast.StmtErr term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.StmtErrPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.WPosPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtErrPos replace(de.peeeq.wurstscript.ast.StmtErr term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtErrPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.StmtErr> implements de.peeeq.wurstscript.ast.StmtErrPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.StmtErr term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.WPosPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtErrPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtErrPos invoked with too large parameter "+i+", sort has only 1 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtErrPos replace(de.peeeq.wurstscript.ast.StmtErr term) {
            return (de.peeeq.wurstscript.ast.StmtErrPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtErrPos(this);
        }
