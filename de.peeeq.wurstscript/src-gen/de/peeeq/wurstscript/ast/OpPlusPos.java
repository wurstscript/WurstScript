...
public interface OpPlusPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpPlus> {

    //----- methods of OpPlusPos -----

    public de.peeeq.wurstscript.ast.OpPlus termOpBinary();
    public de.peeeq.wurstscript.ast.OpPlus termOp();
    public de.peeeq.wurstscript.ast.OpPlus term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpPlusPos replace(de.peeeq.wurstscript.ast.OpPlus term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpPlusPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpPlus> implements de.peeeq.wurstscript.ast.OpPlusPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpPlus term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpPlusPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpPlusPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpPlusPos replace(de.peeeq.wurstscript.ast.OpPlus term) {
            return (de.peeeq.wurstscript.ast.OpPlusPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpPlusPos(this);
        }
