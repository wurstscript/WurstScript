...
public interface FunctionDefinition extends AstElement, JassToplevelDeclaration, AstElementWithModifier{
	...
	public abstract java.util.Collection<de.peeeq.wurstscript.attributes.FuncDefInstance> attrOverriddenFunctions();
}
