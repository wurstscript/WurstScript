...
public interface OptTypeExprPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of OptTypeExprPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.OptTypeExpr termOptTypeExpr();
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OptTypeExprPos.Switch<CT, E> switchClass) throws E;

    //----- nested classes of OptTypeExprPos -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseNoTypeExprPos(de.peeeq.wurstscript.ast.NoTypeExprPos term) throws E;
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OptTypeExprPos.VisitorType<E> {
