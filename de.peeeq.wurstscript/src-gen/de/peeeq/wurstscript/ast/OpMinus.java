...
public interface OpMinus extends AstElement, OpBinary, OpUnary {
	...
	public abstract void accept(OpUnary.Visitor v);
	...
	public abstract void accept(OpMinus.Visitor v);
