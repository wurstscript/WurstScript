...
public interface PackageOrGlobalPos extends de.peeeq.wurstscript.ast.WScopePos, de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of PackageOrGlobalPos -----

    public de.peeeq.wurstscript.ast.PackageOrGlobal termWScope();
    public KatjaSort term();
    public de.peeeq.wurstscript.ast.PackageOrGlobal termPackageOrGlobal();
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.PackageOrGlobalPos.Switch<CT, E> switchClass) throws E;

    //----- nested classes of PackageOrGlobalPos -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseWPackagePos(de.peeeq.wurstscript.ast.WPackagePos term) throws E;
        public CT CaseCompilationUnitPos(de.peeeq.wurstscript.ast.CompilationUnitPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.PackageOrGlobalPos.VisitorType<E> {
