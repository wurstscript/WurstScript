...
public interface FuncRef extends KatjaSort {
    ...
    //----- nested classes of FuncRef -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseExprFuncRef(de.peeeq.wurstscript.ast.ExprFuncRef term) throws E;
        public CT CaseExprMemberMethod(de.peeeq.wurstscript.ast.ExprMemberMethod term) throws E;
        public CT CaseExprFunctionCall(de.peeeq.wurstscript.ast.ExprFunctionCall term) throws E;
    }
    ...
    static interface VisitorType<E extends Throwable> {
        ...
        public void visit(de.peeeq.wurstscript.ast.FuncRef term) throws E;
    }

    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.FuncRef.VisitorType<E> {
        ...
        private final de.peeeq.wurstscript.ast.FuncRef.Switch<Object, E> variantVisit$FuncRef = new de.peeeq.wurstscript.ast.FuncRef.Switch<Object, E>() { public final Object CaseExprFuncRef(de.peeeq.wurstscript.ast.ExprFuncRef term) throws E { visit(term); return null; } public final Object CaseExprMemberMethod(de.peeeq.wurstscript.ast.ExprMemberMethod term) throws E { visit(term); return null; } public final Object CaseExprFunctionCall(de.peeeq.wurstscript.ast.ExprFunctionCall term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.wurstscript.ast.FuncRef term) throws E {
            term.Switch(variantVisit$FuncRef);
        }
