...
public interface ClassMember extends de.peeeq.wurstscript.ast.ClassSlot, KatjaSort {

    //----- methods of ClassMember -----

    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ClassMember.Switch<CT, E> switchClass) throws E;

    //----- nested classes of ClassMember -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ClassMember.VisitorType<E> {
