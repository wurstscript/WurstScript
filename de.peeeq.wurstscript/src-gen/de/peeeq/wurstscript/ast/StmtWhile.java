...
public interface StmtWhile extends de.peeeq.wurstscript.ast.WStatement, KatjaTuple {

    //----- methods of StmtWhile -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.StmtWhile replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.Expr cond();
    public de.peeeq.wurstscript.ast.StmtWhile replaceCond(de.peeeq.wurstscript.ast.Expr cond);
    public de.peeeq.wurstscript.ast.WStatements body();
    public de.peeeq.wurstscript.ast.StmtWhile replaceBody(de.peeeq.wurstscript.ast.WStatements body);
    public KatjaSort get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtWhile replace(int pos, Object term);
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E;

    //----- nested classes of StmtWhile -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtWhile.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.StmtWhile {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.Expr cond, de.peeeq.wurstscript.ast.WStatements body) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort StmtWhile invoked with null parameter source");
            if(cond == null)
                throw new IllegalArgumentException("constructor of sort StmtWhile invoked with null parameter cond");
            if(body == null)
                throw new IllegalArgumentException("constructor of sort StmtWhile invoked with null parameter body");
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtWhile invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtWhile invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtWhile replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort StmtWhile invoked with negative parameter "+pos);
            if(pos >= 3)
                throw new IllegalArgumentException("replace on sort StmtWhile invoked with too large parameter "+pos+", sort has only 3 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort StmtWhile invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.Expr))
                throw new IllegalArgumentException("replace on sort StmtWhile invoked with term of incorrect sort, Expr expected");
            if(pos == 2 && !(term instanceof de.peeeq.wurstscript.ast.WStatements))
                throw new IllegalArgumentException("replace on sort StmtWhile invoked with term of incorrect sort, WStatements expected");

            return (de.peeeq.wurstscript.ast.StmtWhile) AST.unique(new de.peeeq.wurstscript.ast.StmtWhile.Impl(
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtWhile(this);
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.StmtWhile");
            builder.append("( ");
