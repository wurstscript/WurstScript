...
public interface TypeDefPos extends de.peeeq.wurstscript.ast.WEntityPos, de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of TypeDefPos -----

    public de.peeeq.wurstscript.ast.TypeDef termWEntity();
    public KatjaSort term();
    public de.peeeq.wurstscript.ast.TypeDef termTypeDef();
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.TypeDefPos.VisitorType<E> {
