...
public interface NativeFuncPos extends de.peeeq.wurstscript.ast.FunctionDefinitionPos, de.peeeq.wurstscript.ast.WEntityPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.NativeFunc> {

    //----- methods of NativeFuncPos -----
    ...
    public de.peeeq.wurstscript.ast.NativeFuncPos replaceSignature(de.peeeq.wurstscript.ast.FuncSignature signature);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.NativeFuncPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.NativeFunc> implements de.peeeq.wurstscript.ast.NativeFuncPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.NativeFunc term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.TuplePos<?> get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort NativeFuncPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort NativeFuncPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.NativeFuncPos replace(de.peeeq.wurstscript.ast.NativeFunc term) {
            return (de.peeeq.wurstscript.ast.NativeFuncPos) super.replace(term);
        }
