...
public interface StmtDestroy extends de.peeeq.wurstscript.ast.WStatement, KatjaTuple {
    ...
    //----- methods of StmtDestroy -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.StmtDestroy replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.Expr obj();
    public de.peeeq.wurstscript.ast.StmtDestroy replaceObj(de.peeeq.wurstscript.ast.Expr obj);
    public KatjaSort get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtDestroy replace(int pos, Object term);
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E;

    //----- nested classes of StmtDestroy -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtDestroy.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.StmtDestroy {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.Expr obj) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort StmtDestroy invoked with null parameter source");
            if(obj == null)
                throw new IllegalArgumentException("constructor of sort StmtDestroy invoked with null parameter obj");
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtDestroy invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtDestroy invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtDestroy replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort StmtDestroy invoked with negative parameter "+pos);
            if(pos >= 2)
                throw new IllegalArgumentException("replace on sort StmtDestroy invoked with too large parameter "+pos+", sort has only 2 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort StmtDestroy invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.Expr))
                throw new IllegalArgumentException("replace on sort StmtDestroy invoked with term of incorrect sort, Expr expected");

            return (de.peeeq.wurstscript.ast.StmtDestroy) AST.unique(new de.peeeq.wurstscript.ast.StmtDestroy.Impl(
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtDestroy(this);
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.StmtDestroy");
            builder.append("( ");
