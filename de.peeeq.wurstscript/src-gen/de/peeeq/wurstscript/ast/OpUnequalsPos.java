...
public interface OpUnequalsPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpUnequals> {
    ...
    public int size();
    public de.peeeq.wurstscript.ast.OpUnequalsPos replace(de.peeeq.wurstscript.ast.OpUnequals term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpUnequalsPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpUnequals> implements de.peeeq.wurstscript.ast.OpUnequalsPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpUnequals term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpUnequalsPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpUnequalsPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpUnequalsPos replace(de.peeeq.wurstscript.ast.OpUnequals term) {
            return (de.peeeq.wurstscript.ast.OpUnequalsPos) super.replace(term);
        }
