...
public interface OpModIntPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpModInt> {
    ...
    //----- methods of OpModIntPos -----

    public de.peeeq.wurstscript.ast.OpModInt termOpBinary();
    public de.peeeq.wurstscript.ast.OpModInt termOp();
    public de.peeeq.wurstscript.ast.OpModInt term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpModIntPos replace(de.peeeq.wurstscript.ast.OpModInt term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpModIntPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpModInt> implements de.peeeq.wurstscript.ast.OpModIntPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpModInt term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpModIntPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpModIntPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpModIntPos replace(de.peeeq.wurstscript.ast.OpModInt term) {
            return (de.peeeq.wurstscript.ast.OpModIntPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpModIntPos(this);
        }
