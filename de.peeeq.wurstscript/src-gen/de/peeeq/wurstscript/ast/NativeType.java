...
public interface NativeType extends de.peeeq.wurstscript.ast.JassToplevelDeclaration, de.peeeq.wurstscript.ast.TypeDef, KatjaTuple {
    ...
    public de.peeeq.wurstscript.ast.NativeType replaceVisibility(de.peeeq.wurstscript.ast.VisibilityModifier visibility);
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.NativeType {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.VisibilityModifier visibility, java.lang.String name, de.peeeq.wurstscript.ast.OptTypeExpr typ) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort NativeType invoked with null parameter source");
            if(visibility == null)
                throw new IllegalArgumentException("constructor of sort NativeType invoked with null parameter visibility");
            if(name == null)
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        ...
                        throw new IllegalArgumentException("get on sort NativeType invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.NativeType replace(int pos, Object term) {
            ...
            if(pos >= 4)
                throw new IllegalArgumentException("replace on sort NativeType invoked with too large parameter "+pos+", sort has only 4 components");
            ...
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.VisibilityModifier))
                throw new IllegalArgumentException("replace on sort NativeType invoked with term of incorrect sort, VisibilityModifier expected");
