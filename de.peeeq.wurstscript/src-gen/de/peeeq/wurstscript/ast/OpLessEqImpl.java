...
class OpLessEqImpl implements OpLessEq, AstElementIntern {
	OpLessEqImpl() {
	}
	...
	@Override public void accept(OpLessEq.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpLessEq(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpLessEq(this);
	}
