...
public interface ExprCastPos extends de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.ExprCast> {

    //----- methods of ExprCastPos -----

    public de.peeeq.wurstscript.ast.ExprCast termExpr();
    public de.peeeq.wurstscript.ast.ExprCast termOptExpr();
    public de.peeeq.wurstscript.ast.ExprCast term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.ExprCastPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.TypeExprPos typ();
    public de.peeeq.wurstscript.ast.ExprCastPos replaceTyp(de.peeeq.wurstscript.ast.TypeExpr typ);
    public de.peeeq.wurstscript.ast.ExprPos expr();
    public de.peeeq.wurstscript.ast.ExprCastPos replaceExpr(de.peeeq.wurstscript.ast.Expr expr);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ExprCastPos replace(de.peeeq.wurstscript.ast.ExprCast term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprCastPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.ExprCast> implements de.peeeq.wurstscript.ast.ExprCastPos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.TypeExprPos _typ = null;
        private de.peeeq.wurstscript.ast.ExprPos _expr = null;
        ...
        public de.peeeq.wurstscript.ast.ExprPos expr() {
            if(_expr == null)
                _expr = de.peeeq.wurstscript.ast.AST.ExprPos(this, _term.expr(), 2);

            return _expr;
        }

        public de.peeeq.wurstscript.ast.ExprCastPos replaceExpr(de.peeeq.wurstscript.ast.Expr expr) {
            return replace(_term.replaceExpr(expr));
        }

        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.ExprCast term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_expr == null)
                        _expr = AST.ExprPos(this, _term.expr(), 2);
                    
                    return _expr;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprCastPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprCastPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprCastPos replace(de.peeeq.wurstscript.ast.ExprCast term) {
            return (de.peeeq.wurstscript.ast.ExprCastPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ExprPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseExprCastPos(this);
        }
