...
class OpDivIntImpl implements OpDivInt, AstElementIntern {
	OpDivIntImpl() {
	}
	...
	@Override public void accept(OpDivInt.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpDivInt(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpDivInt(this);
	}
