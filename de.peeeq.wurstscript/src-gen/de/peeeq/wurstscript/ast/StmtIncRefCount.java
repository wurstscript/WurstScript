...
public interface StmtIncRefCount extends de.peeeq.wurstscript.ast.WStatement, KatjaTuple {

    //----- methods of StmtIncRefCount -----

    public de.peeeq.wurstscript.ast.WPos source();
    public de.peeeq.wurstscript.ast.StmtIncRefCount replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.Expr obj();
    public de.peeeq.wurstscript.ast.StmtIncRefCount replaceObj(de.peeeq.wurstscript.ast.Expr obj);
    public KatjaSort get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtIncRefCount replace(int pos, Object term);
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E;

    //----- nested classes of StmtIncRefCount -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtIncRefCount.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.StmtIncRefCount {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.Expr obj) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort StmtIncRefCount invoked with null parameter source");
            if(obj == null)
                throw new IllegalArgumentException("constructor of sort StmtIncRefCount invoked with null parameter obj");
        ...
        public KatjaSort get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtIncRefCount invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtIncRefCount invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtIncRefCount replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort StmtIncRefCount invoked with negative parameter "+pos);
            if(pos >= 2)
                throw new IllegalArgumentException("replace on sort StmtIncRefCount invoked with too large parameter "+pos+", sort has only 2 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort StmtIncRefCount invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.Expr))
                throw new IllegalArgumentException("replace on sort StmtIncRefCount invoked with term of incorrect sort, Expr expected");

            return (de.peeeq.wurstscript.ast.StmtIncRefCount) AST.unique(new de.peeeq.wurstscript.ast.StmtIncRefCount.Impl(
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatement.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtIncRefCount(this);
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.StmtIncRefCount");
            builder.append("( ");
        ...
        public Appendable toString(Appendable builder) throws IOException {
            builder.append("StmtIncRefCount");
            builder.append("( ");
