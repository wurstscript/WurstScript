...
class ExprStringValImpl implements ExprStringVal, AstElementIntern {
	ExprStringValImpl(WPos source, String val) {
	...
	@Override public ExprStringVal copy() {
		return new ExprStringValImpl((WPos) source.copy(), val);
	}
	...
	@Override public <T> T match(OptExpr.Matcher<T> matcher) {
		return matcher.case_ExprStringVal(this);
	}
	@Override public void match(OptExpr.MatcherVoid matcher) {
		matcher.case_ExprStringVal(this);
	}
	...
	@Override public String toString() {
		return "ExprStringVal(" + source + ", " +val+")";
	}
