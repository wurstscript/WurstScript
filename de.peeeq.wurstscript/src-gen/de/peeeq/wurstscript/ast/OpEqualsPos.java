...
public interface OpEqualsPos extends de.peeeq.wurstscript.ast.OpBinaryPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.OpEquals> {

    //----- methods of OpEqualsPos -----

    public de.peeeq.wurstscript.ast.OpEquals termOpBinary();
    public de.peeeq.wurstscript.ast.OpEquals termOp();
    public de.peeeq.wurstscript.ast.OpEquals term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.OpEqualsPos replace(de.peeeq.wurstscript.ast.OpEquals term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OpEqualsPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.OpEquals> implements de.peeeq.wurstscript.ast.OpEqualsPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.OpEquals term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OpEqualsPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OpEqualsPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OpEqualsPos replace(de.peeeq.wurstscript.ast.OpEquals term) {
            return (de.peeeq.wurstscript.ast.OpEqualsPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OpBinaryPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseOpEqualsPos(this);
        }
