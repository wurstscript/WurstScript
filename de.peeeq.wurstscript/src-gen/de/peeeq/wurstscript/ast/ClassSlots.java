...
public abstract class ClassSlots extends ParseqList<ClassSlot> implements AstElement{
	public ClassSlots copy() {
		ClassSlots result = new ClassSlotsImpl();
		for (ClassSlot elem : this) {
			result.add((ClassSlot) elem.copy());
		}
		return result;
	}
