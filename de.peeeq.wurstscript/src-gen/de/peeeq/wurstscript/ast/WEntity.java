...
public interface WEntity extends KatjaSort {
    ...
    //----- nested classes of WEntity -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.TypeDef.Switch<CT, E> {
        ...
        public CT CaseNativeFunc(de.peeeq.wurstscript.ast.NativeFunc term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.WEntity.VisitorType<E> {
