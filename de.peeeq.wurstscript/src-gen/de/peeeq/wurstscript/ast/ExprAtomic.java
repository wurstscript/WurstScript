...
public interface ExprAtomic extends de.peeeq.wurstscript.ast.Expr, KatjaSort {
    ...
    //----- methods of ExprAtomic -----

    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ExprAtomic.Switch<CT, E> switchClass) throws E;

    //----- nested classes of ExprAtomic -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseExprIntVal(de.peeeq.wurstscript.ast.ExprIntVal term) throws E;
        public CT CaseExprRealVal(de.peeeq.wurstscript.ast.ExprRealVal term) throws E;
        public CT CaseExprStringVal(de.peeeq.wurstscript.ast.ExprStringVal term) throws E;
        public CT CaseExprBoolVal(de.peeeq.wurstscript.ast.ExprBoolVal term) throws E;
        ...
        public CT CaseExprThis(de.peeeq.wurstscript.ast.ExprThis term) throws E;
        public CT CaseExprNull(de.peeeq.wurstscript.ast.ExprNull term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprAtomic.VisitorType<E> {
