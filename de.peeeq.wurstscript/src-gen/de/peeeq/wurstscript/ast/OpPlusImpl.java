...
class OpPlusImpl implements OpPlus, AstElementIntern {
	OpPlusImpl() {
	}
	...
	@Override public void accept(OpPlus.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpPlus(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpPlus(this);
	}
