...
class VisibilityPublicreadImpl implements VisibilityPublicread, AstElementIntern {
	...
	@Override public VisibilityPublicread copy() {
		return new VisibilityPublicreadImpl((WPos) source.copy());
	}
	...
	@Override public String toString() {
		return "VisibilityPublicread(" + source+")";
	}
