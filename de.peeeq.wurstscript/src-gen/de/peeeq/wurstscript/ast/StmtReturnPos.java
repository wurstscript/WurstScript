...
public interface StmtReturnPos extends de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.StmtReturn> {

    //----- methods of StmtReturnPos -----

    public de.peeeq.wurstscript.ast.StmtReturn termWStatement();
    public de.peeeq.wurstscript.ast.StmtReturn term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.StmtReturnPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.OptExprPos obj();
    public de.peeeq.wurstscript.ast.StmtReturnPos replaceObj(de.peeeq.wurstscript.ast.OptExpr obj);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtReturnPos replace(de.peeeq.wurstscript.ast.StmtReturn term);
    ...
    //----- nested classes of StmtReturnPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtReturnPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.StmtReturn> implements de.peeeq.wurstscript.ast.StmtReturnPos {

        //----- attributes of Impl -----

        private de.peeeq.wurstscript.ast.WPosPos _source = null;
        private de.peeeq.wurstscript.ast.OptExprPos _obj = null;
        ...
        public de.peeeq.wurstscript.ast.OptExprPos obj() {
            if(_obj == null)
                _obj = de.peeeq.wurstscript.ast.AST.OptExprPos(this, _term.obj(), 1);
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.StmtReturn term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_obj == null)
                        _obj = AST.OptExprPos(this, _term.obj(), 1);
                    
                    return _obj;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtReturnPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtReturnPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtReturnPos replace(de.peeeq.wurstscript.ast.StmtReturn term) {
            return (de.peeeq.wurstscript.ast.StmtReturnPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtReturnPos(this);
        }
