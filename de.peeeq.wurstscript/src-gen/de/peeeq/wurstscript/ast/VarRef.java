...
public interface VarRef extends KatjaSort {
    ...
    //----- nested classes of VarRef -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseExprVarArrayAccess(de.peeeq.wurstscript.ast.ExprVarArrayAccess term) throws E;
        public CT CaseExprVarAccess(de.peeeq.wurstscript.ast.ExprVarAccess term) throws E;
        public CT CaseExprMemberVar(de.peeeq.wurstscript.ast.ExprMemberVar term) throws E;
        public CT CaseExprMemberArrayVar(de.peeeq.wurstscript.ast.ExprMemberArrayVar term) throws E;
    }
    ...
    static interface VisitorType<E extends Throwable> {
        ...
        public void visit(de.peeeq.wurstscript.ast.VarRef term) throws E;
    }

    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.VarRef.VisitorType<E> {
        ...
        private final de.peeeq.wurstscript.ast.VarRef.Switch<Object, E> variantVisit$VarRef = new de.peeeq.wurstscript.ast.VarRef.Switch<Object, E>() { public final Object CaseExprVarArrayAccess(de.peeeq.wurstscript.ast.ExprVarArrayAccess term) throws E { visit(term); return null; } public final Object CaseExprVarAccess(de.peeeq.wurstscript.ast.ExprVarAccess term) throws E { visit(term); return null; } public final Object CaseExprMemberVar(de.peeeq.wurstscript.ast.ExprMemberVar term) throws E { visit(term); return null; } public final Object CaseExprMemberArrayVar(de.peeeq.wurstscript.ast.ExprMemberArrayVar term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.wurstscript.ast.VarRef term) throws E {
            term.Switch(variantVisit$VarRef);
        }
    }
}
