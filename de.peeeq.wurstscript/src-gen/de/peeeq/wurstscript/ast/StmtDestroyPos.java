...
public interface StmtDestroyPos extends de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.StmtDestroy> {

    //----- methods of StmtDestroyPos -----

    public de.peeeq.wurstscript.ast.StmtDestroy termWStatement();
    public de.peeeq.wurstscript.ast.StmtDestroy term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.StmtDestroyPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.ExprPos obj();
    public de.peeeq.wurstscript.ast.StmtDestroyPos replaceObj(de.peeeq.wurstscript.ast.Expr obj);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtDestroyPos replace(de.peeeq.wurstscript.ast.StmtDestroy term);
    ...
    //----- nested classes of StmtDestroyPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtDestroyPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.StmtDestroy> implements de.peeeq.wurstscript.ast.StmtDestroyPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.StmtDestroy term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtDestroyPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtDestroyPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtDestroyPos replace(de.peeeq.wurstscript.ast.StmtDestroy term) {
            return (de.peeeq.wurstscript.ast.StmtDestroyPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtDestroyPos(this);
        }
