...
public interface StmtDecRefCountPos extends de.peeeq.wurstscript.ast.WStatementPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.StmtDecRefCount> {
    ...
    //----- methods of StmtDecRefCountPos -----

    public de.peeeq.wurstscript.ast.StmtDecRefCount termWStatement();
    public de.peeeq.wurstscript.ast.StmtDecRefCount term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.StmtDecRefCountPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.ExprPos obj();
    public de.peeeq.wurstscript.ast.StmtDecRefCountPos replaceObj(de.peeeq.wurstscript.ast.Expr obj);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.StmtDecRefCountPos replace(de.peeeq.wurstscript.ast.StmtDecRefCount term);
    ...
    //----- nested classes of StmtDecRefCountPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.StmtDecRefCountPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.StmtDecRefCount> implements de.peeeq.wurstscript.ast.StmtDecRefCountPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.StmtDecRefCount term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort StmtDecRefCountPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort StmtDecRefCountPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.StmtDecRefCountPos replace(de.peeeq.wurstscript.ast.StmtDecRefCount term) {
            return (de.peeeq.wurstscript.ast.StmtDecRefCountPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseStmtDecRefCountPos(this);
        }
