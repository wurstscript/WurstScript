...
public interface TypeRef extends KatjaSort {
    ...
    //----- nested classes of TypeRef -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseTypeExpr(de.peeeq.wurstscript.ast.TypeExpr term) throws E;
    ...
    static interface VisitorType<E extends Throwable> {
        ...
        public void visit(de.peeeq.wurstscript.ast.TypeRef term) throws E;
        public void visit(de.peeeq.wurstscript.ast.TypeExpr term) throws E;
    }

    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.TypeRef.VisitorType<E> {
        ...
        private final de.peeeq.wurstscript.ast.TypeRef.Switch<Object, E> variantVisit$TypeRef = new de.peeeq.wurstscript.ast.TypeRef.Switch<Object, E>() { public final Object CaseTypeExpr(de.peeeq.wurstscript.ast.TypeExpr term) throws E { visit(term); return null; } public final Object CaseExprNewObject(de.peeeq.wurstscript.ast.ExprNewObject term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.wurstscript.ast.TypeRef term) throws E {
            term.Switch(variantVisit$TypeRef);
        }
    }
}
