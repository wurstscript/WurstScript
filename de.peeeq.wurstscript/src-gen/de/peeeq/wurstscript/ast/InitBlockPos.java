...
public interface InitBlockPos extends de.peeeq.wurstscript.ast.WEntityPos, de.peeeq.wurstscript.ast.WScopePos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.InitBlock> {

    //----- methods of InitBlockPos -----

    public de.peeeq.wurstscript.ast.InitBlock termWEntity();
    public de.peeeq.wurstscript.ast.InitBlock termWScope();
    public de.peeeq.wurstscript.ast.InitBlock term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.InitBlockPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.WStatementsPos body();
    public de.peeeq.wurstscript.ast.InitBlockPos replaceBody(de.peeeq.wurstscript.ast.WStatements body);
    public de.peeeq.wurstscript.ast.AST.NodePos<?> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.InitBlockPos replace(de.peeeq.wurstscript.ast.InitBlock term);
    ...
    //----- nested classes of InitBlockPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.InitBlockPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.InitBlock> implements de.peeeq.wurstscript.ast.InitBlockPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.InitBlock term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.NodePos<?> get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort InitBlockPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort InitBlockPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.InitBlockPos replace(de.peeeq.wurstscript.ast.InitBlock term) {
            return (de.peeeq.wurstscript.ast.InitBlockPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.WEntityPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseInitBlockPos(this);
        }
