...
public interface TopLevelDeclarationPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of TopLevelDeclarationPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.TopLevelDeclaration termTopLevelDeclaration();
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.TopLevelDeclarationPos.Switch<CT, E> switchClass) throws E;

    //----- nested classes of TopLevelDeclarationPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.JassToplevelDeclarationPos.Switch<CT, E> {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.TopLevelDeclarationPos.VisitorType<E> {
