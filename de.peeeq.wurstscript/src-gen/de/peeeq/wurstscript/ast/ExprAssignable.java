...
public interface ExprAssignable extends de.peeeq.wurstscript.ast.Expr, KatjaSort {

    //----- methods of ExprAssignable -----
    ...
    //----- nested classes of ExprAssignable -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprAssignable.VisitorType<E> {
