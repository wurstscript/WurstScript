...
class StmtWhileImpl implements StmtWhile, AstElementIntern {
	...
	@Override public StmtWhile copy() {
		return new StmtWhileImpl((WPos) source.copy(), (Expr) cond.copy(), (WStatements) body.copy());
	}
