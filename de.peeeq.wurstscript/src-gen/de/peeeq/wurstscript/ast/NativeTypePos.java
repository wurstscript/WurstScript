...
public interface NativeTypePos extends de.peeeq.wurstscript.ast.JassToplevelDeclarationPos, de.peeeq.wurstscript.ast.TypeDefPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.NativeType> {
    ...
    public de.peeeq.wurstscript.ast.NativeTypePos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.VisibilityModifierPos visibility();
    public de.peeeq.wurstscript.ast.NativeTypePos replaceVisibility(de.peeeq.wurstscript.ast.VisibilityModifier visibility);
    public de.peeeq.wurstscript.ast.StringPos name();
    public de.peeeq.wurstscript.ast.NativeTypePos replaceName(java.lang.String name);
    public de.peeeq.wurstscript.ast.OptTypeExprPos typ();
    public de.peeeq.wurstscript.ast.NativeTypePos replaceTyp(de.peeeq.wurstscript.ast.OptTypeExpr typ);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.NativeTypePos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.NativeType> implements de.peeeq.wurstscript.ast.NativeTypePos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.NativeType term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort NativeTypePos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort NativeTypePos invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.NativeTypePos replace(de.peeeq.wurstscript.ast.NativeType term) {
            return (de.peeeq.wurstscript.ast.NativeTypePos) super.replace(term);
        }
