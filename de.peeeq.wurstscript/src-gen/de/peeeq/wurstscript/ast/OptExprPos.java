...
public interface OptExprPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of OptExprPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.OptExpr termOptExpr();
    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.OptExprPos.Switch<CT, E> switchClass) throws E;

    //----- nested classes of OptExprPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.ExprPos.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseNoExprPos(de.peeeq.wurstscript.ast.NoExprPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OptExprPos.VisitorType<E> {
