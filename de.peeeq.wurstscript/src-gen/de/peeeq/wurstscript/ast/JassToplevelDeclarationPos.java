...
public interface JassToplevelDeclarationPos extends de.peeeq.wurstscript.ast.TopLevelDeclarationPos, de.peeeq.wurstscript.ast.AST.SortPos {
    ...
    //----- methods of JassToplevelDeclarationPos -----

    public de.peeeq.wurstscript.ast.JassToplevelDeclaration termTopLevelDeclaration();
    public KatjaSort term();
    public de.peeeq.wurstscript.ast.JassToplevelDeclaration termJassToplevelDeclaration();
    ...
    //----- nested classes of JassToplevelDeclarationPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.wurstscript.ast.FunctionDefinitionPos.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseJassGlobalBlockPos(de.peeeq.wurstscript.ast.JassGlobalBlockPos term) throws E;
        public CT CaseNativeTypePos(de.peeeq.wurstscript.ast.NativeTypePos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.JassToplevelDeclarationPos.VisitorType<E> {
