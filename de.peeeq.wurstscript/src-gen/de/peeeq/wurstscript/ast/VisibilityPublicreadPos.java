...
public interface VisibilityPublicreadPos extends de.peeeq.wurstscript.ast.VisibilityModifierPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.VisibilityPublicread> {

    //----- methods of VisibilityPublicreadPos -----

    public de.peeeq.wurstscript.ast.VisibilityPublicread termVisibilityModifier();
    public de.peeeq.wurstscript.ast.VisibilityPublicread term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.VisibilityPublicreadPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.WPosPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.VisibilityPublicreadPos replace(de.peeeq.wurstscript.ast.VisibilityPublicread term);
    ...
    //----- nested classes of VisibilityPublicreadPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.VisibilityPublicreadPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.VisibilityPublicread> implements de.peeeq.wurstscript.ast.VisibilityPublicreadPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.VisibilityPublicread term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.WPosPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort VisibilityPublicreadPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort VisibilityPublicreadPos invoked with too large parameter "+i+", sort has only 1 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.VisibilityPublicreadPos replace(de.peeeq.wurstscript.ast.VisibilityPublicread term) {
            return (de.peeeq.wurstscript.ast.VisibilityPublicreadPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.VisibilityModifierPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseVisibilityPublicreadPos(this);
        }
        ...
        public final String sortName() {
            return "VisibilityPublicreadPos";
        }
    }
}
