...
public interface PackageOrGlobal extends de.peeeq.wurstscript.ast.WScope, KatjaSort {

    //----- methods of PackageOrGlobal -----

    public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.PackageOrGlobal.Switch<CT, E> switchClass) throws E;

    //----- nested classes of PackageOrGlobal -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseWPackage(de.peeeq.wurstscript.ast.WPackage term) throws E;
        public CT CaseCompilationUnit(de.peeeq.wurstscript.ast.CompilationUnit term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.PackageOrGlobal.VisitorType<E> {
