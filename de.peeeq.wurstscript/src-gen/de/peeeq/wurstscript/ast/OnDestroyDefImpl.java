...
class OnDestroyDefImpl implements OnDestroyDef, AstElementIntern {
	...
	@Override public OnDestroyDef copy() {
		return new OnDestroyDefImpl((WPos) source.copy(), (WStatements) body.copy());
	}
