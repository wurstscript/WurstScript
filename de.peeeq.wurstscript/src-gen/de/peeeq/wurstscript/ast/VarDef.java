...
public interface VarDef extends KatjaSort {
    ...
    //----- nested classes of VarDef -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseGlobalVarDef(de.peeeq.wurstscript.ast.GlobalVarDef term) throws E;
        public CT CaseLocalVarDef(de.peeeq.wurstscript.ast.LocalVarDef term) throws E;
        public CT CaseWParameter(de.peeeq.wurstscript.ast.WParameter term) throws E;
    }
    ...
    static interface VisitorType<E extends Throwable> {
        ...
        public void visit(de.peeeq.wurstscript.ast.VarDef term) throws E;
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.VarDef.VisitorType<E> {
        ...
        private final de.peeeq.wurstscript.ast.VarDef.Switch<Object, E> variantVisit$VarDef = new de.peeeq.wurstscript.ast.VarDef.Switch<Object, E>() { public final Object CaseGlobalVarDef(de.peeeq.wurstscript.ast.GlobalVarDef term) throws E { visit(term); return null; } public final Object CaseLocalVarDef(de.peeeq.wurstscript.ast.LocalVarDef term) throws E { visit(term); return null; } public final Object CaseWParameter(de.peeeq.wurstscript.ast.WParameter term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.wurstscript.ast.VarDef term) throws E {
            term.Switch(variantVisit$VarDef);
        }
    }
}
