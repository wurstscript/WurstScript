...
public interface ExprMemberVarPos extends de.peeeq.wurstscript.ast.ExprPos, de.peeeq.wurstscript.ast.ExprAssignablePos, de.peeeq.wurstscript.ast.VarRefPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.ExprMemberVar> {

    //----- methods of ExprMemberVarPos -----

    public de.peeeq.wurstscript.ast.ExprMemberVar termExpr();
    public de.peeeq.wurstscript.ast.ExprMemberVar termExprAssignable();
    public de.peeeq.wurstscript.ast.ExprMemberVar termVarRef();
    public de.peeeq.wurstscript.ast.ExprMemberVar termOptExpr();
    public de.peeeq.wurstscript.ast.ExprMemberVar term();
    public de.peeeq.wurstscript.ast.WPosPos source();
    public de.peeeq.wurstscript.ast.ExprMemberVarPos replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.ExprPos left();
    public de.peeeq.wurstscript.ast.ExprMemberVarPos replaceLeft(de.peeeq.wurstscript.ast.Expr left);
    public de.peeeq.wurstscript.ast.StringPos varName();
    public de.peeeq.wurstscript.ast.ExprMemberVarPos replaceVarName(java.lang.String varName);
    public de.peeeq.wurstscript.ast.AST.SortPos get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.ExprMemberVarPos replace(de.peeeq.wurstscript.ast.ExprMemberVar term);
    ...
    //----- nested classes of ExprMemberVarPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprMemberVarPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.ExprMemberVar> implements de.peeeq.wurstscript.ast.ExprMemberVarPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.ExprMemberVar term, int pos) {
        ...
        public de.peeeq.wurstscript.ast.AST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprMemberVarPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprMemberVarPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprMemberVarPos replace(de.peeeq.wurstscript.ast.ExprMemberVar term) {
            return (de.peeeq.wurstscript.ast.ExprMemberVarPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.ExprPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseExprMemberVarPos(this);
        }
