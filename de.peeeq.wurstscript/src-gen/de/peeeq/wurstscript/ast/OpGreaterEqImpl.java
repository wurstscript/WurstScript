...
class OpGreaterEqImpl implements OpGreaterEq, AstElementIntern {
	OpGreaterEqImpl() {
	}
	...
	@Override public OpGreaterEq copy() {
	...
	@Override public void accept(OpGreaterEq.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(OpBinary.Matcher<T> matcher) {
		return matcher.case_OpGreaterEq(this);
	}
	@Override public void match(OpBinary.MatcherVoid matcher) {
		matcher.case_OpGreaterEq(this);
	}
