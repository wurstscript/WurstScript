...
public interface FunctionDefinitionPos extends de.peeeq.wurstscript.ast.JassToplevelDeclarationPos, de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of FunctionDefinitionPos -----

    public de.peeeq.wurstscript.ast.FunctionDefinition termJassToplevelDeclaration();
    public de.peeeq.wurstscript.ast.FunctionDefinition termTopLevelDeclaration();
    public KatjaSort term();
    public de.peeeq.wurstscript.ast.FunctionDefinition termFunctionDefinition();
    ...
    //----- nested classes of FunctionDefinitionPos -----
    ...
    public static interface Switch<CT, E extends Throwable> {
        ...
        public CT CaseNativeFuncPos(de.peeeq.wurstscript.ast.NativeFuncPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.FunctionDefinitionPos.VisitorType<E> {
