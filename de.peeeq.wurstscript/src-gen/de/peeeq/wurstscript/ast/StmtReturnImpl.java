...
class StmtReturnImpl implements StmtReturn, AstElementIntern {
	...
	@Override public StmtReturn copy() {
		return new StmtReturnImpl((WPos) source.copy(), (OptExpr) obj.copy());
	}
