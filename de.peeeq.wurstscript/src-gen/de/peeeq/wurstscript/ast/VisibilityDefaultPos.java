...
public interface VisibilityDefaultPos extends de.peeeq.wurstscript.ast.VisibilityModifierPos, de.peeeq.wurstscript.ast.AST.TuplePos<de.peeeq.wurstscript.ast.VisibilityDefault> {

    //----- methods of VisibilityDefaultPos -----

    public de.peeeq.wurstscript.ast.VisibilityDefault termVisibilityModifier();
    public de.peeeq.wurstscript.ast.VisibilityDefault term();
    public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.wurstscript.ast.VisibilityDefaultPos replace(de.peeeq.wurstscript.ast.VisibilityDefault term);
    ...
    //----- nested classes of VisibilityDefaultPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.VisibilityDefaultPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.wurstscript.ast.CompilationUnitPos, de.peeeq.wurstscript.ast.VisibilityDefault> implements de.peeeq.wurstscript.ast.VisibilityDefaultPos {
        ...
        Impl(KatjaNodePos<de.peeeq.wurstscript.ast.CompilationUnitPos, ?> parent, de.peeeq.wurstscript.ast.VisibilityDefault term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.wurstscript.ast.CompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort VisibilityDefaultPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort VisibilityDefaultPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.VisibilityDefaultPos replace(de.peeeq.wurstscript.ast.VisibilityDefault term) {
            return (de.peeeq.wurstscript.ast.VisibilityDefaultPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.wurstscript.ast.VisibilityModifierPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseVisibilityDefaultPos(this);
        }
