...
public interface CompilationUnit extends KatjaList<de.peeeq.wurstscript.ast.WPackage> {

    //----- methods of CompilationUnit -----

    public de.peeeq.wurstscript.ast.CompilationUnit add(de.peeeq.wurstscript.ast.WPackage element);
    public de.peeeq.wurstscript.ast.CompilationUnit addAll(KatjaList<? extends de.peeeq.wurstscript.ast.WPackage> list);
    public de.peeeq.wurstscript.ast.CompilationUnit remove(de.peeeq.wurstscript.ast.WPackage element);
    public de.peeeq.wurstscript.ast.CompilationUnit removeAll(KatjaList<? extends de.peeeq.wurstscript.ast.WPackage> list);
    public de.peeeq.wurstscript.ast.CompilationUnit appBack(de.peeeq.wurstscript.ast.WPackage element);
    public de.peeeq.wurstscript.ast.CompilationUnit appFront(de.peeeq.wurstscript.ast.WPackage element);
    public de.peeeq.wurstscript.ast.CompilationUnit conc(KatjaList<? extends de.peeeq.wurstscript.ast.WPackage> list);
    ...
    public de.peeeq.wurstscript.ast.CompilationUnit setAdd(de.peeeq.wurstscript.ast.WPackage element);
    public de.peeeq.wurstscript.ast.CompilationUnit setRemove(de.peeeq.wurstscript.ast.WPackage element);
    public de.peeeq.wurstscript.ast.CompilationUnit setUnion(KatjaList<? extends de.peeeq.wurstscript.ast.WPackage> list);
    public de.peeeq.wurstscript.ast.CompilationUnit setIntersection(KatjaList<? extends de.peeeq.wurstscript.ast.WPackage> list);
    public de.peeeq.wurstscript.ast.CompilationUnit setWithout(KatjaList<? extends de.peeeq.wurstscript.ast.WPackage> list);
    ...
    static class Impl extends KatjaListImpl<de.peeeq.wurstscript.ast.WPackage> implements de.peeeq.wurstscript.ast.CompilationUnit {

        //----- methods of Impl -----

        Impl(de.peeeq.wurstscript.ast.WPackage... elements) {
            super(elements);

            for(de.peeeq.wurstscript.ast.WPackage element : elements)
                if(element == null)
        ...
        protected de.peeeq.wurstscript.ast.CompilationUnit createInstance(de.peeeq.wurstscript.ast.WPackage[] elements, boolean isSet) {
            for(de.peeeq.wurstscript.ast.WPackage element : elements)
                if(element == null)
                    throw new IllegalArgumentException("constructor of sort CompilationUnit invoked with null element");
        ...
        protected de.peeeq.wurstscript.ast.WPackage[] createArray(int size) {
            return new de.peeeq.wurstscript.ast.WPackage[size];
        }
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            ...
            builder.append("( ");
            for(de.peeeq.wurstscript.ast.WPackage element : values) {
