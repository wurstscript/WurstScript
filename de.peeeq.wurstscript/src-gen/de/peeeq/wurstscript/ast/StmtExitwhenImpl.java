...
class StmtExitwhenImpl implements StmtExitwhen, AstElementIntern {
	StmtExitwhenImpl(WPos source, Expr cond) {
	...
	@Override public StmtExitwhen copy() {
		return new StmtExitwhenImpl((WPos) source.copy(), (Expr) cond.copy());
	}
	...
	@Override public String toString() {
		return "StmtExitwhen(" + source + ", " +cond+")";
	}
