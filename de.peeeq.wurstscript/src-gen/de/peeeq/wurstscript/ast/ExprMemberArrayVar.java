...
public interface ExprMemberArrayVar extends de.peeeq.wurstscript.ast.Expr, de.peeeq.wurstscript.ast.ExprAssignable, de.peeeq.wurstscript.ast.VarRef, KatjaTuple {
    ...
    public de.peeeq.wurstscript.ast.ExprMemberArrayVar replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.Expr left();
    public de.peeeq.wurstscript.ast.ExprMemberArrayVar replaceLeft(de.peeeq.wurstscript.ast.Expr left);
    public java.lang.String varName();
    public de.peeeq.wurstscript.ast.ExprMemberArrayVar replaceVarName(java.lang.String varName);
    public de.peeeq.wurstscript.ast.Indexes indexes();
    public de.peeeq.wurstscript.ast.ExprMemberArrayVar replaceIndexes(de.peeeq.wurstscript.ast.Indexes indexes);
    ...
    //----- nested classes of ExprMemberArrayVar -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.ExprMemberArrayVar.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.ExprMemberArrayVar {
        ...
        public de.peeeq.wurstscript.ast.ExprMemberArrayVar replaceIndexes(de.peeeq.wurstscript.ast.Indexes indexes) {
            return replace(3, indexes);
        }

        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.Expr left, java.lang.String varName, de.peeeq.wurstscript.ast.Indexes indexes) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort ExprMemberArrayVar invoked with null parameter source");
            if(left == null)
                throw new IllegalArgumentException("constructor of sort ExprMemberArrayVar invoked with null parameter left");
            if(varName == null)
                throw new IllegalArgumentException("constructor of sort ExprMemberArrayVar invoked with null parameter varName");
            if(indexes == null)
                throw new IllegalArgumentException("constructor of sort ExprMemberArrayVar invoked with null parameter indexes");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                case 3: return _indexes;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ExprMemberArrayVar invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ExprMemberArrayVar invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.ExprMemberArrayVar replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort ExprMemberArrayVar invoked with negative parameter "+pos);
            if(pos >= 4)
                throw new IllegalArgumentException("replace on sort ExprMemberArrayVar invoked with too large parameter "+pos+", sort has only 4 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort ExprMemberArrayVar invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.Expr))
                throw new IllegalArgumentException("replace on sort ExprMemberArrayVar invoked with term of incorrect sort, Expr expected");
            if(pos == 2 && !(term instanceof java.lang.String))
                throw new IllegalArgumentException("replace on sort ExprMemberArrayVar invoked with term of incorrect sort, String expected");
            if(pos == 3 && !(term instanceof de.peeeq.wurstscript.ast.Indexes))
                throw new IllegalArgumentException("replace on sort ExprMemberArrayVar invoked with term of incorrect sort, Indexes expected");

            return (de.peeeq.wurstscript.ast.ExprMemberArrayVar) AST.unique(new de.peeeq.wurstscript.ast.ExprMemberArrayVar.Impl(
                ...
                pos == 3 ? (de.peeeq.wurstscript.ast.Indexes) term : _indexes
            ));
        }
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.ExprMemberArrayVar");
            builder.append("( ");
        ...
        public Appendable toString(Appendable builder) throws IOException {
            builder.append("ExprMemberArrayVar");
            builder.append("( ");
