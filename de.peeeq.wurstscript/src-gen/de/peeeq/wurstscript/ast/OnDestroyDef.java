...
public interface OnDestroyDef extends de.peeeq.wurstscript.ast.ClassSlot, KatjaTuple {
    ...
    public de.peeeq.wurstscript.ast.OnDestroyDef replaceSource(de.peeeq.wurstscript.ast.WPos source);
    public de.peeeq.wurstscript.ast.WStatements body();
    public de.peeeq.wurstscript.ast.OnDestroyDef replaceBody(de.peeeq.wurstscript.ast.WStatements body);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.OnDestroyDef.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.wurstscript.ast.OnDestroyDef {
        ...
        Impl(de.peeeq.wurstscript.ast.WPos source, de.peeeq.wurstscript.ast.WStatements body) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort OnDestroyDef invoked with null parameter source");
            if(body == null)
                throw new IllegalArgumentException("constructor of sort OnDestroyDef invoked with null parameter body");
        ...
        public KatjaTerm get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort OnDestroyDef invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort OnDestroyDef invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.wurstscript.ast.OnDestroyDef replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort OnDestroyDef invoked with negative parameter "+pos);
            if(pos >= 2)
                throw new IllegalArgumentException("replace on sort OnDestroyDef invoked with too large parameter "+pos+", sort has only 2 components");

            if(pos == 0 && !(term instanceof de.peeeq.wurstscript.ast.WPos))
                throw new IllegalArgumentException("replace on sort OnDestroyDef invoked with term of incorrect sort, WPos expected");
            if(pos == 1 && !(term instanceof de.peeeq.wurstscript.ast.WStatements))
                throw new IllegalArgumentException("replace on sort OnDestroyDef invoked with term of incorrect sort, WStatements expected");

            return (de.peeeq.wurstscript.ast.OnDestroyDef) AST.unique(new de.peeeq.wurstscript.ast.OnDestroyDef.Impl(
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("AST.OnDestroyDef");
            builder.append("( ");
