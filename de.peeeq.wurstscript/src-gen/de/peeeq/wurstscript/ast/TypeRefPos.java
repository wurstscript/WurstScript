...
public interface TypeRefPos extends de.peeeq.wurstscript.ast.AST.SortPos {

    //----- methods of TypeRefPos -----

    public KatjaSort term();
    public de.peeeq.wurstscript.ast.TypeRef termTypeRef();
    ...
    //----- nested classes of TypeRefPos -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseTypeExprPos(de.peeeq.wurstscript.ast.TypeExprPos term) throws E;
    ...
    static interface VisitorType<E extends Throwable> {
        ...
        public void visit(de.peeeq.wurstscript.ast.TypeRefPos term) throws E;
        public void visit(de.peeeq.wurstscript.ast.TypeExprPos term) throws E;
    }

    public static abstract class Visitor<E extends Throwable> implements de.peeeq.wurstscript.ast.TypeRefPos.VisitorType<E> {
        ...
        private final de.peeeq.wurstscript.ast.TypeRefPos.Switch<Object, E> variantVisit$TypeRefPos = new de.peeeq.wurstscript.ast.TypeRefPos.Switch<Object, E>() { public final Object CaseTypeExprPos(de.peeeq.wurstscript.ast.TypeExprPos term) throws E { visit(term); return null; } public final Object CaseExprNewObjectPos(de.peeeq.wurstscript.ast.ExprNewObjectPos term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.wurstscript.ast.TypeRefPos term) throws E {
            term.Switch(variantVisit$TypeRefPos);
        }
    }
}
