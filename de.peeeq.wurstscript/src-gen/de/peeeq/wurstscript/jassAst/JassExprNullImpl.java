...
class JassExprNullImpl implements JassExprNull, JassAstElementIntern {
	JassExprNullImpl() {
	}
	...
	@Override public JassExprNull copy() {
	...
	@Override public void accept(JassExprNull.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassExprAtomic.Matcher<T> matcher) {
		return matcher.case_JassExprNull(this);
	}
	@Override public void match(JassExprAtomic.MatcherVoid matcher) {
		matcher.case_JassExprNull(this);
	}
