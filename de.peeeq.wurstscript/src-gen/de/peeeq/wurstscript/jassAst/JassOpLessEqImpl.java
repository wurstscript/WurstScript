...
class JassOpLessEqImpl implements JassOpLessEq, JassAstElementIntern {
	JassOpLessEqImpl() {
	}
	...
	@Override public JassOpLessEq copy() {
	...
	@Override public void accept(JassOpLessEq.Visitor v) {
		v.visit(this);
	}
	@Override public <T> T match(JassOpBinary.Matcher<T> matcher) {
		return matcher.case_JassOpLessEq(this);
	}
	@Override public void match(JassOpBinary.MatcherVoid matcher) {
		matcher.case_JassOpLessEq(this);
	}
