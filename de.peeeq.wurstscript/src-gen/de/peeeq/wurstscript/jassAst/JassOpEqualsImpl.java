...
class JassOpEqualsImpl implements JassOpEquals, JassAstElementIntern {
	JassOpEqualsImpl() {
	}
	...
	@Override public JassOpEquals copy() {
	...
	@Override public void accept(JassOpEquals.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassOpBinary.Matcher<T> matcher) {
		return matcher.case_JassOpEquals(this);
	}
	@Override public void match(JassOpBinary.MatcherVoid matcher) {
		matcher.case_JassOpEquals(this);
	}
