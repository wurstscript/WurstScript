...
class JassOpGreaterEqImpl implements JassOpGreaterEq, JassAstElementIntern {
	JassOpGreaterEqImpl() {
	}
	...
	@Override public JassOpGreaterEq copy() {
	...
	@Override public void accept(JassOpGreaterEq.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassOpBinary.Matcher<T> matcher) {
		return matcher.case_JassOpGreaterEq(this);
	}
	@Override public void match(JassOpBinary.MatcherVoid matcher) {
		matcher.case_JassOpGreaterEq(this);
	}
