...
class JassOpAndImpl implements JassOpAnd, JassAstElementIntern {
	JassOpAndImpl() {
	}
	...
	@Override public JassOpAnd copy() {
	...
	@Override public void accept(JassOpAnd.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassOpBinary.Matcher<T> matcher) {
		return matcher.case_JassOpAnd(this);
	}
	@Override public void match(JassOpBinary.MatcherVoid matcher) {
		matcher.case_JassOpAnd(this);
	}
