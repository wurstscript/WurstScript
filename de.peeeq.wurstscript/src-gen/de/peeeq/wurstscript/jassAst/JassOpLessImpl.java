...
class JassOpLessImpl implements JassOpLess, JassAstElementIntern {
	JassOpLessImpl() {
	}
	...
	@Override public JassOpLess copy() {
	...
	@Override public void accept(JassOpLess.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassOpBinary.Matcher<T> matcher) {
		return matcher.case_JassOpLess(this);
	}
	@Override public void match(JassOpBinary.MatcherVoid matcher) {
		matcher.case_JassOpLess(this);
	}
