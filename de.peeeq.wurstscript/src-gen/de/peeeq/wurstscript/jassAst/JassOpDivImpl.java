...
class JassOpDivImpl implements JassOpDiv, JassAstElementIntern {
	JassOpDivImpl() {
	}
	...
	@Override public JassOpDiv copy() {
	...
	@Override public void accept(JassOpDiv.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassOpBinary.Matcher<T> matcher) {
		return matcher.case_JassOpDiv(this);
	}
	@Override public void match(JassOpBinary.MatcherVoid matcher) {
		matcher.case_JassOpDiv(this);
	}
