...
class JassOpGreaterImpl implements JassOpGreater, JassAstElementIntern {
	JassOpGreaterImpl() {
	}
	...
	@Override public JassOpGreater copy() {
	...
	@Override public void accept(JassOpGreater.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassOpBinary.Matcher<T> matcher) {
		return matcher.case_JassOpGreater(this);
	}
	@Override public void match(JassOpBinary.MatcherVoid matcher) {
		matcher.case_JassOpGreater(this);
	}
