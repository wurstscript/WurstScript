...
class JassOpMinusImpl implements JassOpMinus, JassAstElementIntern {
	JassOpMinusImpl() {
	}
	...
	@Override public JassOpMinus copy() {
	...
	@Override public void accept(JassOpMinus.Visitor v) {
		v.visit(this);
	}
	...
	@Override public <T> T match(JassOpUnary.Matcher<T> matcher) {
		return matcher.case_JassOpMinus(this);
	}
	@Override public void match(JassOpUnary.MatcherVoid matcher) {
		matcher.case_JassOpMinus(this);
	}
