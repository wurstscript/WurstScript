...
public class AssetsGenerator {
  ...
  static HashSet<String> forbidden =
      new HashSet<>(Arrays.asList("step", "switch", "nothing", "lightning"));
  ...
  enum Category {
    ...
    TEXTURES(
        (String l) -> l.startsWith("Textures") | l.startsWith("ReplaceableTextures"), "Textures"),
  ...
  public static void generate() throws IOException {
    ...
    String input =
        new String(Files.readAllBytes(rocfile.toPath()))
            + new String(Files.readAllBytes(tftfile.toPath()))
