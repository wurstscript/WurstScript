...
public class TypeNameLinks {
  ...
  public static ImmutableMultimap<String, TypeLink> calculate(
  ...
  private static void addTypeParametersIfAny(
      ImmutableMultimap.Builder<String, TypeLink> result, WScope c) {
  ...
  private static void addJassTypes(
      ImmutableMultimap.Builder<String, TypeLink> result, CompilationUnit cu) {
  ...
  //    private static void addPackages(ImmutableMultimap.Builder<String, TypeLink> result,
  // CompilationUnit cu) {
