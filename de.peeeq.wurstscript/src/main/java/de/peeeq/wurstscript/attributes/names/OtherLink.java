...
public abstract class OtherLink extends NameLink {
  private static final NameDef dummyDef =
      new NameDef() {
        @Override
        ...
        @Override
        public ImmutableCollection<FuncLink> lookupMemberFuncs(
            WurstType receiverType, String name, boolean showErrors) {
          return null;
        }
        ...
        @Override
        public ImmutableCollection<FuncLink> lookupMemberFuncs(
            WurstType receiverType, String name) {
          return null;
        }
