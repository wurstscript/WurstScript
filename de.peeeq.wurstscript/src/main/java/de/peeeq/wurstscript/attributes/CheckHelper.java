...
public class CheckHelper {
   ...
   *
   * <p>Returns an error if it is not a refinement
   */
  public static Optional<String> checkIfIsRefinement(
      VariableBinding typeParamMapping,
  ...
  private static WurstType getRealType(
      Element context, VariableBinding typeParamMapping, WurstType t) {
    return t.setTypeArgs(typeParamMapping);
  }

  public static boolean isRefinement(
      VariableBinding typeParamMapping, FunctionDefinition f, FunctionDefinition of) {
