...
public class ErrorHandling {
  ...
  private static void addErrorOrWarning(Element e, String msg, ErrorType errorType)
      throws CompileError {
  ...
  private static @Nullable CompileError makeCompileError(
      Element e, String msg, ErrorHandler handler, CompileError.ErrorType errorType)
      throws CompileError {
