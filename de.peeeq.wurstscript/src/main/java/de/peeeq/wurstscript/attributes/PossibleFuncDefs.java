...
public class PossibleFuncDefs {
  ...
  private static ImmutableCollection<FuncLink> getExtensionFunction(
      Expr left, Expr right, WurstOperator op) {
  ...
  private static ImmutableCollection<FuncLink> searchFunction(
      String funcName, @Nullable FuncRef node) {
    if (node == null) {
  ...
  private static ImmutableCollection<FuncLink> searchMemberFunc(
      Expr node, WurstType leftType, String funcName) {
  ...
  private static ImmutableCollection<FuncLink> filterInvisible(
      String funcName, Element node, ImmutableCollection<FuncLink> funcs) {
  ...
  private static ImmutableList<FuncLink> filterByReceiverType(
      Element node, String funcName, ImmutableCollection<FuncLink> funcs) {
