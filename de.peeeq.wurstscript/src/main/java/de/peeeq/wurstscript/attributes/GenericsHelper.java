...
public class GenericsHelper {
  ...
  public static VariableBinding givenBinding(
      AstElementWithTypeArgs e, List<TypeParamDef> typeParams) {
    ...
    if (typeArgs.size() > typeParams.size()) {
      res =
          res.withError(
              new CompileError(
                  typeArgs.get(typeParams.size()).attrErrorPos(), "Too many type arguments given"));
    }
    return res;
  }
