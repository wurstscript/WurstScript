...
public class NameResolution {
  ...
  public static ImmutableCollection<FuncLink> lookupFuncsNoConfig(
      Element node, String name, boolean showErrors) {
  ...
  public static ImmutableCollection<FuncLink> lookupFuncs(
      Element e, String name, boolean showErrors) {
  ...
  public static ImmutableCollection<FuncLink> lookupMemberFuncs(
      Element node, WurstType receiverType, String name, boolean showErrors) {
    List<FuncLink> result = Lists.newArrayList();
  ...
  public static void addMemberMethods(
      Element node, WurstType receiverType, String name, List<FuncLink> result) {
  ...
  public static NameLink lookupVarNoConfig(Element node, String name, boolean showErrors) {
    ...
    if (showErrors) {
      if (privateCandidate == null) {
        ...
        node.addError(
            Utils.printElementWithSource(Optional.of(privateCandidate.getDef()))
  ...
  public static NameLink lookupMemberVar(
      Element node, WurstType receiverType, String name, boolean showErrors) {
    WScope scope = node.attrNearestScope();
    while (scope != null) {
      for (DefLink n : scope.attrNameLinks().get(name)) {
  ...
  public static DefLink matchDefLinkReceiver(
      DefLink n, WurstType receiverType, Element node, boolean showErrors) {
    WurstType n_receiverType = n.getReceiverType();
    if (n_receiverType == null) {
      return null;
    }
    VariableBinding mapping =
        receiverType.matchAgainstSupertype(
            n_receiverType,
            node,
            VariableBinding.emptyMapping().withTypeVariables(n.getTypeParams()),
  ...
  public static ImmutableCollection<FuncLink> lookupMemberFuncsShort(
      Element elem, WurstType receiverType, String name) {
