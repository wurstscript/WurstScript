...
public class WurstTypeModuleInstanciation extends WurstTypeNamedScope {
  ...
  public WurstTypeModuleInstanciation(
      ModuleInstanciation moduleInst2, List<WurstTypeBoundTypeParam> newTypes) {
    super(newTypes);
  ...
  public String getName() {
    return getDef().getName()
        + printTypeParams()
        + " (module instanciation in "
        + moduleInst.getParent().attrNearestNamedScope().attrTyp()
        + ")";
  }
