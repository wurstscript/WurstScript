...
public class WurstTypeClosure extends WurstType {
  ...
  VariableBinding matchAgainstSupertypeIntern(
    ...
    if (other instanceof WurstTypeClosure) {
        ...
        mapping =
            o.paramTypes
                ...
                .matchAgainstSupertype(
                    paramTypes.get(i), location, mapping, variablePosition.inverse());
        if (mapping == null) {
          return null;
        }
      }
      ...
      FunctionSignature abstractMethod =
          AttrClosureAbstractMethod.getAbstractMethodSignature(other);
  ...
  private VariableBinding closureImplementsAbstractMethod(
      FunctionSignature abstractMethod,
      Element location,
      VariableBinding mapping,
      VariablePosition variablePosition) {
    ...
    // covariant return types
    return returnType.matchAgainstSupertype(
        abstractMethod.getReturnType().normalize(), location, mapping, variablePosition);
  }
