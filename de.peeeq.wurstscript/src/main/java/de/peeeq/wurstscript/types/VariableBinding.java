...
public class VariableBinding implements Iterable<Tuple2<TypeParamDef, WurstTypeBoundTypeParam>> {
  public static final VariableBinding EMPTY_MAPPING =
      new VariableBinding(HashMap.empty(), List.empty(), List.empty());
  ...
  public VariableBinding(
      HashMap<TypeParamDef, WurstTypeBoundTypeParam> binding,
      List<TypeParamDef> typeVariablesLeft,
  ...
  public VariableBinding union(VariableBinding other) {
    ...
    VariableBinding res =
        new VariableBinding(binding, typeVariablesLeft, errors.appendAll(other.errors));
