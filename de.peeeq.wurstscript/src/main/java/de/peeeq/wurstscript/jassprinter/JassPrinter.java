...
public class JassPrinter {
    ...
    g.match(
        new JassVar.MatcherVoid() {
          ...
          public void case_JassInitializedVar(
              @SuppressWarnings("null") JassInitializedVar jassInitializedVar) {
            ...
            sb.append(jassInitializedVar.getType())
                .append(" ")
                .append(jassInitializedVar.getName())
                .append("=");
  ...
  static void printStatements(
      StringBuilder sb, int indent, List<JassStatement> statements, boolean withSpace) {
  ...
  protected static int precedence(JassOp op) {
    ...
    return op.match(
        new JassOp.Matcher<Integer>() {
          ...
          @Override
          public Integer case_JassOpUnequals(
              @SuppressWarnings("null") JassOpUnequals jassOpUnequals) {
            return 2;
          }

          @Override
          public Integer case_JassOpGreaterEq(
              @SuppressWarnings("null") JassOpGreaterEq jassOpGreaterEq) {
            return 2;
          }
