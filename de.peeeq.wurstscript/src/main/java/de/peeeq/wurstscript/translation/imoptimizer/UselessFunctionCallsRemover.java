...
public class UselessFunctionCallsRemover implements OptimizerPass {
  ...
  /**
   * checks if the jass-function with the given name can have no side effects. Note that these are
   * not all pure functions, some of these functions depend on external state, but they never change
   * it.
   */
