...
public class ExprTranslation {
  ...
  public static JassExpr translate(ImFunctionCall e, ImToJassTranslator translator) {
    ...
    switch (e.getCallType()) {
      ...
      case EXECUTE:
        return JassAst.JassExprFunctionCall(
            "ExecuteFunc", JassAst.JassExprlist(JassAst.JassExprStringVal(f.getName())));
      default:
  ...
  public static JassExpr translate(ImNull e, ImToJassTranslator translator) {
    if (e.getType() instanceof ImAnyType || TypesHelper.isIntType(e.getType())) {
  ...
  public static JassExprVarArrayAccess translate(
      ImVarArrayAccess e, ImToJassTranslator translator) {
    JassVar v = translator.getJassVarFor(e.getVar());
  ...
  public static JassExpr translate(ImClassRelatedExpr e, ImToJassTranslator translator) {
