...
public class OverrideUtils {
  ...
  public static void addOverrideClosure(
      ImTranslator tr, FuncDef superMethod, ImMethod m, ExprClosure exprClosure) {
  ...
  public static void addOverride(
      ...
      if (toIndex != null) {
        ...
        arg =
            JassIm.ImFunctionCall(
                e, toIndexF, JassIm.ImTypeArguments(), JassIm.ImExprs(arg), false, CallType.NORMAL);
      }
      arguments.add(arg);
    }
    ...
    ImMethod wrapperMethod =
        JassIm.ImMethod(
            e,
            subMethod.getMethodClass(),
            subMethod.getName() + "_wrapper",
            implementation,
            subMethods,
            false);
