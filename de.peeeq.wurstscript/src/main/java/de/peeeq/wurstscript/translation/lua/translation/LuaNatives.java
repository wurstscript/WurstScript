...
public class LuaNatives {
  ...
  static {
          ...
          f.getBody()
              .add(
                  LuaAst.LuaExprFunctionCallByName(
                      "print", LuaAst.LuaExprlist(LuaAst.LuaExprVarAccess(p))));
        });
    ...
    addNative(
        Arrays.asList("SaveInteger", "SaveBoolean", "SaveReal", "SaveStr", "SaveBoolean"),
        f -> {
          f.getParams().add(LuaAst.LuaVariable("h", LuaAst.LuaNoExpr()));
    ...
    addNative(
        Arrays.asList("LoadInteger", "LoadBoolean", "LoadReal", "LoadStr", "LoadBoolean"),
        f -> {
          f.getParams().add(LuaAst.LuaVariable("h", LuaAst.LuaNoExpr()));
          f.getParams().add(LuaAst.LuaVariable("p", LuaAst.LuaNoExpr()));
          f.getParams().add(LuaAst.LuaVariable("c", LuaAst.LuaNoExpr()));
        ...
        .getOrDefault(
            ...
            ff -> {
              ...
              f.getBody()
                  .add(
                      LuaAst.LuaLiteral(
                          "error(\"The native '" + ff.getName() + "' is not implemented.\")"));
            })
        .accept(f);
  }
}
