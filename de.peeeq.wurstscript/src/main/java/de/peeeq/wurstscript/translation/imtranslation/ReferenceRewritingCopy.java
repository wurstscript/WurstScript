...
public class ReferenceRewritingCopy {
  ...
  private static <T extends Element> void rewriteReferences(
      T copy, Map<Element, Element> oldToNew) {
    copy.accept(
  ...
  private static <T extends Element> void calcOldToNew(
      T elem, T copy, HashMap<Element, Element> result) {
