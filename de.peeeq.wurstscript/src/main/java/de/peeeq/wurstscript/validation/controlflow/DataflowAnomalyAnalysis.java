...
class VarStates {
  ...
  public boolean equals(Object o) {
    ...
    return thisDestroyed == varStates.thisDestroyed && Objects.equals(states, varStates.states);
  }
  ...
  public VarStates addRead(LocalVarDef v, Element r) {
    ...
    ImmutableMap<LocalVarDef, VState> rs = builder.put(v, s).build();
...
class VState {
  ...
  public static final VState initialDefined =
      new VState(false, false, ImmutableSetMultimap.of(), ImmutableSet.of(), ImmutableSet.of());
  public static final VState initial =
      new VState(true, false, ImmutableSetMultimap.of(), ImmutableSet.of(), ImmutableSet.of());
  public static final VState destroyed =
      new VState(false, true, ImmutableSetMultimap.of(), ImmutableSet.of(), ImmutableSet.of());
  ...
  public VState(
      boolean mightBeUninitialized,
      boolean mightBeDestroyed,
      ImmutableSetMultimap<WStatement, Element> writesAndReads,
      ImmutableSet<WStatement> activeWrites,
      ImmutableSet<WStatement> allWrites) {
  ...
  public VState addRead(Element r) {
    ...
    return new VState(
        mightBeUninitialized, mightBeDestroyed, builder.build(), activeWrites, allWrites);
  }

  public VState merge(VState other) {
    return new VState(
        mightBeUninitialized || other.mightBeUninitialized,
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    if (!activeWrites.equals(other.activeWrites)) return false;
    if (!allWrites.equals(other.allWrites)) return false;
    if (mightBeUninitialized != other.mightBeUninitialized) return false;
    if (mightBeDestroyed != other.mightBeDestroyed) return false;
    if (!writesAndReads.equals(other.writesAndReads)) return false;
    return true;
  }
  ...
  public String toString() {
    StringBuilder sb =
        new StringBuilder(
            "VState [ " + this.mightBeUninitialized + ", " + this.mightBeDestroyed + ", ");
    for (Entry<WStatement, Element> e : this.writesAndReads.entries()) {
      sb.append("\n\t\t");
      sb.append(e.getKey().attrSource().getLine())
          .append(" -> ")
          .append(e.getValue().attrSource().getLine());
    }
    sb.append("]");
    return sb.toString();
  }
...
public class DataflowAnomalyAnalysis extends ForwardMethod<VarStates, AstElementWithBody> {
  ...
  VarStates calculate(WStatement s, VarStates incoming) {
    ...
    if (n != null) {
      ...
      ////					s.addError("Assigning to " + Utils.printElement(n) + " overrides previous assignment
      // in line " + wr.attrSource().getLine());
      //				}
      //			}
      if (isLocalVarDef(n)) {
