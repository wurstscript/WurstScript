...
public class CompiletimeNatives extends ReflectionBasedNativeProvider implements NativesProvider {
  ...
  public ILconstTuple createObjectDefinition(
    ...
    if (modifiedTable.getObjectDefinitions().containsKey(newUnitId.getVal())) {
      globalState.compilationError(
          "Object definition with id "
              + ObjectHelper.objectIdIntToString(newUnitId.getVal())
              + " already exists.");
    }
    ObjectDefinition objDef =
        new ObjectDefinition(modifiedTable, deriveFrom.getVal(), newUnitId.getVal());
  ...
  public void ObjectDefinition_setInt(
      ILconstTuple unitType, ILconstString modification, ILconstInt value) {
  ...
  public void ObjectDefinition_setString(
      ILconstTuple unitType, ILconstString modification, ILconstString value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(od, modification, VariableType.STRING, value.getVal());
  }

  public void ObjectDefinition_setReal(
      ILconstTuple unitType, ILconstString modification, ILconstReal value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(od, modification, VariableType.REAL, value.getVal());
  }

  public void ObjectDefinition_setUnreal(
      ILconstTuple unitType, ILconstString modification, ILconstReal value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(od, modification, VariableType.UNREAL, value.getVal());
  }

  public void ObjectDefinition_setLvlInt(
      ILconstTuple unitType, ILconstString modification, ILconstInt level, ILconstInt value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(od, modification, VariableType.INTEGER, level.getVal(), value.getVal());
  }

  public void ObjectDefinition_setLvlString(
      ILconstTuple unitType, ILconstString modification, ILconstInt level, ILconstString value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(od, modification, VariableType.STRING, level.getVal(), value.getVal());
  }

  public void ObjectDefinition_setLvlReal(
      ILconstTuple unitType, ILconstString modification, ILconstInt level, ILconstReal value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(od, modification, VariableType.REAL, level.getVal(), value.getVal());
  }

  public void ObjectDefinition_setLvlUnreal(
      ILconstTuple unitType, ILconstString modification, ILconstInt level, ILconstReal value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(od, modification, VariableType.UNREAL, level.getVal(), value.getVal());
  }

  public void ObjectDefinition_setLvlDataInt(
      ILconstTuple unitType,
      ILconstString modification,
      ILconstInt level,
      ILconstInt dataPointer,
      ILconstInt value) {
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(
        od,
  ...
  public void ObjectDefinition_setLvlDataString(
      ILconstTuple unitType,
      ILconstString modification,
      ILconstInt level,
      ILconstInt dataPointer,
  ...
  public void ObjectDefinition_setLvlDataReal(
      ILconstTuple unitType,
      ILconstString modification,
      ILconstInt level,
      ILconstInt dataPointer,
    ...
    ObjectDefinition od = globalState.getObjectDefinition(getKey(unitType));
    modifyObject(
        od, modification, VariableType.REAL, level.getVal(), dataPointer.getVal(), value.getVal());
  }

  public void ObjectDefinition_setLvlDataUnreal(
      ILconstTuple unitType,
      ILconstString modification,
      ILconstInt level,
      ILconstInt dataPointer,
  ...
  private <T> void modifyObject(
      ObjectDefinition od, ILconstString modification, VariableType<T> variableType, T value) {
