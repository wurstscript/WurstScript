...
public class ImageProvider extends Provider {
  ...
  public IlConstHandle CreateImage(
      ILconstString file,
      ILconstReal sizeX,
      ILconstReal sizeY,
      ILconstReal sizeZ,
      ...
      ILconstReal originY,
      ILconstReal originZ,
      ILconstInt imageType) {
    return new IlConstHandle(
        NameProvider.getRandomName("image"),
        new ImageMock(
            file, sizeX, sizeY, sizeZ, posX, posY, posZ, originX, originY, originZ, imageType));
  }
  ...
  public void SetImageAboveWater(
      IlConstHandle image, ILconstBool flag, ILconstBool useWaterAlpha) {}
