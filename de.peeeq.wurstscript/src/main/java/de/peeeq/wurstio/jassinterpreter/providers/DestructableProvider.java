...
public class DestructableProvider extends Provider {
  ...
  public IlConstHandle CreateDestructable(
      ILconstInt objectId,
      ILconstReal x,
      ILconstReal y,
      ILconstReal face,
      ILconstReal scale,
      ILconstInt variation) {
    return new IlConstHandle(
        NameProvider.getRandomName("destructable"),
        new DestructableMock(objectId, x, y, face, scale, variation));
  }
