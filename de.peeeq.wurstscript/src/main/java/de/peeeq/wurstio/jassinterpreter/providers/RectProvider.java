...
public class RectProvider extends Provider {
  ...
  public IlConstHandle Rect(
      ILconstReal minx, ILconstReal miny, ILconstReal maxx, ILconstReal maxy) {
    return new IlConstHandle(
        NameProvider.getRandomName("rect"), new RectMock(minx, miny, maxx, maxy));
  }
  ...
  public void SetRect(
      IlConstHandle rect, ILconstReal minx, ILconstReal miny, ILconstReal maxx, ILconstReal maxy) {
    RectMock rectMock = (RectMock) rect.getObj();
    rectMock.maxx = maxx;
    rectMock.maxy = maxy;
    rectMock.minx = minx;
