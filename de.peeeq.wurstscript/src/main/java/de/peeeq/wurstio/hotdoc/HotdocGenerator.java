...
public class HotdocGenerator {
  ...
  private <T extends FunctionDefinition> void documentFuncs(
      List<T> funcs, StringWriter writer, boolean includeNonPublic) {
  ...
  private <T extends VarDef> void documentVars(
      List<T> vardefs, StringWriter writer, boolean includeNonPublic) {
