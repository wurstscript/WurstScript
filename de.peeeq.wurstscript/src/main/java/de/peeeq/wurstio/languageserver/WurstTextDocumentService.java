...
public class WurstTextDocumentService implements TextDocumentService {
  ...
  public CompletableFuture<Either<List<CompletionItem>, CompletionList>> completion(
    ...
    return worker
        .handle(new GetCompletions(position, worker.getBufferManager()))
  ...
  public CompletableFuture<Either<List<? extends Location>, List<? extends LocationLink>>>
      definition(DefinitionParams definitionParams) {
  ...
  public CompletableFuture<List<? extends Location>> references(ReferenceParams params) {
    ...
    return worker
        .handle(new GetUsages(params, worker.getBufferManager(), true))
        .thenApply(
            (List<GetUsages.UsagesData> udList) ->
                udList.stream()
  ...
  public CompletableFuture<List<? extends DocumentHighlight>> documentHighlight(
      DocumentHighlightParams highlightParams) {
    WLogger.info("documentHighlight");
    return worker
        .handle(new GetUsages(highlightParams, worker.getBufferManager(), false))
        .thenApply(
            (List<GetUsages.UsagesData> udList) ->
                udList.stream()
