...
public class HoverInfo extends UserRequest<Hover> {
      ...
      return new Hover(
          Collections.singletonList(
              Either.forLeft(
                  "File "
                      + filename
                      + " is not part of the project. Move it to the wurst folder.")));
    }
  ...
  private List<Either<String, MarkedString>> addArgumentHint(
      Element e, List<Either<String, MarkedString>> desription) {
    try {
      if (e.getParent() instanceof Arguments) {
        ...
        if (args.getParent() instanceof FunctionCall) {
          ...
          desription =
              Utils.append(
                  desription, Either.forLeft("Parameter " + parameterType + " " + parameterName));
        }
      }
    } catch (Exception ex) {
  ...
  static class Description implements Element.Matcher<List<Either<String, MarkedString>>> {
    ...
    public List<Either<String, MarkedString>> description(NameDef n) {
      ...
      String additionalProposalInfo =
          type(n.attrTyp()) + " " + n.getName() + " defined in " + nearestScopeName(n);
    ...
    @Override
    public List<Either<String, MarkedString>> case_StartFunctionStatement(
        StartFunctionStatement startFunctionStatement) {
    ...
    public List<Either<String, MarkedString>> case_ModStatic(ModStatic modStatic) {
      return string(
          "static: This function or variable is just like a function outside of a class. "
    ...
    public List<Either<String, MarkedString>> case_WImport(WImport imp) {
      ...
      if (imported != null) return string(imported.attrComment());
    ...
    @Override
    public List<Either<String, MarkedString>> case_VisibilityProtected(
    ...
    public List<Either<String, MarkedString>> case_ConstructorDef(ConstructorDef constr) {
      ...
      String descr =
          "construct(" + getParameterString(constr) + ") " + "defined in " + Utils.printElement(c);
    ...
    @Override
    public List<Either<String, MarkedString>> case_CompilationUnit(
    ...
    public List<Either<String, MarkedString>> case_SwitchStmt(SwitchStmt switchStmt) {
      return string(
          "A switch statement does different things depending on the value of an epxression.");
    }

    @Override
    public List<Either<String, MarkedString>> case_ExtensionFuncDef(
        ExtensionFuncDef extensionFuncDef) {
      return description(extensionFuncDef);
    }

    @Override
    public List<Either<String, MarkedString>> case_EndFunctionStatement(
        EndFunctionStatement endFunctionStatement) {
      return string("end function");
    }

    @Override
    public List<Either<String, MarkedString>> case_ArrayInitializer(
    ...
    public List<Either<String, MarkedString>> case_ModOverride(ModOverride modOverride) {
      return string(
          "override: This function overrides an other function from a module or superclass");
    }

    @Override
    public List<Either<String, MarkedString>> case_SomeSuperConstructorCall(
        SomeSuperConstructorCall sc) {
    ...
    public List<Either<String, MarkedString>> case_StmtForRangeDown(StmtForRangeDown s) {
      return string(
          "Do something for all " + s.getLoopVar().getName() + " counting from _ down to _");
    }
    ...
    @Override
    public List<Either<String, MarkedString>> case_IdentifierWithTypeArgs(
        IdentifierWithTypeArgs identifierWithTypeArgs) {
      return identifierWithTypeArgs.getParent().match(this);
    }

    @Override
    public List<Either<String, MarkedString>> case_ExprMemberVarDotDot(
        ExprMemberVarDotDot exprMemberVarDotDot) {
      return description(exprMemberVarDotDot);
    }

    @Override
    public List<Either<String, MarkedString>> case_ExprVarArrayAccess(
        ExprVarArrayAccess exprVarArrayAccess) {
      return description(exprVarArrayAccess);
    }

    @Override
    public List<Either<String, MarkedString>> case_ExprMemberMethodDot(
        ExprMemberMethodDot exprMemberMethodDot) {
    ...
    public List<Either<String, MarkedString>> case_ExprClosure(ExprClosure exprClosure) {
      return string(
          "Closure with type "
              + exprClosure.attrTyp()
              + " (implements "
              + exprClosure.attrExpectedTypAfterOverloading()
              + ")");
    }
    ...
    @Override
    public List<Either<String, MarkedString>> case_ExprFunctionCall(
    ...
    @Override
    public List<Either<String, MarkedString>> case_VisibilityPrivate(
        VisibilityPrivate visibilityPrivate) {
      return string("Modifier private: This element can only be used in the current scope.");
    }

    @Override
    public List<Either<String, MarkedString>> case_VisibilityDefault(
    ...
    @Override
    public List<Either<String, MarkedString>> case_ModuleInstanciations(
        ModuleInstanciations moduleInstanciations) {
      return string("List of module instantiations.");
    }

    @Override
    public List<Either<String, MarkedString>> case_WShortParameters(
        WShortParameters wShortParameters) {
      return string("Parameters of anonymous function.");
    }

    @Override
    public List<Either<String, MarkedString>> case_SwitchDefaultCaseStatements(
        SwitchDefaultCaseStatements switchDefaultCaseStatements) {
      return string("Default statements of switch-statement");
    }

    @Override
    public List<Either<String, MarkedString>> case_ExprStatementsBlock(
        ExprStatementsBlock exprStatementsBlock) {
    ...
    @Override
    public List<Either<String, MarkedString>> case_JassToplevelDeclarations(
        JassToplevelDeclarations jassToplevelDeclarations) {
    ...
    @Override
    public List<Either<String, MarkedString>> case_ExprMemberArrayVarDotDot(
        ExprMemberArrayVarDotDot exprMemberArrayVarDotDot) {
      return description(exprMemberArrayVarDotDot);
    }

    @Override
    public List<Either<String, MarkedString>> case_ConstructorDefs(
    ...
    public List<Either<String, MarkedString>> case_ModAbstract(ModAbstract modAbstract) {
      return string(
          "Abstract members are declarations without implementations. They must be implemented in concrete subtypes.");
    }
    ...
    @Override
    public List<Either<String, MarkedString>> case_NoTypeParamConstraints(
        NoTypeParamConstraints noTypeParamConstraints) {
    ...
    @Override
    public List<Either<String, MarkedString>> case_ModuleInstanciation(
        ModuleInstanciation moduleInstanciation) {
      return string("A module instantiation.");
    }

    @Override
    public List<Either<String, MarkedString>> case_ExprMemberArrayVarDot(
    ...
    public List<Either<String, MarkedString>> case_StmtForFrom(StmtForFrom stmtForFrom) {
      return string(
          "The for-from loop takes an iterate and takes elements from the iterator until it is empty.");
    }
    ...
    @Override
    public List<Either<String, MarkedString>> case_VisibilityPublicread(
        VisibilityPublicread visibilityPublicread) {
    ...
    public List<Either<String, MarkedString>> case_ExprInstanceOf(ExprInstanceOf exprInstanceOf) {
      return string(
          "The instanceof expression checks if an object is an instance of a given type.");
    }
    ...
    @Override
    public List<Either<String, MarkedString>> case_ExprMemberMethodDotDot(
        ExprMemberMethodDotDot exprMemberMethodDotDot) {
    ...
    @Override
    public List<Either<String, MarkedString>> case_IdentifierWithTypeParamDefs(
    ...
    @Override
    public List<Either<String, MarkedString>> case_NoSuperConstructorCall(
        NoSuperConstructorCall noSuperConstructorCall) {
    ...
    @Override
    public List<Either<String, MarkedString>> case_TypeExprResolved(
        TypeExprResolved typeExprResolved) {
      return typeExpr(typeExprResolved);
    }

    @Override
    public List<Either<String, MarkedString>> case_VisibilityPublic(
        VisibilityPublic visibilityPublic) {
      return string("This element can be used everywhere");
    }

    @Override
    public List<Either<String, MarkedString>> case_TopLevelDeclarations(
    ...
    @Override
    public List<Either<String, MarkedString>> case_JassGlobalBlock(
        JassGlobalBlock jassGlobalBlock) {
    ...
    public List<Either<String, MarkedString>> case_StmtForIn(StmtForIn stmtForIn) {
      return string(
          "The for-in loop executes the loop body for every element in the given collection using its iterator method.");
    }
    ...
    @Override
    public List<Either<String, MarkedString>> case_WShortParameter(
        WShortParameter wShortParameter) {
      return description(wShortParameter);
    }

    @Override
    public List<Either<String, MarkedString>> case_ExprMemberVarDot(
        ExprMemberVarDot exprMemberVarDot) {
