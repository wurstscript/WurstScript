...
public class WurstLanguageServer
  ...
  private de.peeeq.wurstio.languageserver.LanguageWorker languageWorker =
      new de.peeeq.wurstio.languageserver.LanguageWorker();
  ...
  public CompletableFuture<InitializeResult> initialize(InitializeParams params) {
    ...
    try {
      ...
      System.err.println(
          "Your JVM doesn't support UTF-8 encoding. Output defaults to system encoding.");
    }
    ...
    capabilities.setCompletionProvider(
        new CompletionOptions(false, Collections.singletonList(".")));
    ...
    capabilities.setExecuteCommandProvider(
        new ExecuteCommandOptions(WurstCommands.providedCommands()));
