...
public class ObjectDefinition {
  ...
  static ObjectDefinition readFromStream(BinaryDataInputStream in, ObjectTable parent)
      throws IOException {
  ...
  public void writeToStream(BinaryDataOutputStream out, ObjectFileType fileType)
      throws IOException {
  ...
  public void exportToWurst(Appendable out) throws IOException {
    ...
    out.append("@compiletime function create_")
        .append(parent.getFileType().getExt())
        .append("_")
        .append(newId)
        .append("()\n");
