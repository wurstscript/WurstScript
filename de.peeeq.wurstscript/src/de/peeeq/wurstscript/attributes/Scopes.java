...
//	}
//
//	public static Multimap<String, NameDef> getDefinedNames(StructureDef c) {
//		Multimap<String, NameDef> result = HashMultimap.create();
//		addTypeParametersIfAny(result, c);
...
//
//
//	private static void addDefinedNames(Multimap<String, NameDef> result, StructureDef c) {
...
//		for (NameDef n : slots) {
//			result.put(n.getName(), n);
////			if (n instanceof StructureDef) {
////				StructureDef s = (StructureDef) n;
...
//
//
//	public static Multimap<String, NameDef> getDefinedNames(
//			WStatements wStatements) {
