...
public class RunArgs {
	...
	public RunArgs(String ... args) {
		...
		optionLib = addOptionWithArg("lib", "The next argument should be a library folder which is lazily added to the build.", new Function<String, Void>() {
			@Override
