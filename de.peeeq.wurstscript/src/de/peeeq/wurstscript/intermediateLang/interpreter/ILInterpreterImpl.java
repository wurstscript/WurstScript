...
//				value  = ILconstBool.FALSE;
//			}else if (v.getType() instanceof PScriptTypeReal) {
//				value  = new ILconstReal(0.0f);
...
//			} else if (rightValue instanceof ILconstReal) {
//				ILconstReal r = (ILconstReal) rightValue;
//				result  = new ILconstReal(r.negate());
//			}
//		}else if (s.getOp() == Iloperator.NOT) {
//			if (rightValue instanceof ILconstBool) {
//				ILconstBool r = (ILconstBool) rightValue;
//				result  = ILconstBool.instance(r.not());
//			}
//		}
//
...
//			} else if (leftValue instanceof ILconstReal) {
//				float l = ((ILconstReal) leftValue).getVal().floatValue();
//				float r = ((ILconstReal) rightValue).getVal().floatValue();
//				result  = new ILconstReal(l + r);
...
//				ILconstInt l = (ILconstInt) leftValue;
//				ILconstInt r = (ILconstInt) rightValue;
//				result  = new ILconstReal((1.0*l.getVal()) / r.getVal());
//			}else if(leftValue instanceof ILconstReal) {
//				double l = ((ILconstReal) leftValue).getVal().floatValue();
//				double r = ((ILconstReal) rightValue).getVal().floatValue();
//				double sum = l + r;
//				result  = new ILconstReal( sum );
//			}
...
//				ILconstInt l = (ILconstInt) leftValue;
//				ILconstInt r = (ILconstInt) rightValue;
//				result  = ILconstBool.instance(l.getVal() < r.getVal());
//			} else if (leftValue instanceof ILconstReal) {
//				float l = ((ILconstReal) leftValue).getVal().floatValue();
//				float r = ((ILconstReal) rightValue).getVal().floatValue();
//				result  = ILconstBool.instance(l < r);
//			}
...
//				String l = ((ILconstString) leftValue).getVal();
//				String r = ((ILconstString) rightValue).getVal();
//				result  = ILconstBool.instance(l.equals(r));
//			}
