...
public class VarargTests extends WurstScriptTest {
  ...
  public void testVarargSyntax() {
    testAssertOkLines(false, "package Test", "function foo(vararg int ints)");
  }
  ...
  public void testVarargInput() {
    testAssertOkLines(
        false, "package Test", "function foo(vararg int ints)", "init", "    foo(1,2,3)");
  }
  ...
  public void varargWithBreak() {
    testAssertErrorsLines(
        true,
        "Cannot use break in vararg for each loops",
        "package Test",
        "native testSuccess()",
        "function foo(vararg int ints)",
        "    var sum = 0",
  ...
  public void testVarargInvalidOverload() {
    testAssertErrorsLines(
        true,
        "Call to function foo is ambiguous",
        "package Test",
        "native testSuccess()",
  ...
  public void testInvalidArgs() {
    testAssertErrorsLines(
        false,
        "Wrong parameter type when calling format",
        "package Test",
