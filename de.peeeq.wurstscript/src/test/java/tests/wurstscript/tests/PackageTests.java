...
public class PackageTests extends WurstScriptTest {
  ...
  public void duplicatePackageName() {
    testAssertErrorsLines(false, "already", "package A", "endpackage", "package A", "endpackage");
  }
  ...
  public void test_global_type() {
    testAssertOkLines(
        false, "type unit extends handle", "package B", "	init", "		unit u = null", "endpackage");
  }
  ...
  public void test_same_name_as_class() {
    testAssertOkLines(false, "package A", "	class A", "endpackage");
  }

  @Test
  public void import_self1() {
    testAssertErrorsLines(
        false, "Packages cannot import themselves", "package A", "	import A", "endpackage");
  }
  ...
  public void import_self2() {
    testAssertErrorsLines(
        false,
        "Packages cannot import themselves",
        "package A",
        "	import initlater A",
        "endpackage");
  }
