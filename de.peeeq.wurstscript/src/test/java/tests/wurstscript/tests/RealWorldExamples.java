...
public class RealWorldExamples extends WurstScriptTest {
  ...
  public void testEditorVars() throws IOException {
    ...
    testAssertErrorFileWithStdLib(
        new File(TEST_DIR + "EditorVariables.wurst"),
        "Translation Error: Could not find definition of gg_",
        false);
  }
  ...
  public void nonStaticCallback() throws IOException {
    super.testAssertErrorFileWithStdLib(
        new File(TEST_DIR + "nonStaticCallback.wurst"), "without parameters", false);
  }
  ...
  public void criggesInitOrder1() throws IOException {
    super.testAssertErrorFileWithStdLib(
        new File(TEST_DIR + "CriggesInitOrder1.wurst"), "not yet initialized", false);
  }
  ...
  public void criggesInitOrder2() throws IOException {
    super.testAssertErrorFileWithStdLib(
        new File(TEST_DIR + "CriggesInitOrder2.wurst"), "used before it is initialized", false);
  }
  ...
  public void test_stdlib() {
    ...
    WurstCompilerJassImpl comp =
        new WurstCompilerJassImpl(null, new WurstGuiCliImpl(), null, runArgs);
