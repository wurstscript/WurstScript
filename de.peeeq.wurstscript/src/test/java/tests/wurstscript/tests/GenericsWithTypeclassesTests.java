...
public class GenericsWithTypeclassesTests extends WurstScriptTest {
  ...
  public void implicitConversionFailSimple() { // see bug #121
    testAssertErrorsLines(
        false,
        "cast expression not defined for expression type int",
        "type effect extends handle",
        "package Test",
        "class List<T:>",
        "	function get() returns T",
  ...
  public void genericsSubstitute_override_interface_fail() {
    testAssertErrorsLines(
        false,
        "Parameter int s should have type MyType to override function bla",
        "package Test",
        "interface I<T:,S:>",
        "	function bla(S s, T t)",
        "interface J<T:> extends I<int,T>",
  ...
  public void nullWithGeneric() {
    testAssertErrorsLines(
        false,
        "Cannot compare types T with null",
        "package test",
        "native testSuccess()",
        "function foo<T:>(T t)",
        "	if t == null",
