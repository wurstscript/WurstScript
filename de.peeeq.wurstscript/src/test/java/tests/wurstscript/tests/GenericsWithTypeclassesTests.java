...
//                "		while iterator.hasNext()",
    ...
    public void genericClassStaticAttribute() {
        testAssertOkLines(true,
            ...
            "    Box<real>.count = 3",
            "    BoxInt.count = 4",
            "    if BoxInt.count == 4 and Box<int>.count == 2 and Box<real>.count == 3",
            "        testSuccess()",
            "endpackage"
        );
    }
    ...
    @Test
    public void genericClassWithLLModule2() {
        testAssertOkLinesWithStdLib(true,
            "package test",
            "import LinkedListModule",
            "",
            ...
            "        return",
            "",
            "    // Forward iteration sum",
            "    var sum = 0",
            "    let it1 = Box<int>.iterator()",
            "    while it1.hasNext()",
            "        sum += it1.next().getValue()",
            "    it1.close()",
            "    if sum != 6",
            "        return",
            "",
            "    // Backward iteration: sequence 3,2,1 → 321",
            "    var seq = 0",
            "    let bit = Box<int>.backIterator()",
            "    while bit.hasNext()",
            "        seq = seq * 10 + bit.next().getValue()",
            "    bit.close()",
            "    if seq != 321",
            "        return",
            "",
            ...
            "",
            "    // Check ordering",
            "    if OtherBox<int>.getFirst() != o1",
            "        return",
            "",
            "    if o1.getPrev() != o3 or o3.getNext() != o1",
            "        return",
            "",
            "    // Sum using static iterator",
            "    var sumO = 0",
            "    let oit = OtherBox<int>.staticItr()",
            "    while oit.hasNext()",
            "        sumO += oit.next().get()",
            "    oit.close()",
            "    if sumO != 60",
            ...
            "    destroy o3",
            "",
            "    // After destruction list must be empty",
            "    let oit2 = OtherBox<int>.iterator()",
            "    if oit2.hasNext()",
            "        return",
            "    oit2.close()",
            "",
