...
public class ArrayTests extends WurstScriptTest {
  ...
  public void testArray1() {
    assertOk(true, "int array blub", "init", "	blub[5] = 3", "	if blub[5] == 3", "		testSuccess()");
  }

  @Test
  public void testArrayParam() {
    testAssertErrorsLines(
        false, "arrays as parameter", "package Test", "function foo(int array a)", "endpackage");
  }
  ...
  public void array_init_global1() {
    assertOk(true, "int array blub = [1,2,3,4]", "init", "	if blub[2] == 3", "		testSuccess()");
  }

  @Test
  public void array_init_global_type_inference() {
    assertOk(true, "var blub = [1,2,3,4]", "init", "	if blub[2] == 3", "		testSuccess()");
  }

  @Test
  public void array_init_local_type_inference() {
    assertOk(true, "init", "	var blub = [1,2,3,4]", "	if blub[2] == 3", "		testSuccess()");
  }
  ...
  public void array_init_global_fail1() {
    testAssertErrorsLines(
        false,
        "Expected expression of type int in array initialization, but found string",
        "package test",
  ...
  public void array_init_global_fail2() {
    testAssertErrorsLines(
        false,
        "Expected expression of type B in array initialization, but found C",
        "package test",
        "class A",
        "class B extends A",
        "class C extends A",
  ...
  public void array_init_global_fail3() {
    testAssertErrorsLines(
        false,
        "Cannot assign string to string array",
        "package test",
  ...
  public void array_init_length1() {
    assertOk(true, "init", "	var blub = [1,2,3,4]", "	if blub.length == 4", "		testSuccess()");
  }

  @Test
  public void array_init_length2() {
    assertOk(true, "init", "	int array[7] blub", "	if blub.length == 7", "		testSuccess()");
  }
  ...
  public void multiArrayWrongSize() {
    testAssertErrorsLines(
        true,
        "Array variable v is an array of size 3, but is initialized with 4 values here.",
        "package test",
        "class C",
