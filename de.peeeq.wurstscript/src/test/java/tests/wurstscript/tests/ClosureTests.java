...
public class ClosureTests extends WurstScriptTest {
  ...
  public void code_anonfunc_mixed_err1() {
    testAssertErrorsLines(
        false,
        "Cannot capture local variable 'z'",
        "package test",
        "interface I",
        "	function f()",
        "function foo(code c)",
  ...
  public void code_anonfuncErr2() {
    testAssertErrorsLines(
        false,
        "Cannot capture local variable 'this'",
        "package test",
        "function foo(code c)",
        "class C",
        "	function bar()",
  ...
  public void skipInClosure_fail() {
    testAssertErrorsLines(
        false,
        "Cannot assign () -> Void to SimpleFunc",
        "package test",
        "native testSuccess()",
        "interface SimpleFunc",
        "    function call() returns int",
  ...
  public void overload1() {
    testAssertErrorsLines(
        true,
        "No operator overloading function for operator + was found for operands (integer or string) and integer-literal.",
        "package A",
        "   native testSuccess()",
        "   interface Func",
        "       function apply(int x) returns int",
