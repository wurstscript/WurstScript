...
public class AutoCompleteTests extends WurstLanguageServerTest {
  ...
  public void testWithParentheses() {
    CompletionTestData testData = input("package test", "init", "    CreateG|()", "");
  ...
  public void testWithParentheses2() {
    CompletionTestData testData = input("package test", "init", "    CreateU|(x,y,z)", "");

    CompletionList completions = calculateCompletions(testData);
    assertFalse(completions.getItems().isEmpty());
    CompletionItem comp =
        completions.getItems().stream()
  ...
  public void testWithoutParentheses() {
    CompletionTestData testData = input("package test", "	init", "		CreateG|", "endpackage");
  ...
  public void testWithoutParentheses2() {
    CompletionTestData testData = input("package test", "	init", "		CreateU|", "endpackage");
    ...
    CompletionItem comp =
        completions.getItems().stream()
            ...
            .get();
    assertEquals(
        comp.getInsertText(), "CreateUnit(${1:id}, ${2:unitid}, ${3:x}, ${4:y}, ${5:face})");
  }
