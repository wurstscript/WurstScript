...
public class BugTests extends WurstScriptTest {
  ...
  public void intBoundariesL() {
    testAssertErrorsLines(
        false, "Invalid number", "package test", "	int i1 = -2147483649", "endpackage");
  }

  @Test
  public void intBoundariesH() {
    testAssertErrorsLines(
        false, "Invalid number", "package test", "	int i1 = 2147483648", "endpackage");
  }

  @Test
  public void bug62_codearray() {
    testAssertErrorsLines(false, "Code arrays", "package test", "	code array coar", "endpackage");
  }

  @Test
  public void bug61_break() {
    testAssertErrorsLines(false, "inside a loop", "package test", "	init", "		break", "endpackage");
  }
  ...
  public void test_init_order_jass_warning() {
    testAssertErrorsLines(
        false,
        "Variable b may not have been initialized",
  ...
  public void test_init_order_globals_warning() {
    testAssertErrorsLines(
        false,
        "Global variable b must be declared before it is used.",
        "package test",
        "	integer a = b",
        "	integer b = 3",
        "	native testSuccess()",
  ...
  public void test_init_order_globals_warning_jass() {
    testAssertErrorsLines(
        false,
        "Global variable b used before it is declared.",
        "globals",
        "	integer a = b",
        "	integer b = 3",
        "endglobals",
  ...
  public void cyclicDependency() {
    testAssertErrorsLines(
        false, "cyclic class hierarchy", "package test", "	class A extends A", "endpackage");
  }
  ...
  public void cyclicDependency2() {
    testAssertErrorsLines(
        false,
        "Interface I has a cyclic class hierarchy",
        "package test",
  ...
  public void nonAbstractClass() {
    testAssertErrorsLines(
        false,
        "Non-abstract class A cannot have abstract functions like blub",
        "package test",
        "	class A",
  ...
  public void division() {
    testAssertErrorsLines(false, "div", "package test", "int x = 5 div 3.", "endpackage");
  }
  ...
  public void duplicateNamesOk() {
    testAssertOkLines(
        false, "package test", "class A", "	int i", "class B", "	int i", "endpackage");
  }
  ...
  public void duplicateNames() {
    testAssertErrorsLines(
        false,
        "An element with name i already exists",
        "package test",
        "class A",
        "	int i",
        "	int i",
  ...
  public void duplicateNames2() {
    testAssertOkLines(false, "package test", "class A", "	int i", "	function i()", "endpackage");
  }
  ...
  public void staticGenerics3() {
    testAssertOkLines(
        false, "package test", "class C<T>", "	static function foo<T>(T t)", "endpackage");
  }
  ...
  @Test
  public void hotdoc() {
    testAssertOkLines(false, "package test", "/** test */", "function foo()", "endpackage");
  }
  ...
  public void extensionFunc_noreturn() { // see #280
    testAssertErrorsLines(
        false, "missing a body", "package test", "function int.foo() returns int", "endpackage");
  }

  @Test
  public void func_noreturn() { // see #280
    testAssertErrorsLines(
        false, "missing a body", "package test", "function foo() returns int", "endpackage");
  }
  ...
  public void recursiveTuple2() {
    testAssertErrorsLines(
        false, "is recursive", "package test", "tuple foo(bar bar)", "tuple bar(foo foo)");
  }
  ...
  public void testLinePos() { // #462
    ...
    WurstModel model =
        test()
            .executeProg(false)
            .withStdLib(false)
            .withCu(compilationUnit("testLine", input))
            .run()
            .getModel();
  ...
  public void extensionMethodStatic() { // See #614
    testAssertErrorsLines(
        true,
        "Reference to A can only be used for calling static methods, but not for calling extension method method 'bar'.",
        "package Test",
        "native testSuccess()",
        "abstract class A",
  ...
  public void testCyclicDependencyError() {
    testAssertErrorsLines(
        true,
        "For loop target int doesn't provide a iterator() function",
        "package Test",
        "native testSuccess()",
  ...
  public void testClassExtendsClassWithoutNoArgConstructor() {
    testAssertErrorsLines(
        false,
        "The extended class <A> does not expose a no-arg constructor",
        "package Test",
        "class A",
        "    construct(int i)",
        "class B extends A");
  ...
  public void testSelfAssignmentWarning() {
    testAssertErrorsLines(
        false,
        "The assignment to local variable i probably has no effect",
        "package test",
        "@annotation public function annotation()",
        "@annotation public function extern()",
        "@extern native I2S(int x) returns string",
  ...
  public void testSelfAssignmentWarningDot() {
    testAssertErrorsLines(
        false,
        "The assignment to variable i probably has no effect",
        "package test",
        "@annotation public function annotation()",
        "@annotation public function extern()",
        "@extern native I2S(int x) returns string",
  ...
  public void agentTypeComparisonsWurst() {
    testAssertErrorsLinesWithStdLib(
        true,
        "Cannot compare types sound with rect",
        "package Test",
