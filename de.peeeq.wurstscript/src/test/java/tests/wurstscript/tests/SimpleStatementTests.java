...
public class SimpleStatementTests extends WurstScriptTest {
  ...
  public void testMod1() {
    assertOk(true, "if 10. % 2. == 0.", "	testSuccess()\n" + "");
  }

  @Test
  public void testMod2() {
    assertOk(true, "if 2 mod 10 == 2", "	testSuccess()\n" + "");
  }

  @Test
  public void testIf1() {
    assertOk(true, "if 2 == 2 ", "	testSuccess()\n" + "");
  }

  @Test
  public void testIf2() {
    assertOk(true, "if 10 > 5 ", "	testSuccess()\n" + "");
  }

  @Test
  public void testIf3() {
    assertOk(true, "if not 10 > 5 or not 5 > 10 ", "	testSuccess()\n" + "");
  }

  @Test
  public void testIf4() {
    assertOk(true, "if 10 >= 10 ", "	testSuccess()\n" + "");
  }

  @Test
  public void testIf5() {
    assertOk(true, "if -4 <= -4 ", "	testSuccess()\n" + "");
  }

  @Test
  public void testIf6() {
    assertOk(true, "if 3 != 2 ", "	testSuccess()", "");
  }

  @Test
  public void testIf7() {
    assertOk(true, "if (10 == 10 and 5 == 5)", "	testSuccess()", "");
  }

  @Test
  public void testWhile1() {
    assertOk(true, "int x = 10", "while x > 2", "	x = x - 1", "if x == 2", "	testSuccess()", "");
  }
  ...
  public void testFor1() {
    assertOk(
        true, "int x = 0", "for int i = 1 to 10", "	x = x + 1", "if x == 10", "	testSuccess()", "");
  }

  @Test
  public void testFor2() {
    assertOk(
        true, "int x = 0", "for int i = 1 to 10", "	x = x + i", "if x == 55", "	testSuccess()", "");
  }
  ...
  public void test_inc() {
    assertOk(true, "int x = 5", "x++", "if x == 6", "	testSuccess()", "");
  }

  @Test
  public void test_dec() {
    assertOk(true, "int x = 5", "x--", "if x == 4", "	testSuccess()", "");
  }

  @Test
  public void test_pluseq() {
    assertOk(true, "int x = 5", "x += 2", "if x == 7", "	testSuccess()", "");
  }

  @Test
  public void test_multeq() {
    assertOk(true, "int x = 5", "x *= 2", "if x == 10", "	testSuccess()", "");
  }

  @Test
  public void test_diveq() {
    assertOk(true, "real x = 5", "x /= 2", "if x == 2.5", "	testSuccess()", "");
  }

  @Test
  public void test_diveqFail() {
    assertError(
        true, "Cannot assign real", "int x = 5", "x /= 2", "if x == 2", "	testSuccess()", "");
  }

  @Test
  public void test_minuseq() {
    assertOk(true, "int x = 5", "x -= 2", "if x == 3", "	testSuccess()", "");
  }
  ...
  public void test_unitialized2() {
    assertOk(false, "int x", "int y = 2", "if y == 3", "	x = 2", "else", "	x = 4", "x++");
  }

  @Test
  public void test_arrayUpdate() {
    assertOk(false, "int array x", "x[5] = 2", "x[5] += 3");
  }

  @Test
  public void test_forloop() {
    assertOk(true, "int a = 10", "for int i = 1 to a", "	a++", "if a == 20", "	testSuccess()");
  }

  @Test
  public void test_let() {
    assertOk(true, "let a = 11", "let b = a + 9", "if b == 20", "	testSuccess()");
  }

  @Test
  public void test_let2() {
    assertError(true, "Cannot assign", "let a = 11", "a = a + 9", "if a == 20", "	testSuccess()");
  }

  @Test
  public void test_var() {
    assertOk(true, "var a = 11", "var b = a + 9", "if b == 20", "	testSuccess()");
  }

  @Test
  public void test_var_err() {
    assertError(false, "Could not infer the type of variable", "var a", "if true", "	a = 10");
  }

  @Test
  public void test_var2() {
    assertOk(true, "var a = 11", "a = a + 9", "if a == 20", "	testSuccess()");
  }
  ...
  public void test_destroy() {
    testAssertErrorsLines(
        false, "Cannot destroy class", "package test", "class C", "init", "	destroy C");
  }
  ...
  public void test_varAsStmt() {
    testAssertErrorsLines(
        false,
        "Use of variable x is an incomplete statement",
        "package test",
        "init",
        "	var x = 5",
        "	x");
  ...
  public void test_stupid_for_in() {
    testAssertErrorsLines(
        false, "doesn't provide a iterator() function", "package test", "init", "	for i in 42");
  }
  ...
  public void test_stupid_for_from() {
    testAssertErrorsLines(
        false, "doesn't provide a proper next()", "package test", "init", "	for i from 42");
  }
  ...
  public void test_no_hasNext() {
    testAssertErrorsLines(
        false,
        "doesn't provide a hasNext() function that returns boolean",
        "package test",
        "class C",
