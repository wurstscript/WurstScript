...
public class OptimizerTests extends WurstScriptTest {
  ...
  public void test_number_shortening() {
    test().lines("package test", "	function foo() returns int", "		return 800000", "endpackage");
  }
  ...
  public void test_varRemoval() {
    test().lines("package test", "	constant i = 5", "endpackage");
  }
  ...
  public void test_ConstFolding() {
    test().lines("package test", "	init", "		int i = 3 + 7 * 2 * 33", "endpackage");
  }
  ...
  public void test_tempVarRemover() throws IOException {
    ...
    String output =
        Files.toString(
            new File("./test-output/OptimizerTests_test_tempVarRemover_inlopt.j"), Charsets.UTF_8);

    assertTrue(
        !output.contains("blub_a")
            ? (output.contains("blub_b") || output.contains("blub_c"))
            : (!output.contains("blub_b") && !output.contains("blub_c")));
  }
  ...
  public void test_mult2rewrite() throws IOException {
    ...
    String output =
        Files.toString(
            new File("./test-output/OptimizerTests_test_mult2rewrite_inlopt.j"), Charsets.UTF_8);

    assertTrue(
        !output.contains("blub_a") && !(output.contains("blub_b") && !output.contains("blub_c")));
  }
  ...
  public void test_mult3rewrite() throws IOException {
    ...
    String output1 =
        Files.toString(
            new File("./test-output/OptimizerTests_test_mult3rewrite_inlopt.j"), Charsets.UTF_8);
    String output2 =
        Files.toString(
            new File("./test-output/OptimizerTests_test_mult3rewrite_opt.j"), Charsets.UTF_8);
  ...
  public void test_tempVarRemover2() throws IOException {
    ...
    String output =
        Files.toString(
            new File("./test-output/OptimizerTests_test_tempVarRemover2_inlopt.j"), Charsets.UTF_8);
  ...
  public void test_localVarMerger3() throws IOException {
    test()
        .lines(
            ...
            "	foo(3)",
            "	testSuccess()");
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_test_localVarMerger3_opt.j"), Charsets.UTF_8);
  ...
  public void test_unused_func_remover() throws IOException {
    ...
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_test_unused_func_remover_opt.j"), Charsets.UTF_8);
  ...
  public void test_unused_func_remover2() throws IOException {
    ...
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_test_unused_func_remover2_opt.j"), Charsets.UTF_8);
  ...
  public void test_unreachableCodeRemover() throws IOException {
    ...
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_test_unreachableCodeRemover_opt.j"),
            Charsets.UTF_8);
  ...
  public void controlFlowMergeNoSideEffect() throws IOException {
    ...
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_controlFlowMergeNoSideEffect_opt.j"),
            Charsets.UTF_8);
    assertEquals(
        compiledAndOptimized.indexOf("Test_ghs = 0"),
        compiledAndOptimized.lastIndexOf("Test_ghs = 0"));
  }
  ...
  public void controlFlowMergeSideEffect() throws IOException {
    ...
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_controlFlowMergeSideEffect_opt.j"),
            Charsets.UTF_8);
    assertNotSame(
        compiledAndOptimized.indexOf("Test_ghs = 0"),
        compiledAndOptimized.lastIndexOf("Test_ghs = 0"));
  ...
  public void controlFlowMergeSideEffect2() throws IOException {
    ...
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_controlFlowMergeSideEffect2_opt.j"),
            Charsets.UTF_8);
    assertNotSame(
        compiledAndOptimized.indexOf("Test_ghs = 0"),
        compiledAndOptimized.lastIndexOf("Test_ghs = 0"));
  ...
  public void optimizeDuplicateNullSets() throws IOException {
    ...
    String compiledAndOptimized =
        Files.toString(
            new File("test-output/OptimizerTests_optimizeDuplicateNullSets_opt.j"), Charsets.UTF_8);
    assertEquals(
        compiledAndOptimized.indexOf("u = null"), compiledAndOptimized.lastIndexOf("u = null"));
  }
  ...
  public void testInlineAnnotation() throws IOException {
    ...
    String inlined =
        Files.toString(
            new File("test-output/OptimizerTests_testInlineAnnotation_inl.j"), Charsets.UTF_8);
  ...
  public void cyclicFunctionRemover() throws IOException {
    ...
    String compiled =
        Files.toString(
            new File("test-output/OptimizerTests_cyclicFunctionRemover.j"), Charsets.UTF_8);
  ...
  public void copyPropagation() throws IOException {
    ...
    String compiled =
        Files.toString(
            new File("test-output/OptimizerTests_copyPropagation_opt.j"), Charsets.UTF_8);
    System.out.println(compiled);
  ...
  public void copyPropagation2() throws IOException {
    ...
    String compiled =
        Files.toString(
            new File("test-output/OptimizerTests_copyPropagation2_opt.j"), Charsets.UTF_8);
    System.out.println(compiled);
