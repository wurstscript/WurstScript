    ...
    public void testCompiletimeLazyInitializerControlFlowEdges() {
        test().testLua(true).luaOnly(false).executeProg(true).executeProgOnlyAfterTransforms().runCompiletimeFunctions(true)
            .lines("package MagicFunctions",
                   ...
                   "boolean stableGlobalGuard = false",
                   "int stableGlobalCounter = 0",
                   "function initializeStableGlobal() returns int",
                   "    if compiletime or stableGlobalGuard",
                   "        stableGlobalCounter++",
                   "    return stableGlobalCounter",
                   "int stableGlobalObserved = initializeStableGlobal()",
                   "int divergentLocalCounter = 0",
                   "function compiletimeLocalGuard() returns boolean",
                   "    var result = false",
                   "    if compiletime",
                   "        result = true",
                   "    return result",
                   "function initializeDivergentLocal() returns int",
                   "    if compiletimeLocalGuard()",
                   "        divergentLocalCounter++",
                   "    return divergentLocalCounter",
                   "int divergentLocalObserved = initializeDivergentLocal()",
                   "int divergentIntCounter = 0",
                   "function initializeDivergentInt() returns int",
                   "    var result = 0",
                   "    if compiletime",
                   "        result = 1",
                   "    if result == 1",
                   "        divergentIntCounter++",
                   "    return divergentIntCounter",
                   "int divergentIntObserved = initializeDivergentInt()",
                   "int luaTargetCounter = 0",
                   "function initializeLuaTarget() returns int",
                   "    if compiletime or isLua",
                   "        luaTargetCounter++",
                   ...
                   "boolean priorWriteGuard = false",
                   "int priorWriteCounter = 0",
                   "function initializePriorWrite() returns int",
                   "    priorWriteGuard = true",
                   "    if priorWriteGuard",
                   "        priorWriteCounter++",
                   "    return priorWriteCounter",
                   "int priorWriteObserved = initializePriorWrite()",
                   "int array priorArrayGuard = [0]",
                   "int priorArrayCounter = 0",
                   "function initializePriorArrayWrite() returns int",
                   "    priorArrayGuard[0] = 1",
                   "    if priorArrayGuard[0] == 1",
                   "        priorArrayCounter++",
                   "    return priorArrayCounter",
                   "int priorArrayObserved = initializePriorArrayWrite()",
                   "int loopCounter = 0",
                   ...
                   "    let _stableGlobalSnapshot = stableGlobalObserved",
