...
public class FlowAnalysisTests extends WurstScriptTest {
  ...
  public void testReturns4() {
    assertError(false, "missing a return", "function foo(int i) returns int", "	skip");
  }
  ...
  public void destroyDataflowTest() {
    testAssertErrorsLines(
        false,
        "Variable a may have been destroyed already",
        "package test",
        "class A",
        "    function foo()",
        "init ",
  ...
  public void destroyThisDataflowTest() {
    testAssertErrorsLines(
        false,
        "Cannot access 'this' because it might already have been destroyed.",
        "package test",
        "class A",
        "    function foo()",
        "    function bar()",
