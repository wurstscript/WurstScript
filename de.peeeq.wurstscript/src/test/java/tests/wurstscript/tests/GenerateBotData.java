 ...
 *
 * <p>(21:26:01) lep: einmal ne liste von (Type, Type) (21:26:10) lep: also die typhirachie
 * (21:26:18) lep: und dann ne liste von signaturen (21:26:38) lep: Sig Name [Type] Type
 */
    ...
    model.accept(
        new WurstModel.DefaultVisitor() {
          ...
          public void visit(ConstructorDef f) {
            ...
            sigs.add(
                new Sig("new " + f.attrNearestClassOrModule().getName(), paramTypes, returnType));
          }
