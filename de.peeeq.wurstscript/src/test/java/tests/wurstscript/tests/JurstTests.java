...
public class JurstTests extends WurstScriptTest {
  ...
  public void multilineString() {
    testJurst(false, false, Utils.string("package test", "let s = \"12345678", "90\"", ""));
  }
  ...
  public void jassAgentTypeComparison() {
    String jassCode =
        Utils.string(
            "function bar takes sound s, rect r returns boolean", "return s == r", "endfunction\n");
  ...
  public void testBigJassScript() throws IOException {
    ...
    String jurstCode =
        Utils.string("package test", "	init", "		testSuccess()", "	end", "endpackage");
  ...
  public void testJurstWrapping() throws IOException {
    String jassCode =
        Utils.string(
            "function foo takes integer a returns string", "	return \"   ah \"", "endfunction");

    String jurstCode =
        new String(Files.readAllBytes(Paths.get(Utils.getResourceFile("test.jurst"))));

    testJurstWithJass(false, true, jassCode, jurstCode);
  }

  private void testJurstWithJass(
      boolean executeProg, boolean withStdLib, String jass, String jurst) {
