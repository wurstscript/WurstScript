...
public class ModuleTests extends WurstScriptTest {
  ...
  public void arg_constructor() {
    testAssertErrorsLines(
        false,
        "Module constructors must not have parameters",
        "package Test",
        "native testSuccess()",
        "public module A",
        "    int x = 3",
  ...
  public void stupidTest() { // see #656
    testAssertOkLinesWithStdLib(true, "package Test", "init", "    testSuccess()", "endpackage");
  }
  ...
  public void useModuleAsType() { // see #720
    testAssertErrorsLines(
        false,
        "Cannot use module type A in this context.",
        "package Test",
        "module A",
        "    function foo()",
        "class List<T>",
