...
public class ClassesTests extends WurstScriptTest {
  ...
  public void code_members() {
    testAssertErrorsLines(
        false, "code members not allowed", "package test", "	class C", "		code c", "endpackage");
  }
  ...
  public void abstract_must_not_be_private() {
    testAssertErrorsLines(
        true,
        "Abstract functions must not be private",
        "package test",
        "	abstract class A",
  ...
  public void construct_super() {
    testAssertErrorsLines(
        false,
        "Super call in a class which extends nothing",
        "package test",
        "	class C",
        "		construct(int x)",
        "			super()",
  ...
  public void constructor_private() {
    testAssertErrorsLines(
        false,
        "constructor for class A is not visible here",
        "package test",
        "	class A",
  ...
  public void dotdotOperatorFail() {
    testAssertErrorsLines(
        false,
        "cannot be used with the cascade operator",
        "package test",
        "	native testSuccess()",
        "	class A",
  ...
  public void arrayAttributeFail1() {
    testAssertErrorsLines(
        true, "require a fixed size", "package test", "	class A", "		int array s", "endpackage");
  }
  ...
  public void testInnerClass_module_thistype2() {
    testAssertErrorsLines(
        true,
        "Cannot access dynamic variable x",
        "package test",
        "	native testSuccess()",
        "	module M",
        "		thistype x",
  ...
  public void callStaticFunctionFromInit() {
    testAssertErrorsLines(
        true,
        "Cannot call static method f on an object.",
        "package Test",
        "public class A",
        "    static function f()",
        "init",
