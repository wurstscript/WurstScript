...
public class UtilsTest {
  ...
  public void testSubseqLen() {
    ...
    Assert.assertEquals(Utils.list(3, 2), Utils.subsequenceLengthes("KilUn", "KillUnit"));

    Assert.assertEquals(Utils.list(6), Utils.subsequenceLengthes("abc123", "abcfabc123"));

    Assert.assertEquals(Utils.list(3, 1), Utils.subsequenceLengthes("illu", "getkillingunit"));

    Assert.assertEquals(Utils.list(4), Utils.subsequenceLengthes("illu", "isunitillusion"));
  }
