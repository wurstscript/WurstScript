...
public abstract class ExprSwitchVoid {
	...
	abstract public void caseExprBuildinFunction(ExprBuildinFunction exprBuildinFunction);
	...
	abstract public void caseExprAssignment(ExprAssignment exprAssignment);
	...
	public void doSwitch(Expr expr) {
		...
		if (expr instanceof ExprBuildinFunction) { caseExprBuildinFunction((ExprBuildinFunction)expr); return; }
		...
		if (expr instanceof ExprAssignment) { caseExprAssignment((ExprAssignment)expr); return; }
