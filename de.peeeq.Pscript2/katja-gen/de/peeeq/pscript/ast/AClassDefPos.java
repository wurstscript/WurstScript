...
public interface AClassDefPos extends de.peeeq.pscript.ast.ATypeDefPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AClassDef> {

    //----- methods of AClassDefPos -----

    public de.peeeq.pscript.ast.AClassDef termATypeDef();
    public de.peeeq.pscript.ast.AClassDef termAElement();
    public de.peeeq.pscript.ast.AClassDef term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AClassDefPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.StringPos name();
    public de.peeeq.pscript.ast.AClassDefPos replaceName(java.lang.String name);
    public de.peeeq.pscript.ast.AClassMembersPos members();
    public de.peeeq.pscript.ast.AClassDefPos replaceMembers(de.peeeq.pscript.ast.AClassMembers members);
    public de.peeeq.pscript.ast.pscriptAST.TermPos<?> get(int i);
    public int size();
    public de.peeeq.pscript.ast.AClassDefPos replace(de.peeeq.pscript.ast.AClassDef term);
    ...
    //----- nested classes of AClassDefPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AClassDefPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AClassDef> implements de.peeeq.pscript.ast.AClassDefPos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.StringPos _name = null;
        private de.peeeq.pscript.ast.AClassMembersPos _members = null;
        ...
        public de.peeeq.pscript.ast.AClassMembersPos members() {
            if(_members == null)
                _members = de.peeeq.pscript.ast.pscriptAST.AClassMembersPos(this, _term.members(), 2);

            return _members;
        }

        public de.peeeq.pscript.ast.AClassDefPos replaceMembers(de.peeeq.pscript.ast.AClassMembers members) {
            return replace(_term.replaceMembers(members));
        }

        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AClassDef term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.TermPos<?> get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_members == null)
                        _members = pscriptAST.AClassMembersPos(this, _term.members(), 2);
                    
                    return _members;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AClassDefPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AClassDefPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AClassDefPos replace(de.peeeq.pscript.ast.AClassDef term) {
            return (de.peeeq.pscript.ast.AClassDefPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.ATypeDefPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAClassDefPos(this);
        }
