...
public interface AStatementPos extends de.peeeq.pscript.ast.pscriptAST.SortPos {

    //----- methods of AStatementPos -----

    public KatjaSort term();
    public de.peeeq.pscript.ast.AStatement termAStatement();
    public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatementPos.Switch<CT, E> switchClass) throws E;

    //----- nested classes of AStatementPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.pscript.ast.AExprPos.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseABlockPos(de.peeeq.pscript.ast.ABlockPos term) throws E;
        public CT CaseAIfPos(de.peeeq.pscript.ast.AIfPos term) throws E;
        public CT CaseAWhilePos(de.peeeq.pscript.ast.AWhilePos term) throws E;
        public CT CaseAReturnPos(de.peeeq.pscript.ast.AReturnPos term) throws E;
        public CT CaseAVoidReturnPos(de.peeeq.pscript.ast.AVoidReturnPos term) throws E;
        public CT CaseAAssignmentPos(de.peeeq.pscript.ast.AAssignmentPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AStatementPos.VisitorType<E> {
