...
public interface AMinusPos extends de.peeeq.pscript.ast.AInfixOpPos, de.peeeq.pscript.ast.APrefixOpPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AMinus> {

    //----- methods of AMinusPos -----

    public de.peeeq.pscript.ast.AMinus termAInfixOp();
    public de.peeeq.pscript.ast.AMinus termAPrefixOp();
    public de.peeeq.pscript.ast.AMinus term();
    public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.pscript.ast.AMinusPos replace(de.peeeq.pscript.ast.AMinus term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AMinusPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AMinus> implements de.peeeq.pscript.ast.AMinusPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AMinus term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AMinusPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AMinusPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AMinusPos replace(de.peeeq.pscript.ast.AMinus term) {
            return (de.peeeq.pscript.ast.AMinusPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AInfixOpPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAMinusPos(this);
        }
