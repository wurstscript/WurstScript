...
public interface ABlockPos extends de.peeeq.pscript.ast.AStatementPos, de.peeeq.pscript.ast.pscriptAST.ListPos<de.peeeq.pscript.ast.ABlock, de.peeeq.pscript.ast.AStatementPos, de.peeeq.pscript.ast.AStatement> {

    //----- methods of ABlockPos -----

    public de.peeeq.pscript.ast.ABlock termAStatement();
    public de.peeeq.pscript.ast.ABlock term();
    public de.peeeq.pscript.ast.ABlockPos add(de.peeeq.pscript.ast.AStatement element);
    public de.peeeq.pscript.ast.ABlockPos addAll(KatjaList<? extends de.peeeq.pscript.ast.AStatement> list);
    public de.peeeq.pscript.ast.ABlockPos remove(de.peeeq.pscript.ast.AStatement element);
    public de.peeeq.pscript.ast.ABlockPos removeAll(KatjaList<? extends de.peeeq.pscript.ast.AStatement> list);
    public de.peeeq.pscript.ast.ABlockPos appBack(de.peeeq.pscript.ast.AStatement element);
    public de.peeeq.pscript.ast.ABlockPos appFront(de.peeeq.pscript.ast.AStatement element);
    public de.peeeq.pscript.ast.ABlockPos conc(KatjaList<? extends de.peeeq.pscript.ast.AStatement> list);
    public de.peeeq.pscript.ast.ABlockPos reverse();
    public de.peeeq.pscript.ast.ABlockPos toSet();
    public de.peeeq.pscript.ast.ABlockPos setAdd(de.peeeq.pscript.ast.AStatement element);
    public de.peeeq.pscript.ast.ABlockPos setRemove(de.peeeq.pscript.ast.AStatement element);
    public de.peeeq.pscript.ast.ABlockPos setUnion(KatjaList<? extends de.peeeq.pscript.ast.AStatement> list);
    public de.peeeq.pscript.ast.ABlockPos setWithout(KatjaList<? extends de.peeeq.pscript.ast.AStatement> list);
    public de.peeeq.pscript.ast.ABlockPos setIntersection(KatjaList<? extends de.peeeq.pscript.ast.AStatement> list);
    public KatjaList<de.peeeq.pscript.ast.AStatementPos> toList();
    public de.peeeq.pscript.ast.ABlockPos replace(de.peeeq.pscript.ast.ABlock term);
    ...
    //----- nested classes of ABlockPos -----

    static class ListImpl extends KatjaListImpl<de.peeeq.pscript.ast.AStatementPos> implements KatjaList<de.peeeq.pscript.ast.AStatementPos> {

        //----- methods of ListImpl -----

        ListImpl(de.peeeq.pscript.ast.AStatementPos... elements) {
            super(elements);

            for(de.peeeq.pscript.ast.AStatementPos element : elements)
                if(element == null)
                    throw new IllegalArgumentException("constructor of katja list for position sort AStatementPos invoked with null element");
        }

        private ListImpl() {
        }

        protected KatjaList<de.peeeq.pscript.ast.AStatementPos> createInstance(de.peeeq.pscript.ast.AStatementPos[] elements, boolean isSet) {
            for(de.peeeq.pscript.ast.AStatementPos element : elements)
                if(element == null)
                    throw new IllegalArgumentException("constructor of katja list for position sort AStatementPos invoked with null element");
        ...
        protected de.peeeq.pscript.ast.AStatementPos[] createArray(int size) {
            return new de.peeeq.pscript.ast.AStatementPos[size];
        }
        ...
        public Appendable toString(Appendable builder) throws IOException {
            ...
            for(de.peeeq.pscript.ast.AStatementPos element : values) {
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.ABlockPos.VisitorType<E> {
    ...
    static class Impl extends KatjaListPosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.ABlock, de.peeeq.pscript.ast.AStatementPos, de.peeeq.pscript.ast.AStatement> implements de.peeeq.pscript.ast.ABlockPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.ABlock term, int pos) {
            super(parent, term, pos);
        }

        protected de.peeeq.pscript.ast.AStatementPos getElementInstance(int pos) {
            return de.peeeq.pscript.ast.pscriptAST.AStatementPos(this, _term.get(pos), pos);
        }
        ...
        public KatjaList<de.peeeq.pscript.ast.AStatementPos> toList() {
            ...
            return new ABlockPos.ListImpl(values);
        }

        public de.peeeq.pscript.ast.ABlockPos replace(de.peeeq.pscript.ast.ABlock term) {
            return (de.peeeq.pscript.ast.ABlockPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseABlockPos(this);
        }
