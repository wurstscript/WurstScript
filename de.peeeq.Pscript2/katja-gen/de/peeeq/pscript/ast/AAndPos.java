...
public interface AAndPos extends de.peeeq.pscript.ast.AInfixOpPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AAnd> {

    //----- methods of AAndPos -----

    public de.peeeq.pscript.ast.AAnd termAInfixOp();
    public de.peeeq.pscript.ast.AAnd term();
    public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.pscript.ast.AAndPos replace(de.peeeq.pscript.ast.AAnd term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AAndPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AAnd> implements de.peeeq.pscript.ast.AAndPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AAnd term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AAndPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AAndPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AAndPos replace(de.peeeq.pscript.ast.AAnd term) {
            return (de.peeeq.pscript.ast.AAndPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AInfixOpPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAAndPos(this);
        }
