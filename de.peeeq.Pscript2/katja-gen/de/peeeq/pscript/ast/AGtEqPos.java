...
public interface AGtEqPos extends de.peeeq.pscript.ast.AInfixOpPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AGtEq> {

    //----- methods of AGtEqPos -----

    public de.peeeq.pscript.ast.AGtEq termAInfixOp();
    public de.peeeq.pscript.ast.AGtEq term();
    public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.pscript.ast.AGtEqPos replace(de.peeeq.pscript.ast.AGtEq term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AGtEqPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AGtEq> implements de.peeeq.pscript.ast.AGtEqPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AGtEq term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AGtEqPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AGtEqPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AGtEqPos replace(de.peeeq.pscript.ast.AGtEq term) {
            return (de.peeeq.pscript.ast.AGtEqPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AInfixOpPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAGtEqPos(this);
        }
