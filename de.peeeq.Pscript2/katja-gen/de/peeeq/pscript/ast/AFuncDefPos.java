...
public interface AFuncDefPos extends de.peeeq.pscript.ast.AClassMemberPos, de.peeeq.pscript.ast.AElementPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AFuncDef> {

    //----- methods of AFuncDefPos -----

    public de.peeeq.pscript.ast.AFuncDef termAClassMember();
    public de.peeeq.pscript.ast.AFuncDef termAElement();
    public de.peeeq.pscript.ast.AFuncDef term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AFuncDefPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.StringPos name();
    public de.peeeq.pscript.ast.AFuncDefPos replaceName(java.lang.String name);
    public de.peeeq.pscript.ast.AReturnTypePos retType();
    public de.peeeq.pscript.ast.AFuncDefPos replaceRetType(de.peeeq.pscript.ast.AReturnType retType);
    public de.peeeq.pscript.ast.AFormalParametersPos params();
    public de.peeeq.pscript.ast.AFuncDefPos replaceParams(de.peeeq.pscript.ast.AFormalParameters params);
    public de.peeeq.pscript.ast.ABlockPos body();
    public de.peeeq.pscript.ast.AFuncDefPos replaceBody(de.peeeq.pscript.ast.ABlock body);
    public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i);
    public int size();
    public de.peeeq.pscript.ast.AFuncDefPos replace(de.peeeq.pscript.ast.AFuncDef term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AFuncDefPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AFuncDef> implements de.peeeq.pscript.ast.AFuncDefPos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.StringPos _name = null;
        private de.peeeq.pscript.ast.AReturnTypePos _retType = null;
        private de.peeeq.pscript.ast.AFormalParametersPos _params = null;
        ...
        public de.peeeq.pscript.ast.AReturnTypePos retType() {
            if(_retType == null)
                _retType = de.peeeq.pscript.ast.pscriptAST.AReturnTypePos(this, _term.retType(), 2);

            return _retType;
        }

        public de.peeeq.pscript.ast.AFuncDefPos replaceRetType(de.peeeq.pscript.ast.AReturnType retType) {
            return replace(_term.replaceRetType(retType));
        }

        public de.peeeq.pscript.ast.AFormalParametersPos params() {
            if(_params == null)
                _params = de.peeeq.pscript.ast.pscriptAST.AFormalParametersPos(this, _term.params(), 3);

            return _params;
        }

        public de.peeeq.pscript.ast.AFuncDefPos replaceParams(de.peeeq.pscript.ast.AFormalParameters params) {
            return replace(_term.replaceParams(params));
        }

        public de.peeeq.pscript.ast.ABlockPos body() {
            if(_body == null)
                _body = de.peeeq.pscript.ast.pscriptAST.ABlockPos(this, _term.body(), 4);
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AFuncDef term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_retType == null)
                        _retType = pscriptAST.AReturnTypePos(this, _term.retType(), 2);
                    
                    return _retType;
                case 3:
                    if(_params == null)
                        _params = pscriptAST.AFormalParametersPos(this, _term.params(), 3);
                    
                    return _params;
                case 4:
                    if(_body == null)
                        _body = pscriptAST.ABlockPos(this, _term.body(), 4);
                    
                    return _body;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AFuncDefPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AFuncDefPos invoked with too large parameter "+i+", sort has only 5 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AFuncDefPos replace(de.peeeq.pscript.ast.AFuncDef term) {
            return (de.peeeq.pscript.ast.AFuncDefPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AClassMemberPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAFuncDefPos(this);
        }
