...
public interface AAssignmentPos extends de.peeeq.pscript.ast.AStatementPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AAssignment> {

    //----- methods of AAssignmentPos -----

    public de.peeeq.pscript.ast.AAssignment termAStatement();
    public de.peeeq.pscript.ast.AAssignment term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AAssignmentPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.AExprPos left();
    public de.peeeq.pscript.ast.AAssignmentPos replaceLeft(de.peeeq.pscript.ast.AExpr left);
    public de.peeeq.pscript.ast.AExprPos right();
    public de.peeeq.pscript.ast.AAssignmentPos replaceRight(de.peeeq.pscript.ast.AExpr right);
    public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i);
    public int size();
    public de.peeeq.pscript.ast.AAssignmentPos replace(de.peeeq.pscript.ast.AAssignment term);
    ...
    //----- nested classes of AAssignmentPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AAssignmentPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AAssignment> implements de.peeeq.pscript.ast.AAssignmentPos {
        ...
        public de.peeeq.pscript.ast.AExprPos right() {
            if(_right == null)
                _right = de.peeeq.pscript.ast.pscriptAST.AExprPos(this, _term.right(), 2);
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AAssignment term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_right == null)
                        _right = pscriptAST.AExprPos(this, _term.right(), 2);
                    
                    return _right;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AAssignmentPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AAssignmentPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AAssignmentPos replace(de.peeeq.pscript.ast.AAssignment term) {
            return (de.peeeq.pscript.ast.AAssignmentPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAAssignmentPos(this);
        }
