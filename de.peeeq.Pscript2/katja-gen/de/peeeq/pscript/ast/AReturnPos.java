...
public interface AReturnPos extends de.peeeq.pscript.ast.AStatementPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AReturn> {

    //----- methods of AReturnPos -----

    public de.peeeq.pscript.ast.AReturn termAStatement();
    public de.peeeq.pscript.ast.AReturn term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AReturnPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.AExprPos retValue();
    public de.peeeq.pscript.ast.AReturnPos replaceRetValue(de.peeeq.pscript.ast.AExpr retValue);
    public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i);
    public int size();
    public de.peeeq.pscript.ast.AReturnPos replace(de.peeeq.pscript.ast.AReturn term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AReturnPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AReturn> implements de.peeeq.pscript.ast.AReturnPos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.AExprPos _retValue = null;
        ...
        public de.peeeq.pscript.ast.AExprPos retValue() {
            if(_retValue == null)
                _retValue = de.peeeq.pscript.ast.pscriptAST.AExprPos(this, _term.retValue(), 1);

            return _retValue;
        }

        public de.peeeq.pscript.ast.AReturnPos replaceRetValue(de.peeeq.pscript.ast.AExpr retValue) {
            return replace(_term.replaceRetValue(retValue));
        }

        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AReturn term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_retValue == null)
                        _retValue = pscriptAST.AExprPos(this, _term.retValue(), 1);
                    
                    return _retValue;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AReturnPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AReturnPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AReturnPos replace(de.peeeq.pscript.ast.AReturn term) {
            return (de.peeeq.pscript.ast.AReturnPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAReturnPos(this);
        }
