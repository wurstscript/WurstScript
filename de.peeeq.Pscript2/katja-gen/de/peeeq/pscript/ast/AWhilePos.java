...
public interface AWhilePos extends de.peeeq.pscript.ast.AStatementPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AWhile> {

    //----- methods of AWhilePos -----

    public de.peeeq.pscript.ast.AWhile termAStatement();
    public de.peeeq.pscript.ast.AWhile term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AWhilePos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.AExprPos cond();
    public de.peeeq.pscript.ast.AWhilePos replaceCond(de.peeeq.pscript.ast.AExpr cond);
    public de.peeeq.pscript.ast.AStatementPos body();
    public de.peeeq.pscript.ast.AWhilePos replaceBody(de.peeeq.pscript.ast.AStatement body);
    public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i);
    public int size();
    public de.peeeq.pscript.ast.AWhilePos replace(de.peeeq.pscript.ast.AWhile term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AWhilePos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AWhile> implements de.peeeq.pscript.ast.AWhilePos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.AExprPos _cond = null;
        private de.peeeq.pscript.ast.AStatementPos _body = null;
        ...
        public de.peeeq.pscript.ast.AStatementPos body() {
            if(_body == null)
                _body = de.peeeq.pscript.ast.pscriptAST.AStatementPos(this, _term.body(), 2);
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AWhile term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_body == null)
                        _body = pscriptAST.AStatementPos(this, _term.body(), 2);
                    
                    return _body;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AWhilePos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AWhilePos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AWhilePos replace(de.peeeq.pscript.ast.AWhile term) {
            return (de.peeeq.pscript.ast.AWhilePos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatementPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAWhilePos(this);
        }
