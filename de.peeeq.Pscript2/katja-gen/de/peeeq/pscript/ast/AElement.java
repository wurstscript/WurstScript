...
public interface AElement extends KatjaSort {
    ...
    //----- nested classes of AElement -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.pscript.ast.ATypeDef.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseAFuncDef(de.peeeq.pscript.ast.AFuncDef term) throws E;
        public CT CaseAVarDef(de.peeeq.pscript.ast.AVarDef term) throws E;
        public CT CaseAInitBlock(de.peeeq.pscript.ast.AInitBlock term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AElement.VisitorType<E> {
