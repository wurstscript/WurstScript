...
public interface ABuildinCallPos extends de.peeeq.pscript.ast.AExprPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.ABuildinCall> {

    //----- methods of ABuildinCallPos -----

    public de.peeeq.pscript.ast.ABuildinCall termAExpr();
    public de.peeeq.pscript.ast.ABuildinCall termAStatement();
    public de.peeeq.pscript.ast.ABuildinCall term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.ABuildinCallPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.StringPos name();
    public de.peeeq.pscript.ast.ABuildinCallPos replaceName(java.lang.String name);
    public de.peeeq.pscript.ast.AArgumentsPos args();
    public de.peeeq.pscript.ast.ABuildinCallPos replaceArgs(de.peeeq.pscript.ast.AArguments args);
    public de.peeeq.pscript.ast.pscriptAST.TermPos<?> get(int i);
    public int size();
    public de.peeeq.pscript.ast.ABuildinCallPos replace(de.peeeq.pscript.ast.ABuildinCall term);
    ...
    //----- nested classes of ABuildinCallPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.ABuildinCallPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.ABuildinCall> implements de.peeeq.pscript.ast.ABuildinCallPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.ABuildinCall term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.TermPos<?> get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ABuildinCallPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ABuildinCallPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.ABuildinCallPos replace(de.peeeq.pscript.ast.ABuildinCall term) {
            return (de.peeeq.pscript.ast.ABuildinCallPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AExprPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseABuildinCallPos(this);
        }
