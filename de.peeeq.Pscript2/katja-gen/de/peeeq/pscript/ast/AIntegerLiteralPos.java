...
public interface AIntegerLiteralPos extends de.peeeq.pscript.ast.ALiteralPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AIntegerLiteral> {

    //----- methods of AIntegerLiteralPos -----

    public de.peeeq.pscript.ast.AIntegerLiteral termALiteral();
    public de.peeeq.pscript.ast.AIntegerLiteral termAExpr();
    public de.peeeq.pscript.ast.AIntegerLiteral termAStatement();
    public de.peeeq.pscript.ast.AIntegerLiteral term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AIntegerLiteralPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.IntegerPos value();
    public de.peeeq.pscript.ast.AIntegerLiteralPos replaceValue(java.lang.Integer value);
    public de.peeeq.pscript.ast.pscriptAST.LeafPos<?> get(int i);
    public int size();
    public de.peeeq.pscript.ast.AIntegerLiteralPos replace(de.peeeq.pscript.ast.AIntegerLiteral term);
    ...
    //----- nested classes of AIntegerLiteralPos -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AIntegerLiteralPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AIntegerLiteral> implements de.peeeq.pscript.ast.AIntegerLiteralPos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.IntegerPos _value = null;
        ...
        public de.peeeq.pscript.ast.IntegerPos value() {
            if(_value == null)
                _value = de.peeeq.pscript.ast.pscriptAST.IntegerPos(this, _term.value(), 1);
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AIntegerLiteral term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.LeafPos<?> get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_value == null)
                        _value = pscriptAST.IntegerPos(this, _term.value(), 1);
                    
                    return _value;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AIntegerLiteralPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AIntegerLiteralPos invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AIntegerLiteralPos replace(de.peeeq.pscript.ast.AIntegerLiteral term) {
            return (de.peeeq.pscript.ast.AIntegerLiteralPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.ALiteralPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAIntegerLiteralPos(this);
        }
