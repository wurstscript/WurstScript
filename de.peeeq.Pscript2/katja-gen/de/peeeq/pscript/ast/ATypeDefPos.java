...
public interface ATypeDefPos extends de.peeeq.pscript.ast.AElementPos, de.peeeq.pscript.ast.pscriptAST.SortPos {

    //----- methods of ATypeDefPos -----

    public de.peeeq.pscript.ast.ATypeDef termAElement();
    public KatjaSort term();
    public de.peeeq.pscript.ast.ATypeDef termATypeDef();
    ...
    //----- nested classes of ATypeDefPos -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseANativeTypePos(de.peeeq.pscript.ast.ANativeTypePos term) throws E;
        public CT CaseAClassDefPos(de.peeeq.pscript.ast.AClassDefPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.ATypeDefPos.VisitorType<E> {
        ...
        private final de.peeeq.pscript.ast.ATypeDefPos.Switch<Object, E> variantVisit$ATypeDefPos = new de.peeeq.pscript.ast.ATypeDefPos.Switch<Object, E>() { public final Object CaseANativeTypePos(de.peeeq.pscript.ast.ANativeTypePos term) throws E { visit(term); return null; } public final Object CaseAClassDefPos(de.peeeq.pscript.ast.AClassDefPos term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.pscript.ast.ATypeDefPos term) throws E {
            term.Switch(variantVisit$ATypeDefPos);
        }
