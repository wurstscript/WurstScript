...
public interface IntegerPos extends de.peeeq.pscript.ast.pscriptAST.LeafPos<java.lang.Integer> {

    //----- methods of IntegerPos -----

    public java.lang.Integer term();
    public de.peeeq.pscript.ast.AIntegerLiteralPos parent();
    ...
    static class Impl extends KatjaLeafPosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, java.lang.Integer> implements de.peeeq.pscript.ast.IntegerPos {

        //----- methods of Impl -----

        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, java.lang.Integer term, int pos) {
        ...
        public de.peeeq.pscript.ast.AIntegerLiteralPos parent() {
            return (de.peeeq.pscript.ast.AIntegerLiteralPos) super.parent();
        }
