...
public interface ADivIntPos extends de.peeeq.pscript.ast.AInfixOpPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.ADivInt> {

    //----- methods of ADivIntPos -----

    public de.peeeq.pscript.ast.ADivInt termAInfixOp();
    public de.peeeq.pscript.ast.ADivInt term();
    public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.pscript.ast.ADivIntPos replace(de.peeeq.pscript.ast.ADivInt term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.ADivIntPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.ADivInt> implements de.peeeq.pscript.ast.ADivIntPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.ADivInt term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ADivIntPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ADivIntPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.ADivIntPos replace(de.peeeq.pscript.ast.ADivInt term) {
            return (de.peeeq.pscript.ast.ADivIntPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AInfixOpPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseADivIntPos(this);
        }
