...
public interface AInitBlock extends de.peeeq.pscript.ast.AElement, KatjaTuple {

    //----- methods of AInitBlock -----

    public org.eclipse.emf.ecore.EObject source();
    public de.peeeq.pscript.ast.AInitBlock replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.ABlock body();
    public de.peeeq.pscript.ast.AInitBlock replaceBody(de.peeeq.pscript.ast.ABlock body);
    public Object get(int i);
    public int size();
    public de.peeeq.pscript.ast.AInitBlock replace(int pos, Object term);
    public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AElement.Switch<CT, E> switchClass) throws E;

    //----- nested classes of AInitBlock -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AInitBlock.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.pscript.ast.AInitBlock {
        ...
        Impl(org.eclipse.emf.ecore.EObject source, de.peeeq.pscript.ast.ABlock body) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort AInitBlock invoked with null parameter source");
            if(body == null)
                throw new IllegalArgumentException("constructor of sort AInitBlock invoked with null parameter body");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AInitBlock invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AInitBlock invoked with too large parameter "+i+", sort has only 2 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AInitBlock replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort AInitBlock invoked with negative parameter "+pos);
            if(pos >= 2)
                throw new IllegalArgumentException("replace on sort AInitBlock invoked with too large parameter "+pos+", sort has only 2 components");

            if(pos == 0 && !(term instanceof org.eclipse.emf.ecore.EObject))
                throw new IllegalArgumentException("replace on sort AInitBlock invoked with term of incorrect sort, EObject expected");
            if(pos == 1 && !(term instanceof de.peeeq.pscript.ast.ABlock))
                throw new IllegalArgumentException("replace on sort AInitBlock invoked with term of incorrect sort, ABlock expected");

            return (de.peeeq.pscript.ast.AInitBlock) pscriptAST.unique(new de.peeeq.pscript.ast.AInitBlock.Impl(
                pos == 0 ? (org.eclipse.emf.ecore.EObject) term : _source,
                pos == 1 ? (de.peeeq.pscript.ast.ABlock) term : _body
            ));
        }

        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AElement.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAInitBlock(this);
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("pscriptAST.AInitBlock");
            builder.append("( ");
