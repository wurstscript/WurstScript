...
public interface AWhile extends de.peeeq.pscript.ast.AStatement, KatjaTuple {

    //----- methods of AWhile -----

    public org.eclipse.emf.ecore.EObject source();
    public de.peeeq.pscript.ast.AWhile replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.AExpr cond();
    public de.peeeq.pscript.ast.AWhile replaceCond(de.peeeq.pscript.ast.AExpr cond);
    public de.peeeq.pscript.ast.AStatement body();
    public de.peeeq.pscript.ast.AWhile replaceBody(de.peeeq.pscript.ast.AStatement body);
    public Object get(int i);
    public int size();
    public de.peeeq.pscript.ast.AWhile replace(int pos, Object term);
    public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatement.Switch<CT, E> switchClass) throws E;

    //----- nested classes of AWhile -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AWhile.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.pscript.ast.AWhile {

        //----- attributes of Impl -----

        private org.eclipse.emf.ecore.EObject _source = null;
        private de.peeeq.pscript.ast.AExpr _cond = null;
        private de.peeeq.pscript.ast.AStatement _body = null;
        ...
        Impl(org.eclipse.emf.ecore.EObject source, de.peeeq.pscript.ast.AExpr cond, de.peeeq.pscript.ast.AStatement body) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort AWhile invoked with null parameter source");
            if(cond == null)
                throw new IllegalArgumentException("constructor of sort AWhile invoked with null parameter cond");
            if(body == null)
                throw new IllegalArgumentException("constructor of sort AWhile invoked with null parameter body");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AWhile invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AWhile invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AWhile replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort AWhile invoked with negative parameter "+pos);
            if(pos >= 3)
                throw new IllegalArgumentException("replace on sort AWhile invoked with too large parameter "+pos+", sort has only 3 components");

            if(pos == 0 && !(term instanceof org.eclipse.emf.ecore.EObject))
                throw new IllegalArgumentException("replace on sort AWhile invoked with term of incorrect sort, EObject expected");
            if(pos == 1 && !(term instanceof de.peeeq.pscript.ast.AExpr))
                throw new IllegalArgumentException("replace on sort AWhile invoked with term of incorrect sort, AExpr expected");
            if(pos == 2 && !(term instanceof de.peeeq.pscript.ast.AStatement))
                throw new IllegalArgumentException("replace on sort AWhile invoked with term of incorrect sort, AStatement expected");

            return (de.peeeq.pscript.ast.AWhile) pscriptAST.unique(new de.peeeq.pscript.ast.AWhile.Impl(
                pos == 0 ? (org.eclipse.emf.ecore.EObject) term : _source,
                pos == 1 ? (de.peeeq.pscript.ast.AExpr) term : _cond,
                pos == 2 ? (de.peeeq.pscript.ast.AStatement) term : _body
            ));
        }

        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatement.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAWhile(this);
        }

        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("pscriptAST.AWhile");
            builder.append("( ");
