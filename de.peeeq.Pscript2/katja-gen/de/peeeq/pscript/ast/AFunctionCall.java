...
public interface AFunctionCall extends de.peeeq.pscript.ast.AExpr, KatjaTuple {

    //----- methods of AFunctionCall -----

    public org.eclipse.emf.ecore.EObject source();
    public de.peeeq.pscript.ast.AFunctionCall replaceSource(org.eclipse.emf.ecore.EObject source);
    public java.lang.String name();
    public de.peeeq.pscript.ast.AFunctionCall replaceName(java.lang.String name);
    public de.peeeq.pscript.ast.AArguments args();
    public de.peeeq.pscript.ast.AFunctionCall replaceArgs(de.peeeq.pscript.ast.AArguments args);
    public Object get(int i);
    public int size();
    public de.peeeq.pscript.ast.AFunctionCall replace(int pos, Object term);
    ...
    //----- nested classes of AFunctionCall -----
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AFunctionCall.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.pscript.ast.AFunctionCall {
        ...
        Impl(org.eclipse.emf.ecore.EObject source, java.lang.String name, de.peeeq.pscript.ast.AArguments args) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort AFunctionCall invoked with null parameter source");
            if(name == null)
                throw new IllegalArgumentException("constructor of sort AFunctionCall invoked with null parameter name");
            if(args == null)
                throw new IllegalArgumentException("constructor of sort AFunctionCall invoked with null parameter args");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AFunctionCall invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AFunctionCall invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AFunctionCall replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort AFunctionCall invoked with negative parameter "+pos);
            if(pos >= 3)
                throw new IllegalArgumentException("replace on sort AFunctionCall invoked with too large parameter "+pos+", sort has only 3 components");

            if(pos == 0 && !(term instanceof org.eclipse.emf.ecore.EObject))
                throw new IllegalArgumentException("replace on sort AFunctionCall invoked with term of incorrect sort, EObject expected");
            if(pos == 1 && !(term instanceof java.lang.String))
                throw new IllegalArgumentException("replace on sort AFunctionCall invoked with term of incorrect sort, String expected");
            if(pos == 2 && !(term instanceof de.peeeq.pscript.ast.AArguments))
                throw new IllegalArgumentException("replace on sort AFunctionCall invoked with term of incorrect sort, AArguments expected");

            return (de.peeeq.pscript.ast.AFunctionCall) pscriptAST.unique(new de.peeeq.pscript.ast.AFunctionCall.Impl(
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AExpr.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAFunctionCall(this);
        }
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("pscriptAST.AFunctionCall");
            builder.append("( ");
