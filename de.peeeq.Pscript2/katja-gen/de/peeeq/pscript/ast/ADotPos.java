...
public interface ADotPos extends de.peeeq.pscript.ast.AInfixOpPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.ADot> {

    //----- methods of ADotPos -----

    public de.peeeq.pscript.ast.ADot termAInfixOp();
    public de.peeeq.pscript.ast.ADot term();
    public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.pscript.ast.ADotPos replace(de.peeeq.pscript.ast.ADot term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.ADotPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.ADot> implements de.peeeq.pscript.ast.ADotPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.ADot term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ADotPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ADotPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.ADotPos replace(de.peeeq.pscript.ast.ADot term) {
            return (de.peeeq.pscript.ast.ADotPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AInfixOpPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseADotPos(this);
        }
