...
public interface ALtPos extends de.peeeq.pscript.ast.AInfixOpPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.ALt> {

    //----- methods of ALtPos -----

    public de.peeeq.pscript.ast.ALt termAInfixOp();
    public de.peeeq.pscript.ast.ALt term();
    public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i);
    public int size();
    public de.peeeq.pscript.ast.ALtPos replace(de.peeeq.pscript.ast.ALt term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.ALtPos.VisitorType<E> {
    }

    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.ALt> implements de.peeeq.pscript.ast.ALtPos {
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.ALt term, int pos) {
        ...
        public KatjaSortPos<de.peeeq.pscript.ast.ACompilationUnitPos> get(int i) {
            ...
            switch(ith) {
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort ALtPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort ALtPos invoked with too large parameter "+i+", sort has only 0 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.ALtPos replace(de.peeeq.pscript.ast.ALt term) {
            return (de.peeeq.pscript.ast.ALtPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AInfixOpPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseALtPos(this);
        }
