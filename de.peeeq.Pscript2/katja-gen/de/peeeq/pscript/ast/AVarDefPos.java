...
public interface AVarDefPos extends de.peeeq.pscript.ast.AClassMemberPos, de.peeeq.pscript.ast.AElementPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AVarDef> {

    //----- methods of AVarDefPos -----

    public de.peeeq.pscript.ast.AVarDef termAClassMember();
    public de.peeeq.pscript.ast.AVarDef termAElement();
    public de.peeeq.pscript.ast.AVarDef term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AVarDefPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.StringPos name();
    public de.peeeq.pscript.ast.AVarDefPos replaceName(java.lang.String name);
    public de.peeeq.pscript.ast.ATypeExprPos typeExpr();
    public de.peeeq.pscript.ast.AVarDefPos replaceTypeExpr(de.peeeq.pscript.ast.ATypeExpr typeExpr);
    public de.peeeq.pscript.ast.BooleanPos constant();
    public de.peeeq.pscript.ast.AVarDefPos replaceConstant(java.lang.Boolean constant);
    public de.peeeq.pscript.ast.AExprPos initial();
    public de.peeeq.pscript.ast.AVarDefPos replaceInitial(de.peeeq.pscript.ast.AExpr initial);
    public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i);
    public int size();
    public de.peeeq.pscript.ast.AVarDefPos replace(de.peeeq.pscript.ast.AVarDef term);
    public de.peeeq.pscript.ast.pscriptAST.ListPos<?, ?, ?> parent();
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AVarDefPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AVarDef> implements de.peeeq.pscript.ast.AVarDefPos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.StringPos _name = null;
        private de.peeeq.pscript.ast.ATypeExprPos _typeExpr = null;
        private de.peeeq.pscript.ast.BooleanPos _constant = null;
        private de.peeeq.pscript.ast.AExprPos _initial = null;
        ...
        public de.peeeq.pscript.ast.ATypeExprPos typeExpr() {
            if(_typeExpr == null)
                _typeExpr = de.peeeq.pscript.ast.pscriptAST.ATypeExprPos(this, _term.typeExpr(), 2);

            return _typeExpr;
        }

        public de.peeeq.pscript.ast.AVarDefPos replaceTypeExpr(de.peeeq.pscript.ast.ATypeExpr typeExpr) {
            return replace(_term.replaceTypeExpr(typeExpr));
        }

        public de.peeeq.pscript.ast.BooleanPos constant() {
            if(_constant == null)
                _constant = de.peeeq.pscript.ast.pscriptAST.BooleanPos(this, _term.constant(), 3);

            return _constant;
        }

        public de.peeeq.pscript.ast.AVarDefPos replaceConstant(java.lang.Boolean constant) {
            return replace(_term.replaceConstant(constant));
        }

        public de.peeeq.pscript.ast.AExprPos initial() {
            if(_initial == null)
                _initial = de.peeeq.pscript.ast.pscriptAST.AExprPos(this, _term.initial(), 4);

            return _initial;
        }

        public de.peeeq.pscript.ast.AVarDefPos replaceInitial(de.peeeq.pscript.ast.AExpr initial) {
            return replace(_term.replaceInitial(initial));
        }

        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AVarDef term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 2:
                    if(_typeExpr == null)
                        _typeExpr = pscriptAST.ATypeExprPos(this, _term.typeExpr(), 2);
                    
                    return _typeExpr;
                case 3:
                    if(_constant == null)
                        _constant = pscriptAST.BooleanPos(this, _term.constant(), 3);
                    
                    return _constant;
                case 4:
                    if(_initial == null)
                        _initial = pscriptAST.AExprPos(this, _term.initial(), 4);
                    
                    return _initial;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AVarDefPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AVarDefPos invoked with too large parameter "+i+", sort has only 5 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AVarDefPos replace(de.peeeq.pscript.ast.AVarDef term) {
            return (de.peeeq.pscript.ast.AVarDefPos) super.replace(term);
        }
        ...
        public de.peeeq.pscript.ast.pscriptAST.ListPos<?, ?, ?> parent() {
            return (de.peeeq.pscript.ast.pscriptAST.ListPos<?, ?, ?>) super.parent();
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AClassMemberPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAVarDefPos(this);
        }
