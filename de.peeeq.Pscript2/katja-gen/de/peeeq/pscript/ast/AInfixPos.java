...
public interface AInfixPos extends de.peeeq.pscript.ast.AExprPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.AInfix> {

    //----- methods of AInfixPos -----

    public de.peeeq.pscript.ast.AInfix termAExpr();
    public de.peeeq.pscript.ast.AInfix termAStatement();
    public de.peeeq.pscript.ast.AInfix term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.AInfixPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.AExprPos left();
    public de.peeeq.pscript.ast.AInfixPos replaceLeft(de.peeeq.pscript.ast.AExpr left);
    public de.peeeq.pscript.ast.AInfixOpPos op();
    public de.peeeq.pscript.ast.AInfixPos replaceOp(de.peeeq.pscript.ast.AInfixOp op);
    public de.peeeq.pscript.ast.AExprPos right();
    public de.peeeq.pscript.ast.AInfixPos replaceRight(de.peeeq.pscript.ast.AExpr right);
    public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i);
    public int size();
    public de.peeeq.pscript.ast.AInfixPos replace(de.peeeq.pscript.ast.AInfix term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AInfixPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.AInfix> implements de.peeeq.pscript.ast.AInfixPos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.AExprPos _left = null;
        private de.peeeq.pscript.ast.AInfixOpPos _op = null;
        private de.peeeq.pscript.ast.AExprPos _right = null;
        ...
        public de.peeeq.pscript.ast.AExprPos left() {
            if(_left == null)
                _left = de.peeeq.pscript.ast.pscriptAST.AExprPos(this, _term.left(), 1);
        ...
        public de.peeeq.pscript.ast.AInfixOpPos op() {
            if(_op == null)
                _op = de.peeeq.pscript.ast.pscriptAST.AInfixOpPos(this, _term.op(), 2);
        ...
        public de.peeeq.pscript.ast.AExprPos right() {
            if(_right == null)
                _right = de.peeeq.pscript.ast.pscriptAST.AExprPos(this, _term.right(), 3);
        ...
        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.AInfix term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_left == null)
                        _left = pscriptAST.AExprPos(this, _term.left(), 1);
                    
                    return _left;
                case 2:
                    if(_op == null)
                        _op = pscriptAST.AInfixOpPos(this, _term.op(), 2);
                    
                    return _op;
                case 3:
                    if(_right == null)
                        _right = pscriptAST.AExprPos(this, _term.right(), 3);
                    
                    return _right;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AInfixPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AInfixPos invoked with too large parameter "+i+", sort has only 4 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AInfixPos replace(de.peeeq.pscript.ast.AInfix term) {
            return (de.peeeq.pscript.ast.AInfixPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AExprPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAInfixPos(this);
        }
