...
public interface EObjectPos extends de.peeeq.pscript.ast.pscriptAST.LeafPos<org.eclipse.emf.ecore.EObject> {

    //----- methods of EObjectPos -----

    public org.eclipse.emf.ecore.EObject term();
    ...
    //----- nested classes of EObjectPos -----

    static class Impl extends KatjaLeafPosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, org.eclipse.emf.ecore.EObject> implements de.peeeq.pscript.ast.EObjectPos {

        //----- methods of Impl -----

        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, org.eclipse.emf.ecore.EObject term, int pos) {
