...
public interface AStatement extends KatjaSort {

    //----- methods of AStatement -----

    public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AStatement.Switch<CT, E> switchClass) throws E;

    //----- nested classes of AStatement -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.pscript.ast.AExpr.Switch<CT, E> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseABlock(de.peeeq.pscript.ast.ABlock term) throws E;
        public CT CaseAIf(de.peeeq.pscript.ast.AIf term) throws E;
        public CT CaseAWhile(de.peeeq.pscript.ast.AWhile term) throws E;
        public CT CaseAReturn(de.peeeq.pscript.ast.AReturn term) throws E;
        public CT CaseAVoidReturn(de.peeeq.pscript.ast.AVoidReturn term) throws E;
        public CT CaseAAssignment(de.peeeq.pscript.ast.AAssignment term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AStatement.VisitorType<E> {
