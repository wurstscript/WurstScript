...
public interface ATypeDef extends de.peeeq.pscript.ast.AElement, KatjaSort {
    ...
    //----- nested classes of ATypeDef -----

    public static interface Switch<CT, E extends Throwable> {

        //----- methods of Switch<CT, E extends Throwable> -----

        public CT CaseANativeType(de.peeeq.pscript.ast.ANativeType term) throws E;
        public CT CaseAClassDef(de.peeeq.pscript.ast.AClassDef term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.ATypeDef.VisitorType<E> {
        ...
        private final de.peeeq.pscript.ast.ATypeDef.Switch<Object, E> variantVisit$ATypeDef = new de.peeeq.pscript.ast.ATypeDef.Switch<Object, E>() { public final Object CaseANativeType(de.peeeq.pscript.ast.ANativeType term) throws E { visit(term); return null; } public final Object CaseAClassDef(de.peeeq.pscript.ast.AClassDef term) throws E { visit(term); return null; } };
        ...
        public final void visit(de.peeeq.pscript.ast.ATypeDef term) throws E {
            term.Switch(variantVisit$ATypeDef);
        }
