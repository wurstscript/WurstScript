...
public interface APrefixPos extends de.peeeq.pscript.ast.AExprPos, de.peeeq.pscript.ast.pscriptAST.TuplePos<de.peeeq.pscript.ast.APrefix> {

    //----- methods of APrefixPos -----

    public de.peeeq.pscript.ast.APrefix termAExpr();
    public de.peeeq.pscript.ast.APrefix termAStatement();
    public de.peeeq.pscript.ast.APrefix term();
    public de.peeeq.pscript.ast.EObjectPos source();
    public de.peeeq.pscript.ast.APrefixPos replaceSource(org.eclipse.emf.ecore.EObject source);
    public de.peeeq.pscript.ast.APrefixOpPos op();
    public de.peeeq.pscript.ast.APrefixPos replaceOp(de.peeeq.pscript.ast.APrefixOp op);
    public de.peeeq.pscript.ast.AExprPos e();
    public de.peeeq.pscript.ast.APrefixPos replaceE(de.peeeq.pscript.ast.AExpr e);
    public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i);
    public int size();
    public de.peeeq.pscript.ast.APrefixPos replace(de.peeeq.pscript.ast.APrefix term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.APrefixPos.VisitorType<E> {
    ...
    static class Impl extends KatjaTuplePosImpl<de.peeeq.pscript.ast.ACompilationUnitPos, de.peeeq.pscript.ast.APrefix> implements de.peeeq.pscript.ast.APrefixPos {

        //----- attributes of Impl -----

        private de.peeeq.pscript.ast.EObjectPos _source = null;
        private de.peeeq.pscript.ast.APrefixOpPos _op = null;
        private de.peeeq.pscript.ast.AExprPos _e = null;
        ...
        public de.peeeq.pscript.ast.APrefixOpPos op() {
            if(_op == null)
                _op = de.peeeq.pscript.ast.pscriptAST.APrefixOpPos(this, _term.op(), 1);
        ...
        public de.peeeq.pscript.ast.AExprPos e() {
            if(_e == null)
                _e = de.peeeq.pscript.ast.pscriptAST.AExprPos(this, _term.e(), 2);

            return _e;
        }

        public de.peeeq.pscript.ast.APrefixPos replaceE(de.peeeq.pscript.ast.AExpr e) {
            return replace(_term.replaceE(e));
        }

        Impl(KatjaNodePos<de.peeeq.pscript.ast.ACompilationUnitPos, ?> parent, de.peeeq.pscript.ast.APrefix term, int pos) {
        ...
        public de.peeeq.pscript.ast.pscriptAST.SortPos get(int i) {
            ...
            switch(ith) {
                ...
                case 1:
                    if(_op == null)
                        _op = pscriptAST.APrefixOpPos(this, _term.op(), 1);
                    
                    return _op;
                case 2:
                    if(_e == null)
                        _e = pscriptAST.AExprPos(this, _term.e(), 2);
                    
                    return _e;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort APrefixPos invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort APrefixPos invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.APrefixPos replace(de.peeeq.pscript.ast.APrefix term) {
            return (de.peeeq.pscript.ast.APrefixPos) super.replace(term);
        }
        ...
        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.AExprPos.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAPrefixPos(this);
        }
