...
public interface AClassDef extends de.peeeq.pscript.ast.ATypeDef, KatjaTuple {

    //----- methods of AClassDef -----

    public org.eclipse.emf.ecore.EObject source();
    public de.peeeq.pscript.ast.AClassDef replaceSource(org.eclipse.emf.ecore.EObject source);
    public java.lang.String name();
    public de.peeeq.pscript.ast.AClassDef replaceName(java.lang.String name);
    public de.peeeq.pscript.ast.AClassMembers members();
    public de.peeeq.pscript.ast.AClassDef replaceMembers(de.peeeq.pscript.ast.AClassMembers members);
    public Object get(int i);
    public int size();
    public de.peeeq.pscript.ast.AClassDef replace(int pos, Object term);
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AClassDef.VisitorType<E> {
    ...
    static class Impl extends KatjaTupleImpl implements de.peeeq.pscript.ast.AClassDef {

        //----- attributes of Impl -----

        private org.eclipse.emf.ecore.EObject _source = null;
        private java.lang.String _name = null;
        private de.peeeq.pscript.ast.AClassMembers _members = null;
        ...
        public de.peeeq.pscript.ast.AClassDef replaceMembers(de.peeeq.pscript.ast.AClassMembers members) {
            return replace(2, members);
        }

        Impl(org.eclipse.emf.ecore.EObject source, java.lang.String name, de.peeeq.pscript.ast.AClassMembers members) {
            if(source == null)
                throw new IllegalArgumentException("constructor of sort AClassDef invoked with null parameter source");
            if(name == null)
                throw new IllegalArgumentException("constructor of sort AClassDef invoked with null parameter name");
            if(members == null)
                throw new IllegalArgumentException("constructor of sort AClassDef invoked with null parameter members");
        ...
        public Object get(int i) {
            ...
            switch(ith) {
                ...
                case 1: return _name;
                case 2: return _members;
                default:
                    if(ith < 0) {
                        throw new IllegalArgumentException("get on sort AClassDef invoked with negative parameter "+i);
                    } else {
                        throw new IllegalArgumentException("get on sort AClassDef invoked with too large parameter "+i+", sort has only 3 components");
                    }
            }
        }
        ...
        public de.peeeq.pscript.ast.AClassDef replace(int pos, Object term) {
            if(pos < 0)
                throw new IllegalArgumentException("replace on sort AClassDef invoked with negative parameter "+pos);
            if(pos >= 3)
                throw new IllegalArgumentException("replace on sort AClassDef invoked with too large parameter "+pos+", sort has only 3 components");

            if(pos == 0 && !(term instanceof org.eclipse.emf.ecore.EObject))
                throw new IllegalArgumentException("replace on sort AClassDef invoked with term of incorrect sort, EObject expected");
            if(pos == 1 && !(term instanceof java.lang.String))
                throw new IllegalArgumentException("replace on sort AClassDef invoked with term of incorrect sort, String expected");
            if(pos == 2 && !(term instanceof de.peeeq.pscript.ast.AClassMembers))
                throw new IllegalArgumentException("replace on sort AClassDef invoked with term of incorrect sort, AClassMembers expected");

            return (de.peeeq.pscript.ast.AClassDef) pscriptAST.unique(new de.peeeq.pscript.ast.AClassDef.Impl(
                pos == 0 ? (org.eclipse.emf.ecore.EObject) term : _source,
                pos == 1 ? (java.lang.String) term : _name,
                pos == 2 ? (de.peeeq.pscript.ast.AClassMembers) term : _members
            ));
        }

        public <CT, E extends Throwable> CT Switch(de.peeeq.pscript.ast.ATypeDef.Switch<CT, E> switchClass) throws E {
            return switchClass.CaseAClassDef(this);
        }
        ...
        public Appendable toJavaCode(Appendable builder) throws IOException {
            builder.append("pscriptAST.AClassDef");
            builder.append("( ");
        ...
        public Appendable toString(Appendable builder) throws IOException {
            builder.append("AClassDef");
            builder.append("( ");
            builder.append(_source.toString());
            builder.append(", ");
            builder.append("\"").append(_name.toString()).append("\"");
            builder.append(", ");
            _members.toString(builder);
            builder.append(" )");
