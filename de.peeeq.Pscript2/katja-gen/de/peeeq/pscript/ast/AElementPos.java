...
public interface AElementPos extends de.peeeq.pscript.ast.pscriptAST.SortPos {

    //----- methods of AElementPos -----

    public KatjaSort term();
    public de.peeeq.pscript.ast.AElement termAElement();
    ...
    //----- nested classes of AElementPos -----

    public static interface Switch<CT, E extends Throwable> extends de.peeeq.pscript.ast.ATypeDefPos.Switch<CT, E> {
        ...
        public CT CaseAInitBlockPos(de.peeeq.pscript.ast.AInitBlockPos term) throws E;
    }
    ...
    public static abstract class Visitor<E extends Throwable> implements de.peeeq.pscript.ast.AElementPos.VisitorType<E> {
