...
public class FunctionScope implements IScope {
	...
	public FunctionScope(AttributeManager attributeManager, IScope parentScope, 
...
//		return result;
	...
	private List<IEObjectDescription> applyFilter(Iterable<IEObjectDescription> elements) {
		List<IEObjectDescription> elements1 = getFunctions(elements);
