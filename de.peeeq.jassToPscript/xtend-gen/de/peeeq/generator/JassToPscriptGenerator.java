...
public class JassToPscriptGenerator implements IGenerator {
  ...
  public StringConcatenation compile(final Resource resource) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("package jass_natives {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("nativetype int");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("nativetype real");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("nativetype string");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("nativetype bool");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("nativetype code");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("nativetype handle");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
  ...
  protected StringConcatenation _compile(final NativeDef f) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      if ((_returnType instanceof de.peeeq.jassToPscript.ReturnsNothing)) {
        ...
        StringConcatenation _compile_1 = this.compile(_params_1);
        _builder.append(_compile_1, "");
