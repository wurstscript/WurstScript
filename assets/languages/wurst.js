...
hljs.LANGUAGES.wurst = function(){
  var WURST_KEYWORDS = {
    'keyword': {
       'class' : 1, 'return' : 1, 'if' : 1, 'else' : 1, 'while' : 1, 'for' : 1, 'in' : 1, 'break' : 1, 'new' : 1, 'null' : 1, 'package' : 1, 'endpackage' : 1, 'function' : 1, 'returns' : 1, 'public' : 1, 'private' : 1, 'protected' : 1, 'import' : 1, 'native' : 1, 'nativetype' : 1, 'extends' : 1, 'interface' : 1, 'implements' : 1, 'module' : 1, 'use' : 1, 'abstract' : 1, 'static' : 1, 'thistype' : 1, 'override' : 1, 'immutable' : 1, 'it' : 1, 'array' : 1, 'and' : 1, 'or' : 1, 'not' : 1, 'this' : 1, 'construct' : 1, 'ondestroy' : 1, 'destroy' : 1, 'type' : 1, 'globals' : 1, 'endglobals' : 1, 'constant' : 1, 'endfunction' : 1, 'nothing' : 1, 'takes' : 1, 'local' : 1, 'loop' : 1, 'endloop' : 1, 'exitwhen' : 1, 'set' : 1, 'call' : 1, 'then' : 1, 'elseif' : 1, 'endif' : 1, 'init' : 1, 'castTo' : 1, 'tuple' : 1, 'div' : 1, 'mod' : 1, 'let' : 1, 'var' : 1, 'from' : 1, 'to' : 1, 'downto' : 1, 'step' : 1, 'endpackage' : 1
	   ,'switch' : 1, 'case' : 1, 'default' : 1, 'super' : 1
    },
    'constant': {
