/* The following code was generated by JFlex 1.4.3 on 09.10.11 19:07 */
...
public class WurstTokenMaker  extends AbstractTokenMaker {
	...
	protected final String numberEndChars = ""; // Characters used to specify literal number types.
	...
	public TokenMap getWordsToHighlight() {
		...
		tokenMap.put("and", reservedWord);	
		tokenMap.put("or", reservedWord);	
		tokenMap.put("not", reservedWord);	
		tokenMap.put("this", reservedWord);	
		tokenMap.put("construct", reservedWord);	
		tokenMap.put("ondestroy", reservedWord);	
		tokenMap.put("destroy", reservedWord);	
		tokenMap.put("type", reservedWord);	
		tokenMap.put("globals", reservedWord);	
		tokenMap.put("endglobals", reservedWord);	
		tokenMap.put("constant", reservedWord);	
		tokenMap.put("endfunction", reservedWord);	
		tokenMap.put("nothing", reservedWord);	
		tokenMap.put("takes", reservedWord);	
		tokenMap.put("local", reservedWord);	
		tokenMap.put("loop", reservedWord);	
		tokenMap.put("endloop", reservedWord);	
		tokenMap.put("exitwhen", reservedWord);	
		tokenMap.put("set", reservedWord);	
		tokenMap.put("call", reservedWord);	
		tokenMap.put("then", reservedWord);	
		tokenMap.put("elseif", reservedWord);	
		tokenMap.put("endif", reservedWord);	
		tokenMap.put("init", reservedWord);		
		
		int dataType = Token.DATA_TYPE;
		tokenMap.put("int", reservedWord);
		tokenMap.put("real", reservedWord);
