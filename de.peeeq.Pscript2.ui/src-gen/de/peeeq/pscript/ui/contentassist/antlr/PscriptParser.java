		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExprAtomicAccess().getBoolValAlternatives_7_1_0(), "rule__ExprAtomic__BoolValAlternatives_7_1_0");
					put(grammarAccess.getExprAtomicAccess().getAlternatives_8_3(), "rule__ExprAtomic__Alternatives_8_3");
					...
					put(grammarAccess.getExprAtomicAccess().getGroup_8_3_1(), "rule__ExprAtomic__Group_8_3_1__0");
					...
					put(grammarAccess.getExprAtomicAccess().getBoolValAssignment_7_1(), "rule__ExprAtomic__BoolValAssignment_7_1");
					put(grammarAccess.getExprAtomicAccess().getNameAssignment_8_2(), "rule__ExprAtomic__NameAssignment_8_2");
					put(grammarAccess.getExprAtomicAccess().getParametersAssignment_8_3_0(), "rule__ExprAtomic__ParametersAssignment_8_3_0");
