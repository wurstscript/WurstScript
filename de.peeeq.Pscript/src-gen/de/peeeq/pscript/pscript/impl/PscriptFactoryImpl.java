...
public class PscriptFactoryImpl extends EFactoryImpl implements PscriptFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case PscriptPackage.EXPR_CUSTOM_OPERATOR: return createExprCustomOperator();
      ...
      case PscriptPackage.EXPR_BUILDIN_OPERATOR: return createExprBuildinOperator();
      default:
   ...
   * @generated
   */
  public ExprCustomOperator createExprCustomOperator()
  {
    ExprCustomOperatorImpl exprCustomOperator = new ExprCustomOperatorImpl();
    return exprCustomOperator;
  }
   ...
   * @generated
   */
  public ExprBuildinOperator createExprBuildinOperator()
  {
    ExprBuildinOperatorImpl exprBuildinOperator = new ExprBuildinOperatorImpl();
    return exprBuildinOperator;
  }
